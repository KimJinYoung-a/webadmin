...
<%
Dim searchtype, searchrect, meCode
...
<tr>
	...
	<select name="meCode" class="select">
		...
		<option value="daumshop_brand"			<%= ChkIIF(meCode = "daumshop_brand", "selected", "") %> >퀵링크(브랜드검색)</option>
		<option value="WEB_ALL"					<%= ChkIIF(meCode = "WEB_ALL", "selected", "") %> >==== 웹 매출 전체 ====</option>
		<option value="mobile_daumshop_brand"	<%= ChkIIF(meCode = "mobile_daumshop_brand", "selected", "") %> >퀵링크(브랜드검색)[모바일]</option>
