...
<!-- #include virtual="/company/dm/daumepCls.asp" -->
<%
...
<tr>
	...
	<select name="meCode" class="select">
		...
		<option value="daumshop"			<%= ChkIIF(meCode = "daumshop", "selected", "") %> >다음_웹</option>
		<option value="daumshop_brand"		<%= ChkIIF(meCode = "daumshop_brand", "selected", "") %> >다음_퀵링크</option>
		<option value="daumshop_mall"		<%= ChkIIF(meCode = "daumshop_mall", "selected", "") %> >다음_몰명</option>
		<option value="daumshop_etc"		<%= ChkIIF(meCode = "daumshop_etc", "selected", "") %> >다음_상품DB외</option>
		<option value="WEB_ALL"				<%= ChkIIF(meCode = "WEB_ALL", "selected", "") %> >==== 웹 매출 전체 ====</option>
		
		<option value="mobile_daumshop"	<%= ChkIIF(meCode = "mobile_daumshop", "selected", "") %> >다음_모바일</option>
		<option value="mobile_daumshop_brand"	<%= ChkIIF(meCode = "mobile_daumshop_brand", "selected", "") %> >다음_퀵링크_모바일</option>
		<option value="mobile_daumshop_mall"	<%= ChkIIF(meCode = "mobile_daumshop_mall", "selected", "") %> >다음_몰명_모바일</option>
		<option value="mobile_daumshop_etc"	<%= ChkIIF(meCode = "mobile_daumshop_etc", "selected", "") %> >다음_상품DB외_모바일</option>
