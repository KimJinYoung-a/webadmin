...
<!-- #include virtual="/company/nt/nateshopCls.asp" -->
<%
...
<tr>
	...
	<select name="meCode" class="select">
		...
		<option value="nateshop"			<%= ChkIIF(meCode = "nateshop", "selected", "") %> >네이트_웹</option>
		<option value="nateshop_mall"		<%= ChkIIF(meCode = "nateshop_mall", "selected", "") %> >네이트_몰명</option>
		<option value="nateshop_etc"		<%= ChkIIF(meCode = "nateshop_etc", "selected", "") %> >네이트_상품DB외</option>
		<option value="WEB_ALL"				<%= ChkIIF(meCode = "WEB_ALL", "selected", "") %> >==== 웹 매출 전체 ====</option>
		
		<option value="mobile_nateshop"	<%= ChkIIF(meCode = "mobile_nateshop", "selected", "") %> >네이트_모바일</option>
		<option value="mobile_nateshop_mall"	<%= ChkIIF(meCode = "mobile_nateshop_mall", "selected", "") %> >네이트_몰명_모바일</option>
		<option value="mobile_nateshop_etc"	<%= ChkIIF(meCode = "mobile_nateshop_etc", "selected", "") %> >네이트_상품DB외_모바일</option>
