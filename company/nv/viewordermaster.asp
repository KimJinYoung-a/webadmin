...
<!-- #include virtual="/company/nv/navepCls.asp" -->
...
<tr height="25" bgcolor="#FFFFFF">
	...
	<td bgcolor="#FFD8D8" width="100">%쿠폰할인</td>
	<td ><%= FormatNumber(ojumun.FOneItem.FitemcostSum-ojumun.FOneItem.FreducedpriceSum,0) %></td>
</tr>
<tr height="25" bgcolor="#FFFFFF">
	<td bgcolor="#FFD8D8" width="100">금액쿠폰할인</td>
	<td ><%= FormatNumber(ojumun.FOneItem.getPriceBonusCouponSum,0) %></td>
	<td bgcolor="#FFD8D8" width="100">배송비쿠폰할인</td>
	<td ><%= FormatNumber(ojumun.FOneItem.FdlvcostCpnSum,0) %></td>
</tr>
<tr height="25" bgcolor="#FFFFFF">
	<td bgcolor="#FFD8D8" width="100">정산대상액 (Vat포함)</td>
	<td ><%= FormatNumber(ojumun.FOneItem.getJungsanTargetSum,0) %></td>
	<td bgcolor="#FFD8D8" width="100">정산대상액</td>
