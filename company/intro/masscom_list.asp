...
<!--
	...
	function goPage(pg)
	{
		...
		document.frm.action="masscom_list.asp";
		document.frm.submit();
	}
	...
	function goEdit(brdsn)
	{
		...
		document.frm.action="masscom_edit.asp";
		document.frm.submit();
	}
//-->
</script>
<table width="750" border="0" cellpadding="0" cellspacing="0" class="a" bgcolor="#F4F4F4">
<form name="frm" method="get" action="" action="masscom_list.asp">
...
<tr valign="bottom" height="25">
	...
	<td>
		...
		<tr valign="bottom">
			...
			<td width="75" align="right"><a href="masscom_write.asp?menupos=<%=menupos%>"><img src="/images/icon_new_registration.gif" width="75" border="0"></a></td>
		</tr>
		</table>
	</td>
	<td width="10" align="left" background="/images/tbl_blue_round_05.gif"></td>
