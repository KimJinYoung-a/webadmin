...
<!-- #include virtual="/company/wmprc/wmprcCls.asp" -->
<%
...
If (meCode="") then meCode = "mobile_wmprc"
...
<tr>
	...
	<select name="meCode" class="select">
		...
		<option value="wmprc"			<%= ChkIIF(meCode = "wmprc", "selected", "") %> >PC</option>
		<option value="mobile_wmprc"	<%= ChkIIF(meCode = "mobile_wmprc", "selected", "") %> >모바일</option>
	</select>
	</td>
