...
with (document) {
write("<tr>")
write("<td><table class='tbType1 listTb' width='250' border='0' cellpadding='0' cellspacing='1' bgcolor='#BEBEBE'>")
write("<tr>")
write("<th height='19'><div>일</div></th>")
write("<th height='19'><div>월</div></th>")
write("<th height='19'><div>화</div></th>")
write("<th height='19'><div>수</div></th>")
write("<th height='19'><div>목</div></th>")
write("<th height='19'><div>금</div></th>")
write("<th height='19'><div>토</div></th>")
write("</tr>")
	...
	for (d = 0; d < 7; d++)
		with (gCellSet[(7*w)+d]) {
			...
			if (myMonth[w+1][d]<0) {
 			...
 			if ((iYear==giYear)&&(iMonth==giMonth)&&(iDate==giDay)){
 				 parentNode.className = "bgBl1";
 			} 
...
with (document) {
write("<table width='250' border='0' cellspacing='0' cellpadding='0' style='margin:0 auto;'>")
write("<tr>")
write("<td align='center' background='/WebManager/Image/Calendar/calendar_02.gif'><table width='245' border='0' cellspacing='0' cellpadding='0'>")
write("<tr>")
write("<td height='35' align='center'><table border='0' cellspacing='0' cellpadding='0' class='a'>")
write("<tr>")
//write("<td width='20'><img src='/images/icon_arrow_left.gif'  border='0' onclick='fPrevMonth()'></td>"))
write("<td width='60'><input type=button class='btn3 btnSmall' value='<<' onclick='fPrevYear()'> <input type='button' class='btn3 btnSmall'  value='<' onclick='fPrevMonth()'></td>")
write("<td class='blue'><SELECT id='tbYearSelect' class='formSlt' onChange='fUpdateCal(tbSelYear.value, tbSelMonth.value)' Victor='Won'>");
for(i=giStartYear;i<=giEndYear;i++)
	write("<OPTION value='"+i+"'>"+i+"</OPTION>");
	write("</SELECT><strong>년</strong>&nbsp;&nbsp;");
	write("<select id='tbMonSelect' class='formSlt' onChange='fUpdateCal(tbSelYear.value, tbSelMonth.value)' Victor='Won'><strong>");
for (i=0; i<12; i++)
	...
	write("<td width='60' align='right'><input type=button class='btn3 btnSmall' value='>' onclick='fNextMonth()'> <input type=button class='btn3 btnSmall' value='>>' onclick='fNextYear()'></td>")
	write("</tr>")
	write("</table></td>")
	write("</tr>")
	write("<tr>")
