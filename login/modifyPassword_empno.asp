...
<!--
	function chkForm(frm) {
		...
		if(frm.upwd.value==frm.uid.value) {
			alert("사번과 다른 비밀번호를 사용해주세요.");
			frm.upwd.focus();
			return false;
		}
		if(frm.upwd.value.length<6) {
			alert("비밀번호는 6자이상입니다.");
			frm.upwd.focus();
			return false;
		}
...
<tr>
<td>
    <form method="post" action="/login/doPasswordModi_empno.asp" target="FrameCKP" onSubmit="return chkForm(this)">
    ...
    <table width="400" border="0" align="center" valign="center" cellpadding="0" cellspacing="0" class="a" bgcolor="#FFFFFF">
    	...
    	<tr valign="top">
    		...
    		<td style="padding-bottom:10px">
			    ...
			    <font color="darkblue">
			    &nbsp; 1. 최소 6자리 이상의 비밀번호 사용<br>
			    &nbsp; 2. 사번과 동일하거나 아이디를 포함한 패스워드 금지<br>
			    &nbsp; 3. 같은 문자를 연속으로 3자 이상 금지<br>
			    &nbsp; 4. 새로운 패스워드는 영문/숫자/특수문자 등 두가지 이상의 조합으로 입력하세요. 최소길이 10자(2조합) , 8자(3조합)<br>
			    </font>
    		</td>
    		<td background="/images/tbl_blue_round_05.gif"></td>
    	</tr>
    	<tr align="center">
            ...
            <td style="padding-bottom:10px">
		    	...
		    	<tr align="center">
		            ...
		            <td align="left">
		              	<b><%=session("ssBctSn")%></b>
		              	<input type=hidden name=uid value='<%=session("ssBctSn")%>'>
		            </td>
		    	</tr>
		    	<tr align="center">
