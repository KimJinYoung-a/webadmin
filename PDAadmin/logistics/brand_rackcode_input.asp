...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr height="25" bgcolor="FFFFFF">
		<td colspan="3">
			<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a">
				...
				<tr>
				    <td>
						상품코드: <input type="text" class="text" name="itembarcode" value="<%= itembarcode %>" size="12" maxlength="32">
						<!--
						&nbsp;
						브랜드ID
    ...
    <tr bgcolor="#FFFFFF">
        ...
        <td>
            ...
            <%= ChkIIF(ItemData(6,0)="W","<font color='#3333AA'>위탁</font>","") %>
    ...
    <tr bgcolor="#FFFFFF">
        ...
        <td width="150"><%= opartner.FOneItem.Fid %></td>
        <td>&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#FFFFFF">
        ...
        <td>
        	<input type="text" class="text" name="prtidx" value="<%= opartner.FOneItem.Fprtidx %>" size="4" maxlength="4">
