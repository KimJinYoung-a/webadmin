...
offnews.FRectShopid = session("ssBctId")
...
<% for i = 0 to (offnews.FResultCount - 1) %>
  <tr height="20">
    ...
    <td>&nbsp;<a href="offshop_news_event_edit.asp?idx=<%= offnews.FItemList(i).Fidx %>"><%= offnews.FItemList(i).Ftitle %></a></td>
...
<tr>
	<td align="right"><a href="offshop_news_event_write.asp?shopid=<%= session("ssBctId") %>&menupos=<%= menupos %>"><font color="red">News & 이벤트 등록</font></a>&nbsp;&nbsp;&nbsp;</td>
</tr>
</table>
<br><br>
<% set offnews = Nothing %>
