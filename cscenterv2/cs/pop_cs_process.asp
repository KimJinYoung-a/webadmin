...
'''검토..
        ...
        ReturnUrl = "pop_cs_register.asp?id="  + CStr(id) + "&divcd=" + divcd + "&mode=editreginfo"
    elseif (divcd="A004") or (divcd="A010") then
        ...
        ReturnUrl = "pop_cs_register.asp?id="  + CStr(id) + "&divcd=" + divcd
...
elseif (mode="finishcsas") then
    ...
    if (divcd="A008") then
        ...
        ReturnUrl = "pop_cs_register.asp?id="  + CStr(id) + "&divcd=" + divcd + "&mode=editfinishedinfo"
    ...
    elseif (divcd="A003") or (divcd="A007") then
        ...
        if (RefreturnMethod="R007") and (Refrealrefund>0) then
            ReturnUrl = "pop_cs_register.asp?id="  + CStr(id) + "&divcd=" + divcd + "&finishtype=1"
        else
            ReturnUrl = "pop_cs_register.asp?id="  + CStr(id) + "&divcd=" + divcd
        end if
...
elseif (mode="state2jupsu") then
    if (divcd="A700") then
        ...
        if (ResultMsg="") then
            sqlStr = " update [db_academy].[dbo].[tbl_academy_as_list]"
