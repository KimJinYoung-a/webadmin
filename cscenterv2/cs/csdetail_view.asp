...
<%
'###########################################################
' Description : 핑거스 고객센터 상품CS처리 리스트
			        ...
			        <td colspan="3">
			            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="a" >
			            	<tr>
				    		    ...
				    		    <td align="right" >
				    		        <input class="button" type="button" value="정보수정" onclick="PopCSActionEdit('<%= id %>','editrefundinfo');">
				    		    </td>
				    		</tr>
		    		    </table>
				    </td>
			        ...
			        <td colspan="5">
			            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="a" >
			            	<tr>
				    		    ...
				    		    <td align="right" >
				    		        <input class="button" type="button" value="완료처리" onclick="PopCSActionFinish('<%= id %>','finishreginfo');" >
				    		    </td>
				    		 </tr>
		    			</table>
		    		</td>
