...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr height="25">
	    ...
	    <td bgcolor="#FFFFFF"><input type="text" class="text_ro" name="userid" id="[off,off,off,off][구매자ID]" value="<%= ojumun.FOneItem.FUserID %>" readonly></td>
	</tr>
	<tr height="25">
	    <td bgcolor="<%= adminColor("topbar") %>">주문번호</td>
	    <td bgcolor="#FFFFFF"><input type="text" class="text_ro" name="orderserial" id="[off,off,off,off][주문번호]" value="<%= ojumun.FOneItem.FOrderSerial %>" readonly></td>
	</tr>
	<tr height="25">
	    <td bgcolor="<%= adminColor("topbar") %>">구매자명</td>
	    <td bgcolor="#FFFFFF">
	        <input type="text" class="text" name="buyname" id="[on,off,1,16][구매자명]" value="<%= ojumun.FOneItem.FBuyName %>" size="8" >
