...
<tr height="25" bgcolor="#FFFFFF">
    ...
    <td><input type="text" class="text" name="reqname" id="[on,off,1,16][수령인명]" value="<%= ojumun.FOneItem.FReqName %>"></td>
</tr>
<tr height="25" bgcolor="#FFFFFF">
...
<tr height="25" bgcolor="#FFFFFF">
    ...
    <td>
        <textarea class="textarea" rows="3" cols="35" name="comment" id="[off,off,off,off][기타사항]"><%= ojumun.FOneItem.FComment %></textarea></td>
</tr>
</table>
