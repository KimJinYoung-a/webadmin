...
if email <> "" then
	if checkNotValidHTML(email) then
...
function TnCSTemplateGubunChanged(gubun) {
	...
	CSTemplateFrame.location.href="/cscenterv2/board/cs_template_select_process.asp?mastergubun=20&gubun=" + gubun + "&orderserial=" + orderserial + "&userid=" + userid + "&makerid=" + makerid + "&itemid=" + itemid + "&orderdetailidx=" + orderdetailidx;
}
