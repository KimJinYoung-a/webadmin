...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="a" bgcolor="F4F4F4">
    <form name="frm" method="post" action="do_cs_write.asp" onsubmit="return false;">
    <input type="hidden" name="mode" value="cancelcard">
        ...
        <td colspan="2" background="/images/tbl_blue_round_06.gif">
            ...
            <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="a" bgcolor="BABABA">
            	...
            	<tr height="25" bgcolor="#FFFFFF">
            	    ...
            	    <td><input type="text" name="title" size="50" value="취소요청(<%= oordermaster.FOneItem.JumunMethodName %>)"></td>
    ...
    <tr height="20">
	    <td background="/images/tbl_blue_round_04.gif"></td>
	    <td background="/images/tbl_blue_round_06.gif">
	    	<img src="/images/icon_star.gif" align="absbottom">&nbsp;<b>구매상품리스트</b>
	    </td>
	            ...
	            <tr>
	                <td valign="top" width="50%">
	                    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="BABABA">
                            <tr bgcolor="FFFFFF">
                        		<td height="30" width="100">거래상태</td>
                        		<td width="170"><font color="<%= oordermaster.FOneItem.IpkumDivColor %>"><%= oordermaster.FOneItem.IpkumDivName %></font></td>
                        		<td></td>
                        	</tr>
                        	<tr bgcolor="FFFFFF">
                        		<td height="30">결제금액</td>
                        		<td align="right">
<% if (oordermaster.FOneItem.Fipkumdiv >= 4) then %>
                        		<%= oordermaster.FOneItem.Fsubtotalprice + totalresultrepay %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<% else %>
                                        0&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<% end if %>
                        		</td>
                        	...
                        	<tr bgcolor="FFFFFF">
                        		<td height="30">기타</td>
                        		<td>쿠폰[<%= oordermaster.FOneItem.Ftencardspend %>] / 마일리지[<%= oordermaster.FOneItem.Fmiletotalprice %>]</td>
                        		<td></td>
                        	</tr>
                        	<tr bgcolor="FFFFFF">
...
%>
                        		  <input type="text" name="refundrequire" value="<%= i %>" style="text-align:right;">
                        		</td>
                        		<td></td>
                        	</tr>
                        </table>
...
if ((divcd = "7") and (oordermaster.FOneItem.Faccountdiv = "7")) then
        response.write "<script>frm.btnsave.disabled = true;</script>"
        response.write "<script>alert('무통장에 대한 카드취소 등록은 불가능합니다.');</script>"
end if

if (oordermaster.FOneItem.Fipkumdiv < 4) then
        response.write "<script>frm.btnsave.disabled = true;</script>"
        response.write "<script>alert('입금되지 않은 주문에 대해서는 환불등록이 되지 않습니다.');</script>"
end if
