...
<table width="100%" border="0" align="center" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
	...
	<% end if %>
		...
		<td align="center"><a href="javascript:JunsanDetailList('<%= id %>','upche')"><img src="/images/icon_search.jpg" width="16" border="0"></a></td>
	</tr>
	<% if gubun="maeip" then %>
	<tr bgcolor="#CCCCFF">
	<% else %>
	...
	<% end if %>
		...
		<td align="center"><a href="javascript:JunsanDetailList('<%= id %>','maeip')"><img src="/images/icon_search.jpg" width="16" border="0"></a></td>
	</tr>
	...
	<% end if %>
		...
		<td align="center"><a href="javascript:JunsanDetailList('<%= id %>','witaksell')"><img src="/images/icon_search.jpg" width="16" border="0"></a></td>
	</tr>
	<!--
	<tr bgcolor="#FFFFFF">
		<td>특정 오프라인</td>
	...
	<% end if %>
		...
		<td align="center"><a href="javascript:JunsanDetailList('<%= id %>','witakchulgo')"><img src="/images/icon_search.jpg" width="16" border="0"></a></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td>총계</td>
		<td></td>
...
dim ojungsansummary
set ojungsansummary = new CLecJungsan
...
if (id>1357) and (gubun<>"") then
    ojungsansummary.LecJungsanDetailListSum
end if
%>
...
dim ojungsandetail
set ojungsandetail = new CLecJungsan
...
'' 1357 이전내역은 정산방식이 다름(재고기준정산)
if (id>1357) and (gubun<>"")   then
    ojungsandetail.LecJungsanDetailList
end if  
%>
<!-- 주문건별 리스트 시작-->
<table width="100%" border="0" align="center" class="a" cellpadding="2" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
...
<% if ojungsandetail.FResultCount>0 and ojungsandetail.FRectgubun<>"" then %>
    ...
    <tr bgcolor="#FFFFFF" align="center">
    	<td>합계</td>
    	<% if ojungsandetail.FRectgubun="maeip" or ojungsandetail.FRectgubun="witakchulgo" then %>
    	<td colspan="5"></td>
    	<% else %>
    	<td colspan="7"></td>
    	<% end if %>
