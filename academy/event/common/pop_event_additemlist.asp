...
<%
dim target,gubun ,sortDiv ,page ,cdl, cdm, cds
dim eCode, cEGroup,arrGroup,intLoop ,i
dim itemid, itemname, makerid, sellyn, usingyn, mwdiv, limityn, vatyn, sailyn,deliverytype
...
frm.sType.value = sType;
	...
	frm.target = "FrameCKP";
	frm.action = "/academy/event/eventitem_process.asp";
	frm.submit();
	frm.itemidarr.value = "";
	opener.history.go(0);	
}
...
<iframe name="FrameCKP" src="" frameborder="0" width="300" height="300"></iframe>
