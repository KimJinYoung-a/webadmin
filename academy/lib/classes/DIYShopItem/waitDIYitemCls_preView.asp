...
Class CWaitItem
	...
	Public Function fnGetItemVideos(byval itemid, ByVal vgubun)
		dim strSQL, vCount
		strSQL = " SELECT TOP 1 videogubun, videotype, videourl, videowidth, videoheight, videofullurl FROM db_academy.dbo.tbl_diy_wait_item_videos WHERE videogubun='"&vgubun&"' And itemid = '" & itemid & "'"
		''response.write strSQL
		rsACADEMYget.open strSQL, dbACADEMYget
		set FOneItem = new CVideosItem
		if  not rsACADEMYget.EOF  then
