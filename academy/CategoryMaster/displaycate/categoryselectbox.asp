...
if tmp_cdl="" then	tmp_cdl = RequestCheckvar(request("cdl"),10)
if tmp_cdm="" then	tmp_cdm = RequestCheckvar(request("cdm"),10)
if tmp_cds="" then	tmp_cds = RequestCheckvar(request("cds"),10)
%>
<script type="text/javascript">
// AJAX 프로그램
var parentFrmName = "frmitem";
var xmlHttp;
var xmlDoc;
...
function startRequest( mode,cdl,cdm,cds) {
        ...
        xmlHttp.open("GET", "/academy/comm/normal_action_response.asp?mode=" + mode + "&param1=" + cdl + "&param2=" + cdm + "&param3=" + cds, true);
        xmlHttp.send(null);
}
