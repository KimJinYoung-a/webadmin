...
<%
Dim clsGift ,iSiteScope,sPartnerID,arrsitescope ,strParm ,sOldName ,iSerachType,sSearchTxt, sDate,sSdate,sEdate,iCurrpage,sgDelivery
Dim eCode, cEvent,intgroup , igkCode, igkType, igkCnt,igkLimit, igkName,sgkImg
Dim sTitle, dSDay, dEDay, sBrand, blnGroup, dOpenDay, dCloseDay
Dim gCode,igScope,igType, igR1,igR2, igStatus, dRegdate, sAdminid, igUsing
...
<tr>
	<td>
		...
		<tr>
			...
			<td bgcolor="#FFFFFF"><% drawSelectBoxLecturer "ebrand", sBrand %></td>
		</tr>
		</table>
	</td>
</tr>
	...
	<td>
		...
		<tr>
			...
			<td bgcolor="#FFFFFF"  width="400">
				...
				<input type="text" name="sGKN" size="40" maxlength="60" value ="<%=igkName%>" nkeyup="document.frmReg.iGK.value='';"> <input type="button" class="button" value="확인" onClick="jsSetGiftKind();">
				<div id="spanImg">
			...
			<td bgcolor="#FFFFFF" >
				<input type="text" name="iGKC" size="4" maxlength="10" value="<%=igkCnt%>" style="text-align:right;"> 개씩 <span id="spanKT" style="display:<%IF igType = 2 THEN%>none<%END IF%>;"><input type="checkbox" name="chkKT" value="2" <%IF igkType = 2 THEN%>checked<%END IF%>>1+1 </span>
			</td>
		</tr>
		<tr>
