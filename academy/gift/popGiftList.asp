...
<%
Dim eCode ,iTotCnt ,strParm ,iPageSize, iCurrpage ,iDelCnt
Dim clsGift, arrList, intLoop ,iStartPage, iEndPage, iTotalPage, ix,iPerCnt
...
<script language="javascript">
	...
	function jsSelImport(gc){
		document.getElementById('frameim').src='frmGiftImport.asp?gC='+gc;
	}
...
<iframe name="frameim" src="" frameborder="0" width="0" height="0"></iframe>
<!-- 표 하단바 끝-->
