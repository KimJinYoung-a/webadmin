...
<table width="100%" border="0" align="center" class="a" cellpadding="2" cellspacing="1" bgcolor="#BABABA">
	<tr align="center" bgcolor="#F0F0FD">
		<td colspan="5" align="left">검색건수 : <%= oPreface.FTotalCount %> 건 Page : <%= page %>/<%= oPreface.FTotalPage %></td>
	</tr>
	<tr align="center" bgcolor="#DDDDFF">
		<td align="center" width="60">번호</td>
		<td align="center" width="110">분류</td>
		<td align="center">구분</td>
		<td align="center" width="80">상태</td>
		<td align="center" width="100">등록일</td>
	</tr>
	<%
		for lp=0 to oPreface.FResultCount - 1

			if oPreface.FprfList(lp).Fisusing="<font color=darkblue>사용</font>" then
				bgcolor = "#FFFFFF"
			else
				bgcolor = "#E0E0E0"
			end if
