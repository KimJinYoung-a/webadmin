...
function PlusDIYItem_Main_New(){
    var popwin = window.open('/academy/itemmaster/PlusDIYItem_Edit.asp','PlusDIYItem_Main_New','width=900,height=600,scrollbars=yes,resizable=yes');
    popwin.focus();
}
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a" style="padding-top:10;">
	<tr>
		<td align="left">
			...
			<input type="button" class="button" value="신규등록" onClick="PlusDIYItem_Main_New();">
		</td>
		<td align="right">
