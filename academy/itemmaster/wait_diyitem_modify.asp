...
//    }
    ...
    if (processstatus==true){
		if(confirm("상품을 정식 등록 하시겠습니까?") == true){
...
function NotCheckform(frm){
    ...
    if ((rejectMsg!="undefined")&&(rejectMsg!="")){
    	var ret = confirm('등록 보류(재요청) 하시겠습니까?');
    	if (ret){
...
function Delform(frm){
    ...
    if ((rejectMsg!="undefined")&&(rejectMsg!="")){
    	var ret = confirm('등록불가 (진행안함) 변경 하시겠습니까?');
    	if (ret){
    	    frm.rejectmsg.value = rejectMsg;
...
<tr align="left">
	...
	<td bgcolor="#FFFFFF" colspan="3">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" value="미리보기" onclick="ViewItemDetail('<%= RequestCheckvar(request("itemid"),10) %>');">
	</td>
</tr>
<tr align="left">
	<td height="30" width="15%" bgcolor="#DDDDFF">관리 카테고리 :</td>
	<td bgcolor="#FFFFFF" colspan="3">
		<input type="text" name="cd1_name" value="<%= oitemreg.largename %>" id="[on,off,off,off][카테고리]" size="20" readOnly style="background-color:#E6E6E6">
		<input type="text" name="cd2_name" value="<%= oitemreg.midname %>" id="[on,off,off,off][카테고리]" size="20" readOnly style="background-color:#E6E6E6">
		<input type="text" name="cd3_name" value="<%= oitemreg.smallname %>" id="[on,off,off,off][카테고리]" size="20" readOnly style="background-color:#E6E6E6">
		<input type="button" value="카테고리 선택" onclick="editCategory(itemreg.cd1.value,itemreg.cd2.value,itemreg.cd3.value);">
	</td>
</tr>
<tr align="left">
	<td height="30" width="15%" bgcolor="#DDDDFF">전시 카테고리 :</td>
	<td bgcolor="#FFFFFF" colspan="3">
		<table class=a>
		<tr>
...
<tr align="left">
	...
	<td bgcolor="#FFFFFF" colspan="3">
		...
		<input type="radio" name="itemdiv" value="<%= oitemdetail.Fitemdiv %>" <%=chkIIF(oitemdetail.Fitemdiv="06" or oitemdetail.Fitemdiv="16","checked","")%> onclick="checkItemDiv(this);chgodr(2);">주문제작상품
...
<tr align="left">
	...
	<td bgcolor="#FFFFFF" colspan="3">
		...
		<% end if %>
		<input type="file" name="imgbasic" onchange="CheckImage('imgbasic', <%= CBASIC_IMG_MAXSIZE %>, 1000, 667, 'jpg');" size="40"> (<font color=red>필수</font>,1000X667,jpg)
		<input type="button" value="이미지지우기" onClick="ClearImage('imgbasic')"  class="button"><input type="hidden" name="basic">
	</td>
</tr>
<tr align="left">
...
<tr align="left">
	...
	<td bgcolor="#FFFFFF" colspan="3">
		...
		<% end if %>
		<input type="file" name="imgadd1" onchange="CheckImage('imgadd1', <%= CBASIC_IMG_MAXSIZE %>, 1000, 667, 'jpg,gif');" size="40"> (선택,1000X667,jpg,gif)
		<input type="button" value="이미지지우기" onClick="ClearImage('imgadd1')" class="button"><input type="hidden" name="add1">
	</td>
</tr>
<tr align="left">
	...
	<td bgcolor="#FFFFFF" colspan="3">
		...
		<% end if %>
		<input type="file" name="imgadd2" onchange="CheckImage('imgadd2', <%= CBASIC_IMG_MAXSIZE %>, 1000, 667, 'jpg,gif');" size="40"> (선택,1000X667,jpg,gif)
		<input type="button" value="이미지지우기" onClick="ClearImage('imgadd2')" class="button"><input type="hidden" name="add2">
	</td>
</tr>
<tr align="left">
	...
	<td bgcolor="#FFFFFF" colspan="3">
		...
		<% end if %>
		<input type="file" name="imgadd3" onchange="CheckImage('imgadd3', <%= CBASIC_IMG_MAXSIZE %>, 1000, 667, 'jpg,gif');" size="40"> (선택,1000X667,jpg,gif)
		<input type="button" value="이미지지우기" onClick="ClearImage('imgadd3')" class="button"><input type="hidden" name="add3">
	</td>
</tr>
<!-- <tr align="left"> -->
...
<!-- 		<input type="button" value="이미지지우기" onClick="ClearImage('imgadd4')" class="button"><input type="hidden" name="add4"> -->
<!-- 	</td> -->
<!-- </tr> -->
<!-- <tr align="left"> -->
...
<!-- 		<input type="button" value="이미지지우기" onClick="ClearImage('imgadd5')" class="button"><input type="hidden" name="add5"> -->
<!-- 	</td> -->
<!-- </tr> -->
<!-- <tr align="left"> -->
...
<!-- 		<input type="button" value="이미지지우기" onClick="ClearImage('imgmain')" class="button"><input type="hidden" name="main"> -->
<!-- 	</td> -->
<!-- </tr> -->
	...
	%>
			  <tr align="left">
				...
				%>
			      ...
			      <input type="button" value="#<%= (k) %> 이미지지우기" class="button" onClick="ClearImage2(this.form.addimgname<%=CHKIIF(vArr(3,UBound(vArr,2))=1,"","["&(k-1)&"]")%>,40, 1000, 667, <%= (k-1) %>)"> (선택,1000X667, Max 600KB,jpg,gif)
...
<tr valign="top" height="25">
	<td valign="bottom" align="center" colspan="2">
		<input type="button" value="정 식 등 록" onclick="SubmitSave(true);" <% if oitemdetail.FCurrState<>"1" and oitemdetail.FCurrState<>"5" then response.write "disabled" %> class="button">
		&nbsp;&nbsp;&nbsp;
		<input type="button" value="변경내용임시저장" onclick="SubmitSave(false);" class="button">
		&nbsp;&nbsp;&nbsp;
		<input type="button" value="등록보류 (재요청)" onclick="NotCheckform(borufrm);" class="button">
		&nbsp;&nbsp;&nbsp;
		<input type="button" value="등록불가 (진행안함)" onclick="Delform(borufrm);" class="button">            
	</td>
</tr>
