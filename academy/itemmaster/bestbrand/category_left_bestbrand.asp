...
function RefreshLeftBestBrandRec(){
	if (document.refreshFrm.cdl.value == ""){
		...
		document.refreshFrm.cdl.focus();
		 ...
		 refreshFrm.action = "<%=wwwFingers%>/chtml/make_category_left_bestBrand_JS.asp";
		 refreshFrm.submit();
	}
}
...
<tr align="center" bgcolor="#FFFFFF" >
	...
	<td align="left">
		카테고리 : <% DrawSelectBoxacademyCategoryLarge "cdl", cdl %> /
		사용유무 :
...
<tr bgcolor="#FFFFFF" align="center">
	...
	<td>
		<a href="/academy/itemmaster/bestbrand/category_left_bestbrand_write.asp?mode=edit&idx=<%= omd.FItemList(i).Fidx %>&page=<%=page%>">
		<img src="<%= imgFingers & "/left/bestbrand/" & omd.FItemList(i).Fimage %>" border="0" height="60"></a>
	</td>
