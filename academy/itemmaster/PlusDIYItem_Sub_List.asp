...
function PlusDIYItem_Edit(){
	var popwin = window.open('PlusDIYItem_Edit.asp','PlusDIYItem_Edit','width=900,height=600,scrollbars=yes,resizable=yes')
	popwin.focus();
}

function PlusDIYItem_Sub_Edit(iitemid){
	var popwin = window.open('PlusDIYItem_Sub_New.asp?itemid=' + iitemid,'PlusDIYItem_Sub_Edit','width=600,height=450,scrollbars=yes,resizable=yes')
	popwin.focus();
}

function PlusDIYItem_Sub_New(){
	var popwin = window.open('PlusDIYItem_Sub_New.asp','PlusDIYItem_Sub_New','width=600,height=450,scrollbars=yes,resizable=yes')
	popwin.focus();
}
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a" style="padding-top:10;">
	<tr>
		<td align="left">
			<!-- <input type="button" class="button" value="신규등록1" onClick="PlusDIYItem_Edit();"> -->
			<input type="button" class="button" value="신규등록" onClick="PlusDIYItem_Sub_New();">
		</td>
		<td align="right">
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
    ...
    <tr align="center" bgcolor="#FFFFFF">
    	<td><a href="javascript:PlusDIYItem_Sub_Edit('<%= oPlusSaleItem.FItemList(i).FPlusSaleItemID %>')"><%= oPlusSaleItem.FItemList(i).FPlusSaleItemID %></a></td>
    	<td><img src="<%= oPlusSaleItem.FItemList(i).FImageSmall %>" width="50"></td>
      	<td><%= oPlusSaleItem.FItemList(i).FMakerID %></td>
      	<td><a href="javascript:PlusDIYItem_Sub_Edit('<%= oPlusSaleItem.FItemList(i).FPlusSaleItemID %>')"><%= oPlusSaleItem.FItemList(i).FItemName %></a></td>
      	<td>
