...
<%
	...
	if page="" then page=1
	if searchKey="" then searchKey="partyname"
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	<form name="frm_search" method="GET" action="partnerGroupLecture_list.asp" onSubmit="return chk_form(this)">
	...
	<tr align="center" bgcolor="#FFFFFF" >
		...
		<td align="left">
			...
			<select name="searchKey">
				...
				<option value="partyname">모임명</option>
				<option value="lecturename">강좌명</option>
				<option value="partymastername">대표자명</option>
			</select>
			<script language="javascript">
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
		...
		<td align="center" width="60">강좌명</td>
		<td align="center" width="110">강좌일</td>
		<td align="center">모임명</td>
		<td align="center" width="70">인원수</td>
		<td align="center" width="60">대표자명</td>
	...
	<tr align="center" bgcolor="<%=bgcolor%>">
		...
		<td align="left"><a href="/academy/Partnership/partnerGroupLecture_view.asp?idx=<%= oLecture.FItemList(lp).Fidx %>&page=<%=page & param%>"><%= oLecture.FItemList(lp).Flecturename %></a></td>
		<td><%= oLecture.FItemList(lp).Flecturedate %></td>
		<td align="left"><a href="/academy/Partnership/partnerGroupLecture_view.asp?idx=<%= oLecture.FItemList(lp).Fidx %>&page=<%=page & param%>"><%= oLecture.FItemList(lp).Fpartyname %></a></td>
		<td><%= oLecture.FItemList(lp).Fpartymannumber %></td>
		<td><%= oLecture.FItemList(lp).Fpartymastername %></td>
		<td><%= oLecture.FItemList(lp).Fpartymasterhp %></td>
