...
<%
	...
	if page="" then page=1
	if searchKey="" then searchKey="compname"
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	<form name="frm_search" method="GET" action="partnerJoinAdv_list.asp" onSubmit="return chk_form(this)">
	...
	<tr align="center" bgcolor="#FFFFFF" >
		...
		<td align="left">
			...
			<select name="searchKey">
				...
				<option value="comment">제휴/광고 내용</option>
			</select>
			<script language="javascript">
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
		...
		<td align="center" width="120">회사명</td>
		<td align="center" width="70">담당자명</td>
	...
	<tr align="center" bgcolor="<%=bgcolor%>">
		...
		<td align="left"><a href="/academy/Partnership/partnerJoinAdv_view.asp?idx=<%= oLecture.FItemList(lp).Fidx %>&page=<%=page & param%>"><%= oLecture.FItemList(lp).Fcompname %></a></td>
		<td><a href="/academy/Partnership/partnerJoinAdv_view.asp?idx=<%= oLecture.FItemList(lp).Fidx %>&page=<%=page & param%>"><%= oLecture.FItemList(lp).Fchargename %></a></td>
		<td><%= oLecture.FItemList(lp).Fchargepost %></td>
		<td><%= oLecture.FItemList(lp).Fchargetel %></td>
		<td><%= oLecture.FItemList(lp).Fchargehp %></td>
