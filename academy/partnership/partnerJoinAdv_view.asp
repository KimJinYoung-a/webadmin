...
<tr align="center" bgcolor="#F0F0FD">
	<td height="26" align="left" colspan="4"><b>제휴·광고 문의 상세 내용 / 답변 작성</b></td>
</tr>
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF">회사명</td>
	<td bgcolor="#FDFDFD" colspan="3"><%=oLecture.FItemList(0).Fcompname%></td>
</tr>
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF">회사주소</td>
	<td bgcolor="#FDFDFD" colspan="3"><%=oLecture.FItemList(0).Fcompaddress%></td>
</tr>
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF">담당자명</td>
	<td bgcolor="#FDFDFD" width="260"><%=oLecture.FItemList(0).Fchargename%></td>
	<td align="center" width="120" bgcolor="#DDDDFF">소속부서</td>
	<td bgcolor="#FDFDFD" width="260"><%=oLecture.FItemList(0).Fchargepost%></td>
</tr>
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF">회사전화</td>
...
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF">회사이메일</td>
	<td bgcolor="#FDFDFD" colspan="3"><%=oLecture.FItemList(0).Fchargemail%></td>
</tr>
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF">회사홈페이지</td>
...
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF">제휴내용</td>
	<td bgcolor="#FDFDFD" colspan="3"><%=nl2br(oLecture.FItemList(0).Fcomment)%></td>
</tr>
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF">회사소개</td>
