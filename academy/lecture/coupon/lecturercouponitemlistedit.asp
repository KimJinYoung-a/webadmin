...
function addnewItem(couponCD,evtCd){
	...
	<% if ocouponitemlist.FTotalCount > 0 then %>
		//alert('강좌쿠폰은 하나의 쿠폰에 하나의 강좌만 등록 하실수 있습니다');
		//return;
	<% end if %>
...
<tr align="center" bgcolor="#FFFFFF" >
	...
	<td align="left">
        ...
        <br>
        상품코드:<input type="text" name="sRectlectureridxArr" value="<%= sRectlectureridxArr %>" size="50" maxlength="50">
	</td>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a" style="padding-top:10;">
	<tr>
		...
		<td align="right">
			<input type="button" class="button" value="신규등록" onclick="addnewItem('<%= lecturercouponidx %>');">
		</td>				
	</tr>
</table>
<!-- 액션 끝 -->
