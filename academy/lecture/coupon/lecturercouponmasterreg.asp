...
<tr align="center" bgcolor="#FFFFFF" >
	...
	<td align="left">
		쿠폰번호 : <input type="text" name="lecturercouponidx" value="<%= lecturercouponidx %>" Maxlength="12" size="12" readonly >
	</td>
...
<tr bgcolor="#DDDDFF">
	...
	<td bgcolor="#FFFFFF">
		...
		<input type="radio" name="lecturercoupontype" value="2" <% if oitemcouponmaster.FOneItem.Flecturercoupontype="2" then response.write "checked" %> > 원
		<!--<input type="radio" name="lecturercoupontype" value="3" <% if oitemcouponmaster.FOneItem.Flecturercoupontype="3" then response.write "checked" %> > 배송료할인쿠폰 (2000 입력)-->
	</td>
</tr>
<tr bgcolor="#DDDDFF">
	<td >적용기간</td>
...
<tr bgcolor="#DDDDFF">
	...
	<td bgcolor="#FFFFFF">
		...
		<option value="10" <% if oitemcouponmaster.FOneItem.Fmargintype="10" then response.write "selected" %> >핑거스부담
