...
olecture.GetNewLectureList '리뉴얼
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="a" bgcolor="F4F4F4">
    ...
    <tr height="30" >
        ...
        <td valign="top">
			...
			강좌코드 : <input type="text" name="lec_idx" size="8" value="<%= lec_idx %>">&nbsp;강좌명 :
...
<table width="100%" border="0" align="center" class="a" cellpadding="2" cellspacing="1" bgcolor="#BABABA">
	...
	<tr align="center" bgcolor="#DDDDFF">
		<td></td>
		<td colspan="13" align="right">검색건수 : <%= olecture.FTotalCount %> 건 Page : <%= page %>/<%= olecture.FTotalPage %></td>
	</tr>
	<tr align="center" bgcolor="#DDDDFF">
		...
		<td align="center" width="60">강좌(시작)일</td>

		<td align="center" width="70">접수기간</td>
		<td align="center" width="40">수강료</td>
		<td align="center" width="30">정원</td>
	</tr>
