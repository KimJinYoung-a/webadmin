...
itemoption= RequestCheckvar(request("itemoption"),16)
...
function AddOptionPop(iitemid){
    var popwin = window.open('pop_diyItemOptionAdd.asp?itemid=' + iitemid,'pop_optionAdd','width=800,height=600,scrollbars=yes,resizable=yes');
    popwin.focus();
}
</script>
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="a" bgcolor=#BABABA>
  <form name=frmmaster method=post action=do_diyItemoptionedit.asp onSubmit="return false;">
...
<form name="frmEdit" method="post" action="do_diyItemoptionedit.asp">
...
<form name="frmOption" method="post" action="do_diyItemoptionedit.asp">
<input type="hidden" name="mode" value="">
