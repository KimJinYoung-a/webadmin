...
if optAddType="" then optAddType="S"
...
<tr>
    ...
    <input type="radio" name="optAddType" value="S" <%= chkIIF(oitemoption.IsMultipleOption,"disabled","") %> <%= chkIIF(optAddType="S","checked","") %> onClick="SelectAddType('S');"><a href="javascript:SelectAddType('S');">옵션 추가</a>
    &nbsp;
	...
	if (ret){
        ...
        for(var i = 0; i < frm.addopt.options.length; i++) {
            ...
            if (frm.addopt.options[i].value == "0000") {
                ...
                frm.addopt.options[i].value = "00" + optvalue;
                optvalue = optvalue + 1;
            }
