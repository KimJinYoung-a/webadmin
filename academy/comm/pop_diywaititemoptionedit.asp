...
partnerDiyMargin = npartner.FPartnerList(0).Fdiy_margin
...
if (oitem.FOneItem.Fsellcash<>0) then
    ...
    ''브랜드 디폴트 마진으로 설정.
    ItemDefaultMargin = partnerDiyMargin
end if
...
function AddOptionPop(iitemid){
    var popwin = window.open('pop_diywaititemoptionAdd.asp?itemid=' + iitemid,'pop_diywaititemoptionAdd','width=800,height=600,scrollbars=yes,resizable=yes');
    popwin.focus();
}
</script>
