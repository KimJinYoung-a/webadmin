...
function saveDoubleOptionAdd(){
	...
	// 핑거스 자체상품도 이중옵션 가능, skyer9, 2016-08-09
...
<!-- 이중옵션 -->
    ...
    <table border="0" cellspacing="1" cellpadding="2" width="100%" class="a" bgcolor="#BABABA">
    <form name="frmDoubleOption" method="post" action="do_diyItemoptionedit.asp">
...
<form name=frmarr method=post action="do_diyItemoptionedit.asp">
