...
function popLecSelct(compname){
	var popwin = window.open('/academy/lib/popselectlecturer.asp?parentcomp=' + compname,'popLecSelct','width=200,height=200,scrollbars=yes,resizable=yes');
	popwin.focus();
}

function SelectLec(compname){
	var lecturer = eval(compname).form.lecuserid.value;
	var popwin = window.open('/academy/lib/popselectlec.asp?lecturer=' + lecturer + '&parentcomp=' + compname,'popLecSelct','width=800,height=600,scrollbars=yes,resizable=yes');
	popwin.focus();
}
...
<form name="frm_write" method="POST" action="<%=imgFingers%>/linkweb/doArtistRoom.asp" enctype="multipart/form-data">
<input type="hidden" name="mode" value="write">
<tr align="center" bgcolor="#F0F0FD">
	<td height="26" align="left" colspan="2"><b>작가의방 신규 등록</b></td>
</tr>
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF"><font color="darkred">* </font>작가 ID</td>
	<td bgcolor="#FFFFFF"><input type="text" name="lecuserid" size="20" maxlength="32" readonly > <input type="button" value="작가선택" onclick="popLecSelct('frm_write.lecuserid')"></td>
</tr>
<tr>
...
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF"><font color="darkred"></font>작가 타이틀</td>
	<td bgcolor="#FFFFFF"><input type="text" name="atitle" size="50" maxlength="50"></td>
</tr>
<tr>
...
<% else %>
<table width="100%" border="0" class="a" cellpadding="2" cellspacing="1" bgcolor="#BABABA">
<form name="frm_modi" method="POST" action="<%=imgFingers%>/linkweb/doArtistRoom.asp" enctype="multipart/form-data">
...
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF"><font color="darkred">* </font>작가 ID</td>
	<td bgcolor="#FFFFFF"><input type="text" name="lecuserid" value="<%= oartistroom.FOneItem.Flecuserid %>" size="20" maxlength="32" readonly></td>
</tr>
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF"><font color="darkred">* </font>강좌개요</td>
...
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF"><font color="darkred"></font>작가 타이틀</td>
	<td bgcolor="#FFFFFF"><input type="text" name="atitle" size="50" maxlength="50" value="<%= oartistroom.FOneItem.Ftitle %>"></td>
</tr>
<tr>
	<td align="center" width="120" bgcolor="#DDDDFF"><font color="darkred">* </font>강좌개요 이미지</td>
	<td bgcolor="#FFFFFF">
