...
function fnVodDelete(){
	...
	document.vod.action="/apps/academy/itemmaster/popup/DIYItemPopupDetailinfoEdit_Process.asp";
...
<div class="wrap bgGry">
	<div class="container">
		<!-- content -->
		<form name="vod" method="post" onsubmit="return false;" autocomplete="off">
