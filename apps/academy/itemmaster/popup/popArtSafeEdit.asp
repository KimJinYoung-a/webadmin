...
if (itemid<>"") then
oitem.GetOneItem
safetyYn=oitem.FOneItem.FsafetyYn
safetyDiv=oitem.FOneItem.FsafetyDiv
safetyNum=oitem.FOneItem.FsafetyNum
End If
...
function fnAppCallWinConfirm(){
	if($("#safetyYn").val()=="Y"){
		if($("#safeCertify option:selected").val()==""){
			...
			document.safe.action="/apps/academy/itemmaster/popup/DIYItemPopupDetailinfoEdit_Process.asp";
