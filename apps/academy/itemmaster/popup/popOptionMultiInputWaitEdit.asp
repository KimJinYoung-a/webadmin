...
<%
Dim waititemid, OptionDiv, WinTitle, ItemDefaultMargin, SellCash, BuyCash, DefaultMargin, thisUrl, resetmode
...
if waititemid<>"" then
	oitemoption.GetWaitItemMultipleOptionInfo
						...
						<dl class="optionUnit">
							...
							<dd id="optdiv<%=i%>">
								<ul>
									<li>
										<div>
											<span><input type="text" name="optionName" value="<%= oitemoption.FITemList(i).FoptionKindName %>" id="optionName" placeholder="옵션 내 항목" style="width:100%;" /></span>
										</div>
									</li>
									<li>
										<div>
