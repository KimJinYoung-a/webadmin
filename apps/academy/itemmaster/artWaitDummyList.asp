...
<%
Dim pageTitle
pageTitle="2016 The Fingers Artist Admin App - 작품 관리 더비"
%>
				...
				<div class="artListCont">
					...
					<div class="artListWrap">
						<ul class="artList">
							...
							<li class="<%= owaititem.FItemList(i).GetCurrStateCssClass %>" onclick="fnCloneItem('<%= owaititem.FItemList(i).Fitemid %>','W');"><!-- 판매중(↓ 상태표시에 따라 클래스 artFlag1 ~ artFlag8 붙습니다) //-->
									<div class="artStatus">
						...
						<div class="paging">
							<%=fnDisplayPaging_New(page,owaititem.FTotalCount,12,"jsGoPage")%>
						</div>
					</div>
				</div>
				</form>
