...
<%
Dim pageTitle
pageTitle="2016 The Fingers Artist Admin App - 강사 신청"
%>
...
function fnlectureSubmit(f){
	...
	if (!check_form_email(f.lecmail.value)){
	    alert("이메일 주소가 유효하지 않습니다.");
		f.lecmail.focus();
		return ;
	}
	if (f.leccontent.value == ''){
		alert('강사소개글을 입력해주세요.');
		f.leccontent.focus();
		return;
	}									
	...
	if($(':radio[name="lecwork"]:checked').length < 1){
		alert('강의경험 유무를 선택해주세요.');
		return;
	}
	if($(':radio[name="area"]:checked').length < 1){
		alert('진행방식을 선택해주세요');
		return;
	}
	...
	<div class="container headB bgGry1">
		<div class="content partnerRequest">
			<ul class="tabNav tab1">
				<li><a href="/apps/academy/partnership/partnership_register.asp" onclick="location.replace('/apps/academy/partnership/partnership_register.asp');return false;">작가 신청</a></li>
				<li class="current"><a href="/apps/academy/partnership/partnership_lecturer.asp" onclick="location.replace('/apps/academy/partnership/partnership_lecturer.asp');return false;">강사 신청</a></li>
			</ul>
			<div class="box1 lectureType">
			<form name="frm" method="post" action="<%=uploadUrl%>/linkweb/academy/partnership/doPartnerShip_lecture_app.asp" EncType="multipart/form-data">
				...
				<div class="fingerTable tMar1-5r">
					<table>
						...
						<tr>
							<th><label for="teacherName">강사명<em class="needs">*</em></label></th>
							<td><input type="text" name="lecname" id="teacherName" /></td>
						</tr>
						<tr>
							<th><label for="kind">강좌분야<em class="needs">*</em></label></th>
							<td><input type="text" name="lecarea" id="kind" /></td>
						</tr>
						<tr>
							...
							<td>
								...
								<p class="tMar0-5r"><input type="text" name="txAddr1" readonly /></p>
								<p class="tMar0-5r"><input type="text" name="txAddr2" /></p>
							</td>
						</tr>
						<tr>
							<th><label for="teacherPhone">휴대폰<em class="needs">*</em></label></th>
							<td><input type="tel" name="lechp" id="teacherPhone" maxlength="13" pattern="[0-9]*" /></td>
						</tr>
						<tr>
							<th><label for="teacherTel">전화</label></th>
							<td><input type="tel" name="lectel" id="teacherTel" /></td>
						</tr>
						<tr>
							<th><label for="teacherMail">이메일<em class="needs">*</em></label></th>
							<td><input type="email" name="lecmail" id="teacherMail" placeholder="예)id@example.com" /></td>
						</tr>
						<tr>
							<th><label for="homepage">홈페이지</label></th>
							<td><input type="url" name="lecurl" id="homepage" value="http://" /></td>
						</tr>
						<tr>
							<th><label for="introduce">강사소개<em class="needs">*</em></label></th>
							<td><textarea id="introduce" name="leccontent" cols="20" rows="4"></textarea></td>
						</tr>
						<tr>
							<th><label for="curriculum">강좌내용<em class="needs">*</em></label></th>
							<td><textarea id="curriculum" name="lectitle" cols="20" rows="4"></textarea></td>
						</tr>
						<tr>
							<th>강의경험<em class="needs">*</em></th>
							<td>
								<div class="flexInp">
									<p><span class="form4"><input type="radio" id="expY" name="lecwork" value="Y" /><label for="expY"><em>있음</em></label></span></p>
									<p><span class="form4"><input type="radio" id="expN" name="lecwork" value="N" /><label for="expN"><em>없음</em></label></span></p>
								</div>
							</td>
						</tr>
						<tr>
							<th>진행방식<em class="needs">*</em></th>
							<td>
								<div class="flexInp placeType">
									<p><span class="form4"><input type="radio" id="place1" name="area" value="0" /><label for="place1"><em>내부진행<br />(더핑거스)</em></label></span></p>
									<p><span class="form4"><input type="radio" id="place2" name="area" value="1" /><label for="place2"><em>외부진행<br />(공방 또는 매장)</em></label></span></p>
								</div>
							</td>
						</tr>
					</table>
			...
			<div class="btnGroup pad1-5r">
				<button type="button" onclick="javascript:fnlectureSubmit(frm);" class="btn btnB1 btnYgn">문의하기</button>
			</div>
		</div>
