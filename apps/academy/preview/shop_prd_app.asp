...
<%
	...
	set addEx = new DIYItemPrdCls
		addEx.getItemAddExplain itemid ,"Y"
	...
	Set itemVideos = New DIYItemPrdCls
		itemVideos.fnGetItemVideos itemid, "video1" ,"Y"
			...
			<div class="detailImg <%=chkiif(Not(itemVideos.Prd.FvideoFullUrl="")," isVideo","")%>">
				<div class="swiper-container">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide"><img src="<%= oAdd.FADD(i).FAddimage %>" alt="<%= oItem.Prd.FItemName %>" /></div>
						<% End IF %>
						<% NEXT %>
						<% END IF %>							
