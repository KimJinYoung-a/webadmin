...
DIM CAddDetailSpliter : CAddDetailSpliter= CHR(3)&CHR(4)
 ...
 Dim staticImgUrl,uploadUrl, uploadUrl2,wwwUrl,SSLUrl, g_AdminURL,fingersImgUrl,mailzinUrl , webImgUrl, www1Url, SSL1Url, imgFingers
 ...
 IF application("Svr_Info")="Dev" THEN
	...
	uploadUrl2		= "http://testupload.10x10.co.kr"
 ...
 ELSE
 	...
 	uploadUrl		= "https://upload.10x10.co.kr"
 	fingersImgUrl	= "http://oimage.thefingers.co.kr"
	imgFingers 		= "http://oimage.thefingers.co.kr"
	...
	uploadUrl2		= "http://upload.10x10.co.kr"
