...
{ 
  ...
  this.iconImg = 0; 
  this.nodeImg = 0;
  this.iconSrc = ICONPATH + "openfolder.png";
  this.iconSrcClosed = ICONPATH + "closedfolder.png";
...
{ 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
      ...
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "I.png>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=19 height=16 border=0></a></td>"
  ...
  docW = docW + "<tr>" + leftSide + "<td valign=top onClick='clickOnNode(\""+this.getID()+"\")' style='cursor:pointer'>";
  if (USEICONS)
  {
  ...
  {
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "blank.png height=2 width=2>"
  }
  if (WRAPTEXT)
	  docW = docW + "</td>"+this.prependHTML+"<td valign=middle width=100% onClick='clickOnNode(\""+this.getID()+"\")' style='cursor:pointer'>"
  else
	  docW = docW + "</td>"+this.prependHTML+"<td valign=middle nowrap width=100% onClick='clickOnNode(\""+this.getID()+"\")' style='cursor:pointer'>"
  if (USETEXTLINKS) 
  { 
...
function nodeImageSrc() {
  ...
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "L.png"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "Lminus.png"  
      else
        srcStr = ICONPATH + "Lplus.png"  
  } 
  else 
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "T.png"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "Tminus.png"
      else
        srcStr = ICONPATH + "Tplus.png"
  }   
  return srcStr;
}
...
function finalizeCreationOfItem(itemArray)
{
  ...
  itemArray.iconSrc = ICONPATH + "paper2.gif" 
...
{ 
  ...
  if (this.level>0) 
    ...
    { 
      leftSide = leftSide + "<td valign=top><img src='" + ICONPATH + "L.png' width=19 height=16></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "I.png><img src='" + ICONPATH + "T.png' width=19 height=16></td>"
    } 
  ...
  if (USEICONS)
	  ...
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "blank.png height=2 width=3>"
...
function leftSideHTML(leftSideCoded) {
	...
	for (i=0; i<leftSideCoded.length; i++)
	{
		...
		{
			retStr = retStr + "<td valign=top background=" + ICONPATH + "I.png><img src='" + ICONPATH + "I.png' width=19 height=16></td>"
		}
		if (leftSideCoded.charAt(i) == "0")
		{
			retStr = retStr + "<td valign=top><img src='" + ICONPATH + "blank.png' width=19 height=16></td>"
		}
	}
	return retStr
}
...
function finalizeCreationOfChildDocs(folderObj) {
  for(i=0; i < folderObj.nChildren; i++)  {
    ...
    if (typeof child[0] != 'undefined')
    {
      ...
      if (child[2]) child[0]="<font color=" + child[2] + ">" + child[0] + "</font>"
...
function gFld(description, hreference, mcolor) 
{ 
