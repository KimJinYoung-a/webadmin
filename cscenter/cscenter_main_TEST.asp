...
dim onemonthbefore, nowdate1800, twomonthbefore, treemonthbefore
...
if (IsUpdateOneToOneBoardNeed = True) then
	...
	sqlStr = sqlStr & "JOIN [db_temp].dbo.tbl_mibeasong_list T on 1 = 1 and d.orderserial=T.orderserial and d.idx=T.detailidx "
	sqlStr = sqlStr & "LEFT JOIN db_cs.dbo.tbl_cs_michulgo_stockout_order u on 1 = 1 and m.orderserial = u.orderserial and u.deleteyn = 'N' "
	...
	sqlStr = sqlStr & "	and d.itemid<>0 and d.cancelyn <> 'Y' and IsNull(T.code,'00')='05' and IsNull(T.state, '0')='0' "
...
if (IsUpdateIpjumRefundNeed = True) then
	...
	sqlStr = sqlStr + " WHERE "
	sqlStr = sqlStr + " 	1 = 1 "
	sqlStr = sqlStr + " 	and a.regdate >= DateAdd(m, -2, getdate()) "
	sqlStr = sqlStr + " 	and m.sitename <> '10x10' "							'// 입점몰주문
...
'미처리메모
dim CSMemoNotFinish, CSMemoNotFinishFIN
        	        ...
        	        <td>
						...
						<tr height="25">
            			    ...
            			    <td align="right">
        				    	...
        				    	<a href="javascript:cscenter_memo_list_FIN('','','N', '<%=csMainUserID%>');">
                    				<img src="/images/icon_arrow_right.gif" align="absbottom" border="0">
                    		    </a>
            			    </td>
            			</tr>
