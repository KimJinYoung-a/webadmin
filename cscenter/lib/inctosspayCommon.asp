...
<%
    ...
    '스테이징서버
        TossPay_OrderSuccess_Url       = "http://stgwww.10x10.co.kr/inipay/tosspay/ordertemp_tossresult.asp" '//결제성공시이동할url
        TossPay_OrderFail_Url          = "http://stgwww.10x10.co.kr/inipay/tosspay/ordertemp_tossfail.asp" '//결제실패시이동할url
        TossPay_OrderCancel_Url        = "http://stgwww.10x10.co.kr/inipay/tosspay/ordertemp_tossfail.asp" '//결제취소시이동할url
        TossPay_RestApi_Key            = "sk_test_M1Neq1wmNjM1NeG3Klkj"'//가맹점코드(테스트용)
