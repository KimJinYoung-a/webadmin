...
'ippbxLocalCallArr = Array("901","902","903","904","905","906","907","908","909","910","911","912","913","914","915")
'ippbxMatchUserArr = Array("   ","bseo","limpid727","durida22","ilovecozie","greenmon","hasora","boyishP","porco0805","zerogirl0730","oesesang52","aida82","danseur0810","","hpjy1004")
...
if (session("ssBctId") <> "") then
	...
	if  not rsget.EOF  then
		ippbxLocalUser = "user" & rsget("localcallno")
	end if
	rsget.close
end if
    ...
    <td>
        ...
        <TR>
            ...
            <td align="right">
                ...
                &nbsp;
                <span id="restinfo" name=""><input type=button class=button value='전화허용중임' onClick='javascript:rest_set()'></span>
...
function parseLogin(kind,data1,data2,data3,data4)
{
	...
	if(kind == "LOGIN_OK")
	{
		...
		if (RestStatus == "0"){
		    document.all.restinfo.innerHTML="<input type=button class=button value='전화허용중임' STYLE='width:100; ' onClick='javascript:rest_set()'>";
	    }else{
	        document.all.restinfo.innerHTML="<input type=button class=button value='전화비허용중임' STYLE='width:100; color:red;' onClick='javascript:rest_reset()'>";
	    }
