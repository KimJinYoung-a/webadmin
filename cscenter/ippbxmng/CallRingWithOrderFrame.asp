...
<%
dim i, userid, orderserial,id, mode, sqlStr, ippbxuser, intel, phoneNumber, phoneNumberOut, yyyy1,mm1,dd1, hh1, retrydateyn
dim isEditMode
...
%>
<script type="text/javascript" src="/cscenter/js/date.format.js"></script>
<script type="text/javascript" src="/cscenter/ippbxmng/ippbxClick2Call.js"></script>
...
function reInput(){
    document.location.href = '/cscenter/ippbxmng/CallRingWithOrderFrame.asp';
}
...
<tr>
	...
	<td bgcolor="#FFFFFF">
    	...
    	<tr>
    	    ...
    	    <td width="90" align="center"><a href="javascript:fnClick2Call(frm.phoneNumber);">전화걸기</a></td>
...
<tr>
	<td colspan="2">
		<iframe id="i_history_memo" name="i_history_memo" src="/cscenter/ippbxmng/iframeHistory.asp?userid=<%= userid %>&orderserial=<%= orderserial %>&phoneNumer=<%= phoneNumber %>&id=<%= id %>" width="100%" height="500" scrolling="auto" frameborder="0"></iframe>
	</td>
</tr>
</table>
