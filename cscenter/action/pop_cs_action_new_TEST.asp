...
function popChkGiftItem() {
	...
	var popwin = window.open('pop_cs_gift_modify.asp?orderserial=' + frm.orderserial.value + '&mode=chk&itemlist=' + itemlist,'pop_cs_gift_modify','width=1280,height=960,scrollbars=yes,resizable=yes');
	popwin.focus();
}
...
<!-- 3-1. 사은품                                                            -->
<!-- ====================================================================== -->
<!-- #include virtual="/cscenter/action/include/inc_cs_action_gift_info_TEST.asp" -->
