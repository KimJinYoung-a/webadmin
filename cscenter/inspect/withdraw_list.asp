...
<tr height="25" valign="top">
	...
	<td align="left">
		...
		<input type="checkbox" name="chkIni" value="on" <% if chkIni="on" then Response.Write "checked"%>>앞글자
...
<tr align="center" bgcolor="#FFFFFF">
	...
	<td width="110"><%= printUserId(oWdw.FItemList(lp).Fuid,2,"**") %></td>
	<td width="80"><% if (FALSE) then %><%= oWdw.FItemList(lp).Fjumin1 %><% end if %></td>
