...
function fnfaq_reg(fidx){
	var reg = window.open('/cscenter/board/faq/staff_manual_faq_edit.asp?menupos=<%=menupos%>&fidx='+fidx,'reg','width=1280,height=700,scrollbars=yes,resizable=yes');
	reg.focus();	
}
...
<tr align="center" bgcolor="#FFFFFF" >
	...
	<td align="left">
        * 사용여부 : <% drawSelectBoxisusingYN "isusing",isusing,"" %>
        &nbsp;
        * 구분 : <% Drawstafffaqgubun "gubun",gubun,"" %>
        <Br><Br>
...
<tr align="center" bgcolor="#FFFFFF" onmouseover=this.style.background="#f1f1f1"; onmouseout=this.style.background='#FFFFFF';>
	...
	<td width=200>
		<%= getstafffaqgubunname(ofaq.FItemList(i).fgubun) %>
	</td>
