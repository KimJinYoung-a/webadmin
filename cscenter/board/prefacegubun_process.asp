...
if (mode = "add") then
	...
	sqlStr = " insert into [db_cs].[dbo].tbl_qna_preface_gubun(masterid,code,cname)"
	...
	sqlStr = "update [db_cs].[dbo].tbl_qna_preface_gubun"
...
alert('처리 되었습니다.');
location.replace('cs_qna_preface_gubun.asp');
</script>
