...
function reitems(upfrm){
	if (!CheckSelected()){
		alert('선택아이템이 없습니다.');
		return;
	}

	var ret = confirm('선택 아이템을 사용하시겠습니까?');
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="#FFFFFF" >
		...
		<td align="left">
			분류 : <% SelectBoxQnaPrefaceGubun "01",gubun %>
		</td>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a" style="padding-top:10;">
	<tr>
		<td align="left">
			<input type="button" class="button" value="신규등록" onClick="location.href='cs_user_qna_preface_reg.asp?mode=add'">
			&nbsp;
			<input type="button" class="button" value="선택아이템사용안함" onclick="delitems(delform);">
			&nbsp;
			<input type="button" class="button" value="선택아이템사용" onclick="reitems(delform);">
		</td>
		<td align="right">
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="#FFFFFF">
		...
		<td align="left"><a href="cs_user_qna_preface_reg.asp?mode=edit&idx=<%= omd.FItemList(i).Fidx %>"><%= omd.FItemList(i).Fcontents %></a></td>
...
<form name="delform" method="post" action="preface_del_process.asp">
