...
function billTaxEvalFlexApi(pidx){
    ...
    var obj34 = AddNew("BUY_DAM_NM","최보연");
    ...
    var objline2 = AddNew("NM_ITEM", "온라인 <%= makerid %> 판매대금");
...
function hideLogin(){
    ...
    document.frmAct.evalButton.disabled=false;
}
...
function showLogin(){
    ...
    document.frmAct.evalButton.disabled=true;
    fxStarted = false;
}
...
<table width="100%" border="0" align="center" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
	<form name="frmAct" method="post" action="dotaxreg.asp">
	...
	<input type=hidden name=item_nm value="온라인 <%= makerid %> 판매대금">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td><input type=text name=write_date value="" size="10" maxlength=10 readonly ><a href="javascript:calendarOpen(document.frmAct.write_date);"><img src="/images/calicon.gif" border=0 align=absmiddle></a></td>
		<% else %>
    ...
    <tr valign="bottom" height="25" bgcolor="#FFFFFF">
        <td colspan="2"  align="center">
        	<input type=button name="evalButton" value="전자 <%= stypename %> 발행" onClick="ActTaxReg(document.frmAct)">
        </td>
    </tr>
    </form>
</table>
