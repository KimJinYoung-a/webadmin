...
If gubun = "I" Then
	...
	If mallgubun = "all" Then
		...
		strSQL = strSQL & " WHERE makerid = '"&vMakerID&"' and mallgubun <> 'all' and mallgubun <> 'daumep' and mallgubun <> 'naverep' and mallgubun <> 'shodocep'  " & vbcrlf
...
<tr align="center" bgcolor="#FFFFFF">
	...
	<td><input type="text" name="whyhope" size="80" class="text" onkeydown="if(event.keyCode==13){alert('저장 버튼을 클릭해주세요.');event.returnValue=false;}"></td>
