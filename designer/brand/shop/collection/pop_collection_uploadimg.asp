...
sName = requestCheckVar(Request.Querystring("sName"),200)
sSpan = requestCheckVar(Request.Querystring("sSpan"),200)
%>
...
<form name="frmImg" method="post" action="<%= uploadUrl %>/linkweb/street/docollectionupload.asp" enctype="MULTIPART/FORM-DATA" onSubmit="return jsUpload();">
