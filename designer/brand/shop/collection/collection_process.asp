...
If mode = "I" Then
	...
	Response.Write "<script language='javascript'>alert('저장되었습니다');location.replace('/designer/brand/shop/collection/collectionModify.asp?idx="&idx&"&menupos="&menupos&"');</script>"
