...
Dim page, isusing, gal_div, designerid, lp, oGallery, oGalleryitem
	...
	gal_div = requestCheckVar(request("gal_div"),30)
	designerid = requestCheckVar(request("designerid"),50)
...
<script language="javascript">
	...
	function regmainbanneritem()
	{
		if (searchForm.itemid.value==''){
			...
			moveForm.action="/designer/artist/artist_process.asp";
	...
	//입점문의
	function inquiry(){
		var inquiry = window.open('/designer/artist/artist_inquiry.asp','inquiry','width=1024,height=768,scrollbars=yes,resizable=yes');
		inquiry.focus();
	}	
	
	//아티스트추천관리
	function recommend(){
		var recommend = window.open('/designer/artist/artist_recommend.asp','recommend','width=1024,height=768,scrollbars=yes,resizable=yes');
		recommend.focus();
	}	
