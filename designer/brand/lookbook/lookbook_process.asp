...
If mode = "I" Then
	...
	If existsbrandcnt = 0 Then
		...
		Response.Write  "	location.replace('/designer/brand/lookbook/lookbookModify.asp?menupos="&menupos&"');"
	...
	sqlStr = sqlStr & " 	c.userid as makerid, '"&html2db(title)&"', 2, '"&mainimg&"', '"&isusing&"','"&adminid&"'" + vbcrlf
	...
	Response.Write "<script language='javascript'>alert('저장되었습니다');location.replace('/designer/brand/lookbook/lookbookModify.asp?idx="&idx&"&menupos="&menupos&"');</script>"
...
ElseIf mode = "U" Then
	...
	response.write "	location.replace('/designer/brand/lookbook/lookbookModify.asp?idx="&idx&"&menupos="&menupos&"');"
	response.write "</script>"	
