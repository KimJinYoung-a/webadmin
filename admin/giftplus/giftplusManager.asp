...
<tr>
	<td valign="top" width="220">
		<table border="0" cellpadding="2" cellspacing="1" class="a">
			<tr>
				<td>
					<input type="button" value="실서버 왼쪽 메뉴 생성" class="button" onclick="CreateMenu();"><br>
					<input type="checkbox" name="deldisp" <% IF deldisp="true" then response.write "checked" %> onclick="fnDelDisp(this.checked);">삭제메뉴보기
				</td>
			</tr>
		</table>
		<table border="0" cellpadding="2" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
			...
			<tr bgcolor="#FFFFFF">
				<td align="center" colspan="4">
					<input type="button" class="button" value="추가" onclick="PopAddMenu('L','','','');">
				</td>
			</tr>
		</table>
		...
		<table border="0" cellpadding="2" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
			...
			<tr bgcolor="#FFFFFF">
				<td align="center" colspan="4">
					<input type="button" class="button" value="추가" onclick="PopAddMenu('M','<%= cdL %>','','');">
				</td>
			</tr>
		</table>
		<% end if %>
