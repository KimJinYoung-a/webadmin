...
<%
dim linktype, fixtype ,poscode, page ,oposcode,oposcodeList
...
<form name="frmposcode" method="post" action="imagemake_poscode_process.asp" >
<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
    <td colspan="2" align="center">
    	<input type="button" value="저장" onClick="SavePosCode(frmposcode);" class="button">
    </td>
</tr>
</form>
</table>
