	...
	<td bgcolor="#FFFFFF" align="center">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="a" id="cashtbl"> 
			...
			strSQL =" SELECT MinCash,MaxCash " &_
					" FROM [db_giftplus].[dbo].[tbl_giftplus_CashMenu] " &_
					" WHERE LCode='" & cdL &"' "
...
<iframe name="frame" src="" frameborder="0" width="300" height="300"></iframe>
<% 
set objView = nothing 
%>
