...
<tr bgcolor="#DDDDFF">
	<td >상품ID</td>
	<td bgcolor="#FFFFFF"><input type="text" name="linkitemid" value="0" size="9" maxlength="9">
...
<tr bgcolor="#DDDDFF">
	<td >상품ID</td>
	<td bgcolor="#FFFFFF"><input type="text" name="linkitemid" value="<% = olec.Flinkitemid %>" size="9" maxlength="9">
	<input type="button" value="목록에서선택" onClick="popLectureItemList();">
