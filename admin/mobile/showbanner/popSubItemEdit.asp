...
If subidx <> "" then
	dim oShowBannerItem
	set oShowBannerItem = new CShowBannerContents
	oShowBannerItem.FRectSubIdx = subidx
	oShowBannerItem.GetOneSubItem()

	subIdx			=	oShowBannerItem.FOneItem.Fidxsub
	listidx			=	oShowBannerItem.FOneItem.Fidx
	subItemid		=	oShowBannerItem.FOneItem.FItemid
	sortnum			=	oShowBannerItem.FOneItem.Fsortnum
	isusing			=	oShowBannerItem.FOneItem.Fisusing
	itemName		=	oShowBannerItem.FOneItem.FitemName
	smallImage		=	oShowBannerItem.FOneItem.FsmallImage

	set oShowBannerItem = Nothing
End If 
%>
...
<center>
<form name="frm" method="post" action="showbannerproc.asp" >
