...
If subidx <> "" then
	dim oOnAirItem
	set oOnAirItem = new Cjustoneday
...
<center>
<form name="frm" method="post" action="<%=uploadUrl%>/linkweb/mobile/justoneday_proc.asp" enctype="multipart/form-data" style="margin:0px;">
...
<tr bgcolor="#FFFFFF">
	<td bgcolor="#FFF999">주말/휴일 이미지</td>
	<td colspan="3">
...
<tr bgcolor="#FFFFFF">
	<td bgcolor="#FFF999">이미지 링크</td>
	<td colspan="3">
		<input type="text" name="extraurl" value="<%=extraurl%>" style="width:80%;" />
	</td>
</tr>
<tr bgcolor="#FFFFFF">
