...
if Scnt>0 then
    sqlStr = " insert into [db_sitemaster].[dbo].tbl_mobile_main_justoneday_item" + VbCrlf
    ...
    sqlStr = sqlStr + " 		from [db_sitemaster].[dbo].tbl_mobile_main_justoneday_item" + VbCrlf
