...
If subidx <> "" then
	dim pickItem
	set pickItem = new Cpick
	pickItem.FRectSubIdx = subidx
	pickItem.GetOneSubItem()

	subIdx			=	pickItem.FOneItem.FsubIdx
	listidx			=	pickItem.FOneItem.Flistidx
	subItemid		=	pickItem.FOneItem.FItemid
	sortnum		=	pickItem.FOneItem.Fsortnum
	isusing			=	pickItem.FOneItem.Fisusing
	itemName		=	pickItem.FOneItem.FitemName
	smallImage	=	pickItem.FOneItem.FsmallImage

	set pickItem = Nothing
End If 
%>
...
<center>
<form name="frm" method="post" action="dopick.asp">
