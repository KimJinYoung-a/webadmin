...
sqlStr = "select top 1 * from [db_sitemaster].[dbo].tbl_mobile_mainCont_code"
...
if (ItemExists) then
    sqlStr = " update [db_sitemaster].[dbo].tbl_mobile_mainCont_code" + VbCrlf
    ...
    sqlStr = " insert into [db_sitemaster].[dbo].tbl_mobile_mainCont_code" + VbCrlf
