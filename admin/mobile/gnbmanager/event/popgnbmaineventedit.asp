...
<script language='javascript'>
	...
	function SaveMainContents(frm){
		...
		if(!maxLengthCheck("Evt_Title","이벤트 메인카피",40))
		{
			frm.Evt_Title.focus();
			return;
		}
		...
		if(!maxLengthCheck("Evt_Subcopy","이벤트 서브카피",80))
		{
			frm.Evt_Subcopy.focus();
			return;
		}
...
<tr bgcolor="#FFFFFF" height="30">
	<td bgcolor="#DDDDFF">이벤트 코드</td>
	<td><input type="text" name="Evt_Code" value="<%=oMainContents.FOneItem.FEvt_Code%>"> <a href="javascript:jsLastEvent(1);">불러오기</a></td>
</tr>
<tr bgcolor="#FFFFFF" height="30">
