...
dim oMainContents
	...
	oMainContents.GetGNBMainEventList
%>
<script type="text/javascript">
<!--
function AddNewMainContents(idx){
    var popwin = window.open('/admin/mobile/gnbmanager/event/popgnbmaineventedit.asp?idx=' + idx+'&<%=strParm%>','mainposcodeedit','width=800,height=600,scrollbars=yes,resizable=yes');
    popwin.focus();
}
//-->
</script>
...
<% end if %>
    ...
    <td align="center">
	[<%= oMainContents.FItemList(i).FEvt_Code %>] <%= oMainContents.FItemList(i).FEvt_Title %>
	</td>
    <td align="center">
    	<a href="javascript:AddNewMainContents('<%= oMainContents.FItemList(i).Fidx %>');"><img src="<%= oMainContents.FItemList(i).Fevt_mainimg %>" border="0" width="100"></a>
    </td>
