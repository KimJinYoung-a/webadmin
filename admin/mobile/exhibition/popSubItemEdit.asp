...
If subidx <> "" then
	dim exhibitionItem
	set exhibitionItem = new Cexhibition
	exhibitionItem.FRectSubIdx = subidx
	exhibitionItem.GetOneSubItem()

	subIdx			=	exhibitionItem.FOneItem.FsubIdx
	listidx			=	exhibitionItem.FOneItem.Flistidx
	subItemid		=	exhibitionItem.FOneItem.FItemid
	sortnum			=	exhibitionItem.FOneItem.Fsortnum
	isusing			=	exhibitionItem.FOneItem.Fisusing
	itemName		=	exhibitionItem.FOneItem.FitemName
	smallImage		=	exhibitionItem.FOneItem.FsmallImage

	set exhibitionItem = Nothing
End If 
%>
