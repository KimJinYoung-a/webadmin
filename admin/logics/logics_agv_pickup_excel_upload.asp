...
<form name="frmFile" method="post" action="<%= uploadUrl %>/linkweb/item/agv/upload_AGV_item_excel.asp"  enctype="MULTIPART/FORM-DATA" style="margin:0px;">
...
<tr bgcolor="#FFFFFF" align="center">
	<td width="60">샘플</td>
	<td align="left"><a href="<%= uploadUrl %>/offshop/sample/item/logics_agv_pickup_sample_v1.xls" target="_blank">logics_agv_pickup_sample_v1.xls</a></td>
</tr>
<tr bgcolor="#FFFFFF" align="center">
	...
	<td align="left">
		...
		<br><br>* 맨 상단의 물류코드, 수량 등이 있는 <font color="red"><b>1줄은 그대로 두세요.</b></font>
