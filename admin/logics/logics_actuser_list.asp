	...
	<tr align="center" bgcolor="#FFFFFF" >
		...
		<td align="left">
			...
			<select class="select" name="actgubun">
				...
				<option value="onlineOrderChulgoForce" <% if (actgubun = "onlineOrderChulgoForce") then %>selected<% end if %> >온라인출고(재출력)</option>
				...
				<option value="offlineOrderChulgo" <% if (actgubun = "offlineOrderChulgo") then %>selected<% end if %> >오프라인샵출고</option>
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="<%= adminColor("tabletop") %>" height="30">
		<td align="center" width="80">IDX</td>
		<td align="center" width="150">구분</td>
		<td align="center" width="250">관련코드</td>
		<td align="center" width="60">상품수</td>
		<td align="center" width="120">사번</td>
		<td align="center" width="60">이름</td>
		<td align="center" width="150">처리일</td>
		<td align="center" width="150">작업시간</td>
    ...
    <tr align="center" bgcolor="#FFFFFF" onmouseover=this.style.background="<%= adminColor("tabletop") %>"; onmouseout=this.style.background="#FFFFFF";>
		<td align="center" height="25">
			<%= oCActUser.FItemList(i).Fidx %>
		</td>
		<td align="left" height="25">
			<%= oCActUser.FItemList(i).GetActGubunName %>
		</td>
		<td align="center">
			<%= oCActUser.FItemList(i).Frefcode %>
		</td>
		<td align="center">
			<%= FormatNumber(oCActUser.FItemList(i).FitemNo, 0) %>
		</td>
		<td align="center">
			<%= oCActUser.FItemList(i).Fempno %>
		</td>
		<td align="center">
			<%= oCActUser.FItemList(i).Fusername %>
		</td>
		<td align="center">
			<%= oCActUser.FItemList(i).Fregdate %>
		</td>
		<td align="center">
