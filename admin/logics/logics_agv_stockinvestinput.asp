...
function AddItems(frm){
	...
	popwin = window.open('/admin/newstorage/popjumunitemNew.asp?suplyer=&changesuplyer=Y&shopid=10x10&idx=0&priceGbn=orgprice&skipChkItemNo=Y','pop_logics_agv_stockinvestinput','width=1280,height=960,scrollbars=yes,resizable=no');
	popwin.focus();
}
...
<table width="100%" border="0" align="center" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
    ...
    <input type="hidden" name="itemno" value="<%= itemnoarr(i) %>">
