...
oldmisend.GetOldMisendListMasterCS_ipkumdiv4
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="#FFFFFF" >
		...
		<td align="left">
			...
			<select name="sitename" class="select">
                ...
                <option value="10x10_cs" <%=CHKIIF(vSiteName="10x10_cs","selected","")%>>텐바이텐(CS)</option>
	...
	<tr align="center" bgcolor="#FFFFFF" >
		<td align="left">
			<input type="radio" name="inputyn" value="" <% if (inputyn = "") then response.write "checked" end if %>> 전체목록
	...
	<tr align="center" bgcolor="#FFFFFF" >
		<td align="left">
            미배등록 상태 :
            <select class="select" name="lackItemOnly">
                <option value="">전체</option>
                <option value="Y" <%= CHKIIF(lackItemOnly="Y", "selected", "") %>>미배등록 완료</option>
                <option value="N" <%= CHKIIF(lackItemOnly="N", "selected", "") %>>미배등록 이전</option>
            </select>
		</td>
	</tr>
	</form>
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="#FFFFFF">
		...
		<td><%= oldmisend.FItemList(i).getBeasongDPlusDateStr %></td>
		<td>
		    <% IF (inputyn="C") then %>
