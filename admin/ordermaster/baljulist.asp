...
<tr align="center">
	...
	<td align="left" bgcolor="#ffffff">
		* 조회기간 : <% drawDateBox yyyy1,yyyy2,mm1,mm2,dd1,dd2 %>
		&nbsp;
		* 작업그룹 : <% DrawWorkgroup "workgroup", workgroup, "" %>
	</td>
...
<tr align="center">
	<td align="left" bgcolor="#ffffff">
		* 출고지시ID <input type="text" name="baljuid" value="<%= baljuid %>" maxlength=10 size=8>
		&nbsp;
		<input type="checkbox" name="showItemKind" value="Y" <%= CHKIIF(showItemKind="Y", "checked", "") %>> 상품 가지수 표시
		&nbsp;
		<input type="checkbox" name="showOldData" value="Y" <%= CHKIIF(showOldData="Y", "checked", "") %>> 과거내역 표시(출고지시)
		&nbsp;
		<input type="checkbox" name="showOldOrderData" value="Y" <%= CHKIIF(showOldOrderData="Y", "checked", "") %>> 과거내역 표시(상품정보)
	</td>
</tr>
</table>
</form>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a" style="padding-top:10;">
    <tr height="25">
        <td align="left">
			<!--
        	<input type="button" class="button" value="선택출고지시아이템목록보기" onclick="ViewBaljuArr()">
			-->
        </td>
        <td align="right">
            <input type="button" class="button" value="퀵배송 주문목록" onclick="ViewQuickOrderList()">
			&nbsp;
...
<tr height="25" bgcolor="FFFFFF">
	<td colspan="30">
		검색결과 : <b><%= obalju.FTotalCount %></b>
	</td>
</tr>
    <tr align="center" bgcolor="<%= adminColor("tabletop") %>">
		<td width=20></td>
		<td width="80">출고지시ID</td>
		<td>출고지시일시</td>
		<td>주문<br>사이트</td>
		<td>차수</td>
		<td>그룹</td>
...
<% if (obalju.resultBaljucount<1) then %>
	<tr bgcolor="#FFFFFF" height="31"><td colspan="29" align="center">해당기간에 출고지시서없음</td></tr>
<% else %>
...
%>
	...
	<tr bgcolor="#FFFFFF" align="center">
		...
		<td><a href="popbaljulist.asp?idx=<%= obalju.FBaljumasterList(i).FBaljuID %>&songjangDiv=<%= obalju.FBaljumasterList(i).FsongjangDiv%>" target=_blank>보기</a></td>
		<td>
			<a href="#" onClick="jsPopLogisticsBaljuitem(<%= obalju.FBaljumasterList(i).FBaljuID %>); return false;">보기</a>
		</td>
		<!--
	    ...
	    -->
	    <td><a href="/admin/ordermaster/poporder_gift.asp?baljuid=<%= obalju.FBaljumasterList(i).FBaljuID %>" target=_blank>보기</a></td>
	    <td><a href="/admin/ordermaster/poporder_gift_summary.asp?menupos=1011&research=on&evt_code=&balju_code=<%= obalju.FBaljumasterList(i).FBaljuID %>&viewType=summary&isupchebeasong=N&dateview1=yes&date_display=on" target=_blank>보기</a></td>
		<td><a href="/admin/ordermaster/pop_makeonorder_list_UTF8.asp?menupos=1568&balju_code=<%= obalju.FBaljumasterList(i).FBaljuID %>" target="_blank">보기</a></td>
		<td>
