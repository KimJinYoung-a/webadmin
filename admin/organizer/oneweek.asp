...
<tr>
	<td><input type="button" onClick="location.href='oneweekview.asp';" value="새글쓰기"></td>
</tr>
</table>
<table width="100%" border="0" align="center" class="a" cellpadding="0" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td nowrap align="center"><input type="button" onClick="location.href='oneweekview.asp?idx=<%=oip.FItemList(i).FOW_IDX %>';" value="수정"></td>
	</tr>
	<% Next %>
<% else %>
		<tr bgcolor="#FFFFFF">
