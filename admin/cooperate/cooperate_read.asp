...
<%
	...
	Dim vParam, s_search_team, s_status, s_type, s_ans_ox, s_onlymine, vIsPop, vIsChamjo
...
function checkform(frm)
{
	...
	if(frm.doc_worker.value != frm.doc_worker_temp.value)
	{
		frm.doc_status.value = "1";
	}
}
...
<tr> 
	<td height="25"><font color="#4E9FC6"><b>받은업무협조 > <%=NaviTitle(CHKIIF(vIsChamjo="o","6",sDoc_Status))%> > <%=sDoc_Subj%></font></b></font></td>
</tr>
</table>
...
<form name="frm" action="cooperate_proc.asp" method="post" onSubmit="return checkform(this);" style="margin:0px;">
...
<input type="hidden" name="doc_worker_temp" value="<%=sDoc_Worker%>">
					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0" class="a">
						<Tr> 
							<Td>
								...
								<% else %>
								<%=fnGetReportState(sSys_reportstate)%><br>
...
※ 참조는 수정이 불가합니다.<br/>
<% Else %>
<table width="850" border="0" cellpadding="0" cellspacing="0" class="a">
<tr>
	<td width="50%" align="left">
	<% If sDoc_Status = "1" OR sDoc_Status = "2" Then %>
		<input type="image" src="/images/coop_modify.gif" border="0">
	<% Else %>
		※ 작업완료된 것이나 반려된 것은 수정이 불가합니다.
	<% End If %>
	</td>
	<td width="50%" align="right">
		...
		<tr>
			...
			<td>
				<% If sDoc_Status = "1" OR sDoc_Status = "2" Then %>
					<img src="/images/icon_back.gif" border="0" style="cursor:pointer" onClick="cooperate_status_change('4','반려 하시겠습니까?');">&nbsp;
					<% If sDoc_Status = "1" Then %>
					<img src="/images/coop_jak.gif" border="0" style="cursor:pointer" onClick="cooperate_status_change('2','작업중으로 전환 하시겠습니까?');">&nbsp;
					<% ElseIf sDoc_Status = "2" Then %>
					<img src="/images/coop_gi.gif" border="0" style="cursor:pointer" onClick="cooperate_status_change('1','기안으로 전환 하시겠습니까?');">&nbsp;
					<% End If %>
					<img src="/images/coop_won.gif" border="0" style="cursor:pointer" onClick="cooperate_status_change('3','완료 하시겠습니까?');">
				<% End If %>
			</td>
		</tr>
		</table>
...
<% If iDoc_Idx <> "" Then %>
<!-- ####### 답변쓰기 ####### //-->
<br><div style="text-align:center;width:850px;">
 <iframe src="iframe_cooperate_ans.asp?ispop=<%=vIsPop%>&didx=<%=iDoc_Idx%>&registid=<%=sDoc_Id%>" name="iframeDB1" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="5" scrolling="no" onload="resizeIfr(this, 10)" ></iframe></td>
</div>
<!-- ####### 답변쓰기 ####### //-->
<% End If %>
<br><br>
