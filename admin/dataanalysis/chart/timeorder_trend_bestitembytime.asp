...
<%
Dim MaxPageSize : MaxPageSize = 700
Dim oChart, vArr1, vArr2, i, j
Dim vSDate, vHH, vChannel, vOrdType, rdsitegrp

vSDate = requestCheckvar(request("startdate"),10)
vHH = requestCheckvar(request("hh"),2)
...
SET oChart = new CChart
	...
	vArr2 = oChart.fnTimeMeachul_bestitem_DW
SET oChart = nothing
...
<tr align="center" bgcolor="#F4F4F4">
	...
	조회날짜 : 
	    ...
	    <input type="text" name="hh" value="<%=vHH%>" size="2" maxlength="2">
