...
SET oChart = new CChart
	...
	vArr2 = oChart.fnRdsiteTop_DW
	
	oChart.FPageSize = 5
	vArr1 = oChart.fnRdsiteTop_Trend_DW
SET oChart = nothing

Dim iChartCaption : iChartCaption = "rdsite별 주문건수"
...
if (vOrdType="S") then
    ...
    iChartCaption = "rdsite별 구매총액"
    yAxisName = "구매총액"
end if

Dim pTypeName : pTypeName = "rdsite" ''getpTypeName(vpType)
