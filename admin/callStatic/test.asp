...
{
	var detailpop;
	detailpop = window.open('operatorSummaryReport_pop.asp?tenUserID='+tenUserID+'&inout='+inout+'&sdate=<%=sdate%>&edate=<%=edate%>','detail','width=800,height=672,scrollbars=yes, resizable=yes');
	detailpop.focus();
}
</script>
