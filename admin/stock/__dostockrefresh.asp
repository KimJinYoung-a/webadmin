...
response.write recent3day + "<br>"
response.write recent7day + "<br>"
...
response.flush
	...
	sqlStr = sqlStr + " select T.yyyymmdd,T.itemid,T.itemoption,T.sellno,T.reno, T.totsellno"
	sqlStr = sqlStr + " from "
	sqlStr = sqlStr + " ("
	...
	sqlStr = sqlStr + " where m.beadaldate>='" + recent3day + "'"
	...
	sqlStr = sqlStr + " ) T"
	sqlStr = sqlStr + " left join [db_summary].[dbo].tbl_deliver_itemsell_daily_summary s"
	...
	sqlStr = sqlStr + " group by convert(varchar(10),beadaldate,21) , d.itemid, d.itemoption"
	sqlStr = sqlStr + " ) T"
	sqlStr = sqlStr + " where [db_summary].[dbo].tbl_deliver_itemsell_daily_summary.yyyymmdd=T.yyyymmdd"
	sqlStr = sqlStr + " and [db_summary].[dbo].tbl_deliver_itemsell_daily_summary.itemid=T.itemid"
	sqlStr = sqlStr + " and [db_summary].[dbo].tbl_deliver_itemsell_daily_summary.itemoption=T.itemoption"
