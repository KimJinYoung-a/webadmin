...
function jsSort() {
	...
	document.frm.mode.value = 'interview';
...
function AssignXmlReal(upfrm,imagecount){
	...
	AssignimageReal.location.href="<%=wwwUrl%>/chtml/street/Main_InterViewJS.asp?idx=" +tot + '&sort='+tot2+'&imagecount='+imagecount;
...
<tr align="center" bgcolor="#FFFFFF" >
	...
	<td align="left">
		* 브랜드 : <% drawinterview_ID_with_Name "makerid",makerid , " onchange='gosubmit("""");'" %>
		&nbsp;&nbsp;
...
<input type="hidden" name="idx" value="<%= olist.FItemList(i).FmainIdx %>">
...
<% end if %>	
	...
	<td><input type="text" size="2" maxlength="2" name="sortNo" value="<%= olist.FItemList(i).FmainSortNo %>" class="text"></td>
	<td>
