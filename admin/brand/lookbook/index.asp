...
<tr align="center" bgcolor="#FFFFFF" >
	...
	<td align="left">
		* 브랜드 : 
		<%' LookBook_ID_with_Name "makerid",makerid , " onchange='gosubmit("""");'" %>
...
<form name="frmSortImgSize" method="post" action="/admin/brand/lookbook/lookbookSortNoProcess.asp" style="margin:0px;">
...
<tr>
	...
	<td align="right">
		<input type="button" value="신규등록" class="button" onclick="javascript:location.href='/admin/brand/lookbook/lookbookModify.asp?menupos=<%=menupos%>';">
	</td>
</tr>
</table>
<!-- 액션 끝 -->
