...
<form name="frmSortImgSize" method="post" action="/admin/brand/shop/collection/collectionSortNoProcess.asp" style="margin:0px;">
...
<tr>
	...
	<td align="right">
		<input type="button" value="신규등록" class="button" onclick="javascript:location.href='/admin/brand/shop/collection/collectionModify.asp?menupos=<%=menupos%>';">
	</td>
</tr>
</table>
<!-- 액션 끝 -->
