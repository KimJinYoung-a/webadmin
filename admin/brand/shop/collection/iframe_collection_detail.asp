...
function pop_collectionitemreg(idx){
	var pop_collectionitemreg = window.open('/admin/brand/shop/collection/pop_collection_itemAddInfo.asp?idx='+idx+'&makerid=<%=makerid%>','pop_collectionitemreg','width=1024,height=768,scrollbars=yes,resizable=yes');
...
<form name="frmSortIsusing" method="post" action="/admin/brand/shop/collection/collectionsortIsusingProcess.asp" style="margin:0px;">
