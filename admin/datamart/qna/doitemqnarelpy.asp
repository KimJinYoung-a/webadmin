...
dim page,makerid,notupbea,mifinish,research, sql, sType, sTypeVal, iSD, iED
	id = request("id")
	mode = request("mode")
...
if (mode = "reply") or (mode = "firstreply") then
  ...
  response.write "<script type='text/javascript'>location.replace('newitemqna_view.asp?id=" + id + "&page=" + page + "&makerid=" + makerid + "&notupbea=" + notupbea + "&mifinish="+ mifinish + "&research=" + research + "&sType="+sType+"&sTypeVal="+sTypeVal+"&iSD="+iSD+"&iED="+iED+"')</script>"					
