...
%>
	...
	<tr bgcolor="#FFFFFF">
		<td colspan="20">
			...
			<tr>
				<td align="left">
					검색결과 : <b><%= o73007.FTotalCount %></b>
					&nbsp;
					페이지 : <b><%= page %> / <%=  o73007.FTotalpage %></b>
				</td>
...
'			end if
			...
			<td align="center">
				<% if o73007.FItemList(i).Fsub_opt1_state="Y" then %>
					승인완료
				<% else %>
					<input type="button" class="button_s" value="승인하기" onclick="reggubunok('<%= evt_code %>','<%= o73007.FItemList(i).Fidx %>','<%= o73007.FItemList(i).Fuserid %>');">
				<% end if %>
			</td>
		</tr>
		<% Next %>
