...
Class CMagaZineContents
	...
	public function fnGetMagaZineList()
        ...
        sqlStr = sqlStr & " where 1=1 and sub_opt1<>'subevt' and sub_opt2<>0 " & sqlsearch
...
'		response.write sqlStr &"<Br>"
        ...
        if  not rsget.EOF  then
            ...
            do until rsget.EOF
				set FItemList(i) = new CMagaZineItem
					...
					if Len(FItemList(i).Fsub_opt2) = 3 then
						FItemList(i).Fsub_opt2 = "0"&rsget("sub_opt2")
					end if
	...
	''---------서브이벤트 웨딩사진 ------------------------------------------------------------------------
	public function fnGet73007subevtList()
        dim sqlStr, sqlsearch, i
