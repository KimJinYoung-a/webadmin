...
<span id="fn01" name="fn01" style="cursor:pointer" onclick=onoffFolding('fc01')>[표로 보기]</span><br>
<!-- // 연령별 가입비율 - 표형식 (폴딩 치트) (2008-01-11;허진원) // -->
<span id="fc01" name="fc01" style="DISPLAY:none">
<table width="800" cellspacing="1" class="a" bgcolor=#3d3d3d>
<tr bgcolor="#DDDDFF">
	<td colspan="7">연령별 가입비율(Simple Table Ver.)</td>
</tr>
