...
<!-- #include virtual="/lib/classes/report/category_reportcls_analisys.asp"-->
<!-- #include virtual="/lib/classes/maechul/managementSupport/maechulCls.asp" -->
<%

''' 쿼리느림 - 통계DB로 변경 2016/04/08 -eastone  //group by가 많음..
...
<tr bgcolor="#E6E6E6">
	...
	<td  align="center">상품명(현재)</td>
<% If optExists = "" Then %>
	<td width="100" align="center">브랜드ID(현재)</td>
<% Else %>
	<td width="50">단가</td>
	<td width="100" align="center">브랜드ID(현재)</td>
	<td width="80" align="center">옵션(현재)</td>
<% End If %>
