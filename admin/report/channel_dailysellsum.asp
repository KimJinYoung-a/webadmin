...
<table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#EFBE00">
        <tr align="center">
          ...
          <td class="a" width="120"><font color="#FFFFFF">매출</font></td>
          <td class="a" width="120"><font color="#FFFFFF">판매수량</font></td>
        </tr>
        <% if oreport.FResultCount<1 and cdl="" then %>
        <tr align="center"  bgcolor="#FFFFFF">
            <td colspan="3" align="center" class="a">[먼저 카테고리를 선택 후 검색하세요.]</td>
        </tr>
        <% end if %>
