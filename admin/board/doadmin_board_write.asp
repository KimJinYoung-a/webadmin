...
sqlput = "update [db_board].[10x10]."+table_name+" set pos=pos+1 where pos >= "&pos
rsput.Open sqlput,dbput,1

dim user_file,user_ip,face

sqlput1 = " insert into [db_board].[10x10]."+table_name+" (site_name,name,mail,title,body, "
...
sqlput1 = " update [db_board].[10x10]."+table_name+" set check_flag = 'Y' where site_name = '"+site_name+"' and thread = "+thread

rsput.Open sqlput1,dbput,1

response.redirect "admin_board_list.asp?table_name="+table_name+"&site_name="+site_name
