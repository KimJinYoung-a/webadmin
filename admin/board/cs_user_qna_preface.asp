...
<tr>
	<td><a href="cs_user_qna_preface_reg.asp?mode=add"><font color="red">New</font></a></td>
</tr>
</table>
<table width="650" border="0" cellpadding="5" cellspacing="0" bgcolor="#CCCCCC">
	...
	<tr>
		<td class="a">
		분류 :
			<% SelectBoxQnaPrefaceGubun "01",gubun %>
		</td>
...
<tr bgcolor="#FFFFFF">
	...
	<td align="center"><a href="cs_user_qna_preface_reg.asp?mode=edit&idx=<%= omd.FItemList(i).Fidx %>"><%= omd.FItemList(i).Fcontents %></a></td>
