...
<form method="post" name="frmarr" action="upche_preface_proc.asp">
<input type="hidden" name="mode" value="<% = mode %>">
<input type="hidden" name="masterid" value="03">
<tr>
	<td>
	<% SelectBoxQnaPrefaceAllGubun "03",gubun %>
	</td>
</tr>
<tr>
...
<tr>
	<td>
	  <% SelectBoxQnaPrefaceGubun "03", Cstr(omd.FItemList(0).Fgubun) %>
	</td>
</tr>
<tr>
