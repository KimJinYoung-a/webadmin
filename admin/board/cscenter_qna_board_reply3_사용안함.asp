...
<tr>
	<td bgcolor="#FFFFFF">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
				  <td class="a" height="5">&nbsp;<b>고객등급 : <%= boardqna.results(0).GetUserLevelStr %></td>
...
<tr>
	<td bgcolor="#FFFFFF">
		  ...
		  <tr bgcolor="#FFFFFF">
			  <td><a href="cscenter_qna_board_reply.asp?id=<%= myqnalist.results(i).id %>&reffrom=<%= reffrom %>" class="link_kor"><%= myqnalist.results(i).title %></a></td>
...
<!--
 ...
 function TnChangePreface(SelectGubun){
	PrefaceFrame.location.href="/admin/board/preface_select.asp?gubun=" + SelectGubun + "&userid=<%= boardqna.results(0).userid %>";
 }
