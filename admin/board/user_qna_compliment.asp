...
<tr>
	<td><a href="user_qna_compliment_reg.asp?mode=add"><font color="red">New</font></a></td>
</tr>
</table>
...
<tr bgcolor="#FFFFFF">
	...
	<td align="center"><a href="user_qna_compliment_reg.asp?mode=edit&idx=<%= omd.FItemList(i).Fidx %>&gubun=<%= omd.FItemList(i).Fgubun %>"><%= omd.FItemList(i).Fcontents %></a></td>
...
<form name="delform" method="post" action="delcompliment.asp">
