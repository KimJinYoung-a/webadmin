	...
	<tr>
		...
		<td bgcolor="white" style="padding:0">
			<select name="gubun">
				...
				<option value="01" <% if oboard.Fgubun = "01" then response.write "selected" %>>건의</option>
				<option value="02" <% if oboard.Fgubun = "02" then response.write "selected" %>>제안</option>
				<option value="03" <% if oboard.Fgubun = "03" then response.write "selected" %>>회람</option>
			</select>
		</td>
	</tr>	
	<tr>
		...
		<td bgcolor="white" style="padding:0">
				<input name="title" style="width:450" maxlength="40" style="border:1 solid" value="<% = oboard.Ftitle %>">
		</td>
	</tr>
	<tr>
		<td width="100" align="center" style="color:white">내용</td>
		<td bgcolor="white" style="padding:0">
				<textarea name="contents" cols="50" rows="15"><% = oboard.Fcontents %></textarea>
