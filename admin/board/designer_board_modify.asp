...
response.redirect "designer_board_read.asp?idx=" + request("idx") + "&menupos=90"
...
<form method="POST" name="boardform" action="designer_board_modify.asp?idx=<% =Request("idx")%>&pgsize=<% =Request("pgsize")%>&page=<% =Request("page")%>&menupos=90" name="boardform">
