...
<tr>
	<td><a href="qna_preface_gubun_reg.asp?mode=add"><font color="red">New</font></a></td>
</tr>
</table>
...
<tr bgcolor="#FFFFFF">
	...
	<td align="center"><a href="qna_preface_gubun_reg.asp?mode=edit&code=<%= omd.FItemList(i).Fcode %>"><%= omd.FItemList(i).Fcname %></a></td>
</tr>
</form>
<% next %>
<tr bgcolor="#FFFFFF">
