...
set oposcodeList = new cbrandstreet_list
...
<form name="frmposcode" method="post" action="/admin/brandstreet/imagemake_poscode_process.asp" >
<tr bgcolor="#FFFFFF">
