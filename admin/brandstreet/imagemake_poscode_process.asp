...
sqlStr = "select top 1 poscode,posname,imagetype,imagewidth,imageheight,isusing,imagecount from db_brand.dbo.tbl_brandstreet_poscode"
...
if (ItemExists) then
    sqlStr = " update db_brand.dbo.tbl_brandstreet_poscode" + VbCrlf
    ...
    sqlStr = " insert into db_brand.dbo.tbl_brandstreet_poscode" + VbCrlf
