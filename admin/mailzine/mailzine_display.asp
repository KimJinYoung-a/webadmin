...
response.write "<table align='center' width='670' border='0' cellspacing='0' cellpadding='0'>"
response.write "  <tr>"
...
response.write "    * 더 이상 수신을 원하지 않으시면 수신거부 버튼을 클릭해주세요. <a href='http://www.10x10.co.kr/member/mailzine/reject_mailzine.asp?M_ID=${TMS_M_EMAIL}' target='_blank' onFocus='this.blur()'>[수신거부]</a> (To unsubscribe this e-mail, <a href='http://www.10x10.co.kr/member/mailzine/reject_mailzine.asp?M_ID=${TMS_M_EMAIL}' target='_blank' onFocus='this.blur()'>click HERE</a>)<br />"
response.write "    * 개인정보변경 시 시스템 적용에 2~3일 반영시간이 소요될 수 있으니 이 점 양해 부탁드립니다.</td>"
response.write "  </tr>"
response.write "  <tr>"
response.write "    <td align='center' style='padding:12px 0 20px 0; font-family:Dotum; color:#888; font-size:11px; line-height:16px;'>"
if area = "finger_all" or area = "finger_metropolitan" then
