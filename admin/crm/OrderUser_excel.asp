...
set oorderuser = new COrderUserList
    ...
    oorderuser.FPageSize = 200000
    oorderuser.FRectStartDate = fromDate
    oorderuser.FRectEndDate   = toDate
    oorderuser.GetOrderUserNotPaging

if oorderuser.FTotalCount>0 then
    arrLIst=oorderuser.fArrLIst
end if

downPersonalInformation_rowcnt=oorderuser.ftotalcount
...
Response.AddHeader "Content-Disposition", "attachment; filename=TENorderuserLIST" & Left(CStr(now()),10) & "_" & session.sessionID & ".xls"
