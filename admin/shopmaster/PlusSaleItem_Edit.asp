		...
		<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a">
			<tr>
				...
				<td align="right">
					...
					<input type="button" class="button" value="메인링크상품 추가" onClick="PlusSaleItem_Main_Reg('<%= itemid %>');">
				</td>
			</tr>
		</table>
		</td>
    		...
    		<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a">
    			<tr>
    				<td>
    					...
    					<b>플러스 세일 상품 리스트</b>
    					&nbsp;
    					검색결과 : <b><%= oPmItemList.FTotalCount %></b>
    				</td>
    				<td align="right">
    					<input type="button" class="button" value="선택상품 삭제" onClick="delPlusSaleItem('<%= itemid %>');">
    					<input type="button" class="button" value="추가구성상품 추가" onClick="PlusSaleItem_Sub_Reg('<%= itemid %>');">
						<input type="button" class="button_auth" value="빠른 추가구성상품 추가" onClick="PlusSaleItem_Sub_Direct_Reg('<%= itemid %>');">
    				</td>
    			</tr>
    		</table>
    		</td>
