...
<form name="frmFile" method="post" action="/admin/shopmaster/sale/procFileUpload.asp"  enctype="MULTIPART/FORM-DATA">
...
<tr align="center" bgcolor="#FFFFFF">
	...
	<td align="left">
		...
		&nbsp;&nbsp;&nbsp;<a href="/admin/shopmaster/sale/testsample.xls"><font color="BLUE"><strong>샘플다운</strong></font></a><br>
		1.엑셀은 <font color="red">97-2003 통합문서</font>여야 하고, <font color="red">첫라인</font>은 고정.<br>
		2.샘플 형식과 동일해야 하며, <font color="red">셀서식</font>이 백분율로 되어있을 경우<br>
		 &nbsp;&nbsp;&nbsp;원값이 입력되므로 주의해야 함 (백분율 20%=>0.2로 입력됨)<br>
		&nbsp;&nbsp;&nbsp;<font color="red">%가 붙어있는 경우 셀서식 무조건 숫자로 변경처리</font><br>
		3.상품코드, 할인마진율은 <font color="red">무조건</font> 입력<br> 
		4.할인율과 할인판매가 중 <font color="red">하나는 반드시</font> 입력
	</td>
</tr>
<tr align="center" bgcolor="#FFFFFF">
