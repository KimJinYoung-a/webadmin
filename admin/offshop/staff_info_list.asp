...
<% for i = 0 to (nstaff.FResultCount - 1) %>
  <tr height="20">
    ...
    <td align="center"><a href="staff_info_write.asp?idx=<%= nstaff.FItemList(i).Fidx %>&mode=edit"><%= nstaff.FItemList(i).Fshopname %></a></td>
    <td align="center"><a href="staff_info_write.asp?idx=<%= nstaff.FItemList(i).Fidx %>&mode=edit"><%= nstaff.FItemList(i).Fusername %></a></td>
