...
<!-- #include virtual="/lib/classes/sitemasterclass/offshopmain_ContentsManageCls.asp" -->
...
<tr bgcolor="#FFFFFF">
    ...
    <td>
        <span class="display_date" id="strSDt"><%= Left(oMainContents.FOneItem.Fstartdate,10) %></span>
        <input type="hidden" name="startdate" value="<%= Left(oMainContents.FOneItem.Fstartdate,10) %>">
		...
		<script type="text/javascript">
		    DyCalendar.setup( { firstDay : 0, inputField : "startdate", ifFormat : "%Y-%m-%d", displayArea : "strSDt", daFormat : "%Y-%m-%d"});
		</script>
    </td>
</tr>
<tr bgcolor="#FFFFFF">
    ...
    <td>
        <span class="display_date" id="strEDt"><%= Left(oMainContents.FOneItem.Fenddate,10) %></span>
        <input type="hidden" name="enddate" value="<%= Left(oMainContents.FOneItem.Fenddate,10) %>">
        ...
        <% end if %>
		<script type="text/javascript">
		    DyCalendar.setup( { firstDay : 0, inputField : "enddate", ifFormat : "%Y-%m-%d", displayArea : "strEDt", daFormat : "%Y-%m-%d"});
		</script>
    </td>
</tr>
<tr bgcolor="#FFFFFF">
