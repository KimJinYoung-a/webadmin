...
dim osheetmaster, idx, suplyer,yyyymmdd,comment
...
function AddItems(frm){
	...
	popwin = window.open('popoffjumunitem.asp?suplyer=' + suplyer + '&idx=0','shopjumunitem1','width=880,height=600,scrollbars=yes,resizable=yes');
	popwin.focus();
}

function AddItems2(frm){
	var popwin;
	var suplyer;
	...
	popwin = window.open('popoffjumunbycsv.asp?suplyer=' + suplyer + '&idx=0','offjumuninputadd','width=880,height=600,scrollbars=yes,resizable=yes');
	popwin.focus();
}
...
<tr>
	<td align=right><input type=button value="상품추가(관리자전용)" onclick="AddItems2(frmMaster)">&nbsp;&nbsp;&nbsp;<input type=button value="상품추가" onclick="AddItems(frmMaster)"></td>
</tr>
</table>
...
<form name="frmArrupdate" method="post" action="doshopjumun.asp">
