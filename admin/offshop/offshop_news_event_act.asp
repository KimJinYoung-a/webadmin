...
uploadForm.DefaultPath = "D:\home\cube1010\webadmin\uploadfile\staff\"
...
function DelProc(fieldname, idx)
	dim sqlStr
	sqlStr = " update [db_shop].[dbo].tbl_offshop_staff"
	sqlStr = sqlStr + " set " + fieldname + "=NULL"
...
if (file1<>"") and (dl_file1<>"on") then
	...
	sqlStr = " update [db_shop].[dbo].tbl_offshop_staff"
	sqlStr = sqlStr + " set  file1 ='" + filenameolny + "'"
