...
<%
dim linktype, fixtype ,poscode, page, gubun ,oposcode,oposcodeList ,i
...
function setDefault() {
	self.location.href="popmainposcodeedit.asp?gubun=" + document.all("Lgb").value;
}
...
<tr bgcolor="#FFFFFF">
    <td colspan="2" align="center"><input type="button" value=" 저 장 " onClick="SavePosCode(frmposcode);" class="button"></td>
</tr>
</form>
</table>
<%
