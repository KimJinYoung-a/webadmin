...
<form name="frmarr" method="post" action="/admin/offshop/lib/domailzinenewitem.asp">
<input type="hidden" name="mode">
<input type="hidden" name="itemid">
</form>
<table width="650" border="0" cellpadding="5" cellspacing="0">
<tr>
	<td><a href="/admin/offshop/offshop_mailzine_newitem_reg.asp"><font color="red">***** 아이템추가하러가기 ******</font></a></td>
</tr>
</table>
<table width="650" border="0" cellpadding="5" cellspacing="0" bgcolor="#CCCCCC">
	...
	<tr>
		<td class="a" >
		메일진구분 : <% DrawSelectBoxMailzine masteridx %> 카테고리선택 :	<% DrawSelectBoxCategoryLarge "cd1", cd1 %>
		</td>
...
<tr bgcolor="#FFFFFF" height="25">
	...
	<td width="100" align="center">카테고리구분</td>
