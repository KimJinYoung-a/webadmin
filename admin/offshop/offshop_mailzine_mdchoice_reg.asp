...
function AddIttems(){
	...
	if (confirm(frmarr.itemid.value + '아이템을 추가하시겠습니까?')){
...
<table width="650" border="0" cellpadding="5" cellspacing="0" bgcolor="#CCCCCC">
	...
	<tr>
		<td class="a">
			메일진구분 : <% DrawSelectBoxMailzine masteridx %>&nbsp;&nbsp;&nbsp;<input type="button" value="아이템 추가" onclick="popItemWindow('','frmarr.itemid')" class="button">
		</td>
	</tr>
	<tr>
		<td class="a">
