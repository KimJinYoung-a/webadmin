...
<table width="800" border="0" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF" class="a" >
<tr>
	<td>
	* 야간매출(새벽 3시까지)는 전날 날짜 매출로 표시됩니다.(일별매출통계만 적용)
	</td>
</tr>
</table>
...
<tr bgcolor="#FFFFFF">
	...
	<td align="center"><a href="todayselldetail.asp?menupos=<%= menupos %>&terms=<%= ooffsell.FItemList(i).FTerm %>&shopid=<%= ooffsell.FItemList(i).FShopid %>">보기</a></td>
	<td align="center"><a href="todaysellmaster.asp?menupos=<%= menupos %>&terms=<%= ooffsell.FItemList(i).FTerm %>&shopid=<%= ooffsell.FItemList(i).FShopid %>">보기</a></td>
</tr>
<% next %>
</table>
<%
