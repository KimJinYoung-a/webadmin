...
<table width="650" border="0" cellpadding="5" cellspacing="0" bgcolor="#CCCCCC">
	...
	<tr>
		<td class="a">
			메일진구분 : <% DrawSelectBoxMailzine masteridx %> 카테고리선택 :	<% DrawSelectBoxCategoryLarge "cd1", cd1 %>&nbsp;&nbsp;&nbsp;<input type="button" value="아이템 추가" onclick="popItemWindow('','frmarr.itemid')" class="button">
		</td>
	</tr>
	<tr>
		<td class="a">
