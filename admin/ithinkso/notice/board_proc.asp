...
If mode = "brdreg" Then
	...
	strSql = strSql & " 	select top 1 brd_sn from db_board.dbo.tbl_board_ithinkso where brd_sn='"&brd_sn&"'" + vbcrlf
	strSql = strSql & " )" + vbcrlf
	strSql = strSql & " 	update db_board.dbo.tbl_board_ithinkso set" + vbcrlf
	...
	strSql = strSql & " 	insert into db_board.dbo.tbl_board_ithinkso(" + vbcrlf
	...
	response.write "	location.href='/admin/ithinkso/notice/board_list.asp?menupos="&menupos&"';"
	response.write "</script>"
	dbget.close() : response.end
