...
function AssignXmlReal(upfrm,imagecount){
	...
	var AssignimageReal;
	AssignimageReal = window.open("<%=wwwUrl%>/chtml/make_artist_Main3BannerJS.asp?idx=" +tot + '&imagecount='+imagecount, "AssignimageReal","width=800,height=600,scrollbars=yes,resizable=yes");
	AssignimageReal.focus();
}

//이미지신규등록 & 수정
function AddNewMainContents(idx){
	var AddNewMainContents = window.open('/admin/artist/imagemake_contents.asp?idx='+ idx + '&gubun=1','AddNewMainContents','width=1200,height=600,scrollbars=yes,resizable=yes');
...
<tr><td align="left"><a href="javascript:AssignXmlReal(frm,3);"><img src="/images/refreshcpage.gif" border="0"> Real 적용</a></td></tr>
