...
<tr align="center">
	<td bgcolor="#e1e1e1"><font size=1><strong>BOX NO.</strong></font></td>
	<td bgcolor="#e1e1e1" align="left"><font size=1><strong>BOX Type</strong></font></td>
	<td bgcolor="#e1e1e1"><font size=1><strong>N weight</strong></font></td>
	<td bgcolor="#e1e1e1" align="right"><font size=1><strong>G weight</strong></font></td>
	<td bgcolor="#e1e1e1" align="right"><font size=1><strong>CBM</strong></font></td>
</tr>
<%
currcartoonboxno = ""
suminnerboxweight = 0
...
%>
	<tr>
		<td class='txt' align="center"><font size=1><%=currcartoonboxno %></font></td>
		<td align="left">
			<font size=1>
		...
		<td align="center"><font size=1><%= FormatNumber(ocartoonboxdetail.FItemList(i).FcartoonboxNweight, 2) %>Kgs</font></td>
		<td align="right">
			<font size=1>
			    <%= FormatNumber(ocartoonboxdetail.FItemList(i).Fcartoonboxweight, 2) %>Kgs
			</font>
		</td>
...
<tr>
	...
	<td align="center"><font size=1><strong><%= FormatNumber(sumcartoonboxNweight, 2) %>Kgs</strong></font></td>
	<td align="right"><font size=1><strong><%= FormatNumber(sumcartoonboxweight, 2) %>Kgs</strong></font></td>
	<td align="right" class='txt'><font size=1><strong><%= sumcartoonboxcbm %></strong></font></td>
</tr>
</table>
