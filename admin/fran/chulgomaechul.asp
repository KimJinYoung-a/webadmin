...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="a" bgcolor="#F3F3FF">
	...
	<tr height="25" valign="top">
		...
		<font color="red"><strong>오프샾 출고대비 매출 통계</strong></font></td>
...
<table width="100%" border="0" align="center" class="a" cellpadding="2" cellspacing="1" bgcolor="#BABABA">
    <tr align="center" bgcolor="#DDDDFF">
    	...
    	<td>샆이름</td>
      	...
      	<td width="90">샆매출액(E)</td>
      	<td width="90">샆재고증감<br>(A+B+C+D-E)</td>
    </tr>
<% for i=0 to omaechul.FResultcount-1 %>
    <tr align="center" bgcolor="#FFFFFF">
    	...
    	<td align="right"><%= FormatNumber(omaechul.FItemList(i).Fshopsell,0) %></td>
    	<% tmp = omaechul.FItemList(i).Ftenout + omaechul.FItemList(i).Ftenreturn + omaechul.FItemList(i).Fupcheout + omaechul.FItemList(i).Fupchereturn - omaechul.FItemList(i).Fshopsell %>
    	<td align="right">
    	<% if (tmp < 0) then %>
    	  <font color=red><b><%= FormatNumber(tmp,0) %></b></font>
    	<% else %>
    	  <%= FormatNumber(tmp,0) %>
    	<% end if %>
    	</td>
