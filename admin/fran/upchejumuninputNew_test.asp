...
dim designerid, statecd
dim itemgubunarr, itemidarr, itemoptionarr, ordernoarr, orgbaljucode
dim includepreorderno, shortyn, orderno, realstock
dim research
dim centermwdiv
dim shopid
...
oordersheet1.FGroupByBaljuCode = False
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="#FFFFFF" >
		...
		<td align="left">
		    ...
		    &nbsp;
		    샵 : <% drawSelectBoxOffShop "shopid",shopid %>
		    <!--
		    &nbsp;
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
		...
		<td width="50">기존<br />누락주문</td>
		<td width="50"><b>매장<br />주문</b></td>
	...
	<tr align="center" bgcolor="#FFFFFF">
		...
		<td><%= oordersheet1.FItemList(i).FpreUnderCnt %></td>
		<td><b><%= oordersheet1.FItemList(i).FJupsuCount %></b></td>

		<%
		if (oordersheet1.FItemList(i).Frealstock - oordersheet1.FItemList(i).FpreUnderCnt - oordersheet1.FItemList(i).FJupsuCount) < 0 then
			orderno = (oordersheet1.FItemList(i).Frealstock - oordersheet1.FItemList(i).FpreUnderCnt - oordersheet1.FItemList(i).FJupsuCount) * -1
		else
			orderno = 0
		end if
		%>
		...
		<td>
			<%= oordersheet1.FItemList(i).Fshopname %><br>
			<% if (Not IsNull(oordersheet1.FItemList(i).Fupcheorderlinkcode)) then %>
				<!--
				<%= oordersheet1.FItemList(i).Fupcheorderlinkcode %><br>
				-->
			<% end if %>
			...
			<% if oordersheet1.FItemList(i).Fpreorderno<>0 then %>
				기주문: <%=  oordersheet1.FItemList(i).Fpreorderno %>
