...
dim itemgubun, itemid,itemoption, sqlStr, ioffitem, isusing
...
<% if ioffitem.FResultCount>0 then %>
	...
	<% else %>
		...
		<input type="hidden" name="suplycasharr" value="<%= ioffitem.FOneItem.GetOfflineSuplycash %>|">
		<input type="hidden" name="buycasharr" value="<%= ioffitem.FOneItem.GetOfflineBuycash %>|">
		<input type="hidden" name="foreign_sellcasharr" value="<%= ioffitem.FOneItem.Fforeign_sellprice %>|">
		<input type="hidden" name="foreign_suplycasharr" value="<%= ioffitem.FOneItem.Fforeign_suplyprice %>|">
