...
<%
'###########################################################
' Description :  히치하이커 어드민 프리뷰내 Iframe 페이지(M)
...
//이미지 등록(WWW)
function jsSetImgM(idx, sFolder, sImg, sName, sSpan, device){
...
<tr>
	...
	<td align="right">
		<input type="button" name="btnBan" value="Preview이미지등록" onClick="jsSetImgM('<%=idx%>','preview','','imgU','spanimgU','M')" class="button">
	</td>
</tr>
</table>
<!-- 액션 끝 -->
