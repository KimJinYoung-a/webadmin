...
<form name="frmImg" method="post" action="<%= uploadImgUrl %>/linkweb/hitchhiker/mainbanner/hitchhiker_imgreg.asp" enctype="MULTIPART/FORM-DATA" onSubmit="return jsUpload();">
