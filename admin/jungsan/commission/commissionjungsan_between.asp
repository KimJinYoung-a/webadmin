...
Set cjungsan = New Ccommission
	...
	cjungsan.Getcommissionjungsan_between_paging()
%>
...
<tr valign="bottom">       
    <td align="left">
    	<input type="button" onclick="regcommissionjungsan('regbetween');" value="<%= yyyy %>년<%= mm %>월정산작성" class="button">
    </td>
    <td align="right">
    	<input type="button" onclick="downloadfile('csvbetween');" value="CSV다운" class="button">
    </td>        
</tr>
</table>
<!-- 표 중간바 끝-->
