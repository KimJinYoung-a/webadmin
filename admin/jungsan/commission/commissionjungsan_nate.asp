...
<input type="hidden" name="rdsite" value="nateshop">
...
<tr valign="bottom">       
    <td align="left">
    	<input type="button" onclick="regcommissionjungsan('regnate');" value="<%= yyyy %>년<%= mm %>월정산작성" class="button">
    </td>
    <td align="right">
    	<input type="button" onclick="downloadfile('csvnate');" value="CSV다운" class="button">
    </td>        
</tr>
</table>
<!-- 표 중간바 끝-->
