...
<tr valign="bottom">       
    <td align="left">
    	<input type="button" onclick="regcommissionjungsan('regnaver');" value="<%= yyyy %>년<%= mm %>월정산작성" class="button">
    </td>
    <td align="right">
    	<input type="button" onclick="downloadfile('csvnaver');" value="CSV다운" class="button">
    </td>        
</tr>
</table>
<!-- 표 중간바 끝-->
...
<tr bgcolor="#FFFFFF">
	<td colspan="25">
		검색결과 : <b><%= csum.FTotalCount %></b>
		&nbsp;
		페이지 : <b><%= page %>/ <%= csum.FTotalPage %></b>
	</td>
</tr>
<tr bgcolor="<%= adminColor("tabletop") %>" align="center">
    <td width=120>사이트</td>
    <td width=70>순판매수량</td>
    <td width=80>순주문금액</td>
    <td width=80>수수료</td>
    <td width=50>수수료<br>정산여부</td>
    <td>영역상세</td>
</tr>					  		  	
...
<tr bgcolor="<%= adminColor("tabletop") %>" align="center">
    <td width=70>주문일자</td>
    <td width=70>구매확정일자<br>(결제완료일자)</td>
    <td width=80>주문번호</td>
    <td>상품명</td>
    <td width=50>주문수량</td>
