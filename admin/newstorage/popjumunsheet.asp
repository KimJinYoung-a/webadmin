...
<tr height=35 style='height:26.25pt '>
	...
	<td width=240 colspan=3 align=right class=mid_title style='border-bottom:0.5pt solid black;' >텐바이텐 (<%= oordersheetmaster.FOneItem.FBaljuCode %>)</td>
</tr>
<tr height=16 >
...
<tr height=16 >
	...
	<td colspan=2 rowspan=2 class=mid_title><%= oordersheetmaster.FOneItem.Fbaljuname %></td>
...
<tr height=16 >
	...
	<td rowspan=2 colspan=2 align=left class=Format_number_L x:num="<%= oordersheetmaster.FOneItem.FTotalBuycash %>" ><b>\<%= ForMatNumber(oordersheetmaster.FOneItem.FTotalBuycash,0) %></b></td>
...
<tr height=17 align=center >
	...
	<td width=70 class=normal_b style='border-top:0.5pt solid black; border-right:0.5pt solid black; border-bottom:0.5pt solid black;'>업체관리코드</td>
	<td width=110 class=normal_b style='border-top:0.5pt solid black; border-right:0.5pt solid black; border-bottom:0.5pt solid black;'>상품명</td>
	...
	<td width=60 class=normal_b style='border-top:0.5pt solid black; border-right:0.5pt solid black; border-bottom:0.5pt solid black;'>수량</td>
...
<tr height=17 style='mso-height-source:userset;height:20pt'>
	...
	<Td align=center class=normal width=66 style='border-right:0.5pt solid black; border-bottom:0.5pt solid black;'><%= oordersheet.FItemList(i).FUpcheManageCode %> </td>
...
<tr height=30 style='mso-height-source:userset;height:22.5pt'>
	<td colspan=2 align=center height=30 class=normal_b style='border-top:0.5pt solid black; border-left:0.5pt solid black; border-right:0.5pt solid black; border-bottom:0.5pt solid black;'>인계자</td>
