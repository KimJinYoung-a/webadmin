...
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a">
	<tr height="20">
		<td align="left">
			<font size="3"><b>입고내역서(<%= obrand.FOneItem.Fid %>)</b></font>
		</td>
		<td align="right">
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	<tr height="25" bgcolor="FFFFFF">
		<td colspan="7">
			<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a">
				<tr>
					<td><img src="/images/icon_arrow_down.gif" align="absbottom">&nbsp;<strong>입고상세내역</strong></td>
					<td align="right"><b>입고일자 : <%= executedate %></b></td>
				</tr>
			</table>
		</td>
	</tr>
