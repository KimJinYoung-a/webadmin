...
<script type="text/javascript">
	...
	c0.innerHTML = "&nbsp;";
	var inHtml = "<input type='hidden' name='doc_file' value='<%=vTemp_URL(i)%>'><input type='hidden' name='doc_realfile' value='<%=vTemp_RealURL(i)%>'><img src='http://fiximage.10x10.co.kr/web2009/common/cmt_del.gif' border='0' style='cursor:pointer' onClick='clearRow(this)'> <a href=javascript:alert('먼저저장해야합니다.');><%=vTemp_Name(i)%></a>";
	c0.innerHTML = inHtml;
</script>
<%
Next
