...
<%
'###########################################################
' Description : MD업무참고용FAQ
' Hieditor : 2021.11.25 한용민 생성
'###########################################################
%>
...
function fnfaq_reg(fidx){
	var reg = window.open('/admin/mdMenu/md_manual_faq_edit.asp?menupos=<%=menupos%>&fidx='+fidx,'reg','width=1280,height=700,scrollbars=yes,resizable=yes');
	reg.focus();	
}
...
<tr align="center" bgcolor="#FFFFFF" onmouseover=this.style.background="#f1f1f1"; onmouseout=this.style.background='#FFFFFF';>
	...
	<td width=200>
		<%= getmdfaqgubunname(ofaq.FItemList(i).fgubun) %>
	</td>
