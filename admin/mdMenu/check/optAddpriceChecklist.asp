...
SET oCheck = new cCheck
	...
	oCheck.getOptAddpriceCheckList

	arrList = oCheck.fnOptAddpriceCheckList
%>
...
<tr align="center" bgcolor="#FFFFFF" >
	<td colspan="2"><h2>※옵션추가금액 중에 매입가 오류</h2></td>
</tr>
<tr align="center" bgcolor="#FFFFFF" >
	<td align="left">
...
<% If session("ssBctID")="icommang" or session("ssBctID")="kjy8517" or session("ssBctID")="hrkang97" then %>
<p /><p />
<h2>주문내역</h2>
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
