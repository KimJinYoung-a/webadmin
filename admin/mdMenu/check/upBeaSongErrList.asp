...
SET oCheck = new cCheck
	...
	oCheck.getUpCheBeasongErrList
%>
<script type="text/javascript" src="/js/jquery-1.7.1.min.js"></script>
<script language='javascript'>
function pop_itemEdit(v){
...
<tr align="center" bgcolor="#FFFFFF" >
	<td colspan="2"><h2>※업체조건배송이 아니나 조건배송으로 되어 있는것.(업체정책은 무료 but 상품은 조건 배송)</h2></td>
</tr>
<tr align="center" bgcolor="#FFFFFF" >
	<td align="left">
...
<tr align="center" bgcolor="#FFFFFF">
	...
	<td><%= oCheck.FItemList(i).FDefaultFreeBeasongLimit %></td>
	<td><%= oCheck.FItemList(i).FLastupdate %></td>
	<td><%= oCheck.FItemList(i).FCatename %></td>
	<td><input type="button" class="button" value="Check" onclick="pop_itemEdit('<%= oCheck.FItemList(i).FItemID %>');"></td>
</tr>
<% Next %>
<% Else %>
<tr height="50">
