...
<tr align="center" bgcolor="#E6E6E6">
	...
	<td width="70">주문번호</td>
	<td width="50">상품코드</td>
	<td width="150">상품명 <font color="blue">[옵션]</font></td>
	<td width="40">갯수</td>
...
<tr bgcolor="#FFFFFF">
    ...
    <td align="center"><%= obrandCs.FItemList(i).Forderserial %></td>
    <td align="center"><%= obrandCs.FItemList(i).FItemID %></td>
    <td ><%= obrandCs.FItemList(i).FItemName %>
        <% if (obrandCs.FItemList(i).FItemOptionName<>"") then %>
        <font color="blue">[<%= obrandCs.FItemList(i).FItemOptionName %>]</font>
        <% end if %>
    </td>
    <td align="center"><%= obrandCs.FItemList(i).FconfirmItemNo %></td>
    <td align="center"><%= obrandCs.FItemList(i).FIsUpchebeasong %></td>
    <td ><%= Left(obrandCs.FItemList(i).Ffinishdate,10) %></td>
    <td ></td>
</tr>
<% next %>
<tr bgcolor="#FFFFFF">
