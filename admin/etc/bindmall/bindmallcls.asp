...
Class CBindmallItem
	...
	Public Function getbindmallStatName
		...
		Select Case FbindmallStatCd
			CASE -9 : getbindmallStatName = "미등록"
			CASE -1 : getbindmallStatName = "등록실패"
			CASE 0 : getbindmallStatName = "<font color=blue>등록예정</font>"
			CASE 1 : getbindmallStatName = "전송시도"
			CASE 3 : 
				If FbindmallRegisterStep = "1" Then
					getbindmallStatName = "<font color=red>등록중(STEP1)</font>"
				ElseIf FbindmallRegisterStep = "2" Then
					getbindmallStatName = "<font color=red>등록중(STEP2)</font>"
				End If
...
Class CBindmall
	...
	Public Sub getbindmallRegedItemList
		...
		'bindmall품절&텐바이텐판매가능(판매중,한정>=10) 상품보기
