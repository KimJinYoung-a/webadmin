...
<!-- #include virtual="/admin/etc/auction/incauctionFunction.asp"-->
...
If action = "ebayCommonCode" Then
	If ccd = "brand" or ccd = "maker" or ccd = "placepolicy" or ccd = "infocodedtl" or ccd = "mastercode" or ccd = "sitecode" Then
		Call fnebayCommonCode(ccd, goodsGrpCd)
		response.end
	ElseIf ccd = "dispcategory" Then
		'webadmin에서 호출 뺐음..강제로 URL 호출해서 끌어오자.
		''0.	DELETE FROM db_temp.dbo.tbl_ebay_siteCategory 해서 비우기
		''1.	http://localhost:11117/admin/etc/auction/auctionActProc.asp?act=ebayCommonCode&ccd=dispcategory&depth=1 호출 1depth처리
		''2.	http://localhost:11117/admin/etc/auction/auctionActProc.asp?act=ebayCommonCode&ccd=dispcategory&depth=2 호출 2depth처리
		''3.	http://localhost:11117/admin/etc/auction/auctionActProc.asp?act=ebayCommonCode&ccd=dispcategory&depth=3 호출 3depth처리
		''4.	http://localhost:11117/admin/etc/auction/auctionActProc.asp?act=ebayCommonCode&ccd=dispcategory&depth=4 호출 4depth처리
		''5.	http://localhost:11117/admin/etc/auction/auctionActProc.asp?act=ebayCommonCode&ccd=dispcategory&depth=o 호출 재귀함수로 실제 테이블 만들기
		If depth = "1" Then
			strSql = ""
