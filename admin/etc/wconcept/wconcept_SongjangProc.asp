...
End If
Call fnwconceptSongjangUpload(ord_no, ord_dtl_sn, hdc_cd, inv_no, iMessage, failCount, ORG_ord_no)
...
If NOT(IsSuccss) Then
	...
	If failCount > 0 Then
		...
		response.write "    var uri = 'wconceptActProc.asp?act=updateSendState&ord_no='+ORG_ord_no+'&ord_dtl_sn='+ord_dtl_sn+'&updateSendState='+selectValue;"&VbCRLF
