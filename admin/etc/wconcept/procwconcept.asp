...
Dim cdl, cdm, cds, CateKey, mediumcode
...
Select Case mode
	Case "saveCate"
        '중복 확인
		sqlStr = "Delete From db_etcmall.dbo.tbl_wconcept_cate_mapping " & VbCrlf
		...
		sqlStr = ""
		sqlStr = sqlStr & " INSERT INTO db_etcmall.dbo.tbl_wconcept_cate_mapping  " & VbCrlf
		sqlStr = sqlStr & " (CategoryCode, MediumCode, tenCateLarge, tenCateMid, tenCateSmall, lastUpdate)" & VbCrlf
		sqlStr = sqlStr & " VALUES('" & CateKey & "', '"& mediumcode &"' "  & VbCrlf
