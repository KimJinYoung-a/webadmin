...
<tr valign="top">
	...
	<font color="red"><strong>wconcept 카테고리 검색</strong></font></td>
...
<tr height="5" valign="top">
	...
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> 검색결과 : <strong><%=oWconcept.FtotalCount%></strong></td>
...
%>
<tr align="center" height="25" onClick="fnSelDispCate('<%= oWconcept.FItemList(i).FCategoryCode %>', '<%= oWconcept.FItemList(i).FMediumCode %>', '<%= replace(isNullDepthName, "'", "`") %>')" style="cursor:pointer" title="카테고리 선택" bgcolor="#FFFFFF">
