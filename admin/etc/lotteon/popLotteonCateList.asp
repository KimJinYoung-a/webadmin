...
<tr valign="top">
	...
	<font color="red"><strong>Lotteon 카테고리 관리</strong></font></td>
...
<tr>
	<td align="right" style="padding-top:5px;">
		...
		<select name="srcDiv" class="select">
			<option value="CCD" <%=chkIIF(srcDiv="CCD","selected","")%>>Lotteon 코드</option>
...
<tr align="center" height="25" bgcolor="<%= CHKIIF(IsNull(oLotteon.FItemList(i).FStd_cat_id),"#CCCCCC","#FFFFFF") %>">
	...
	<td colspan="3"><input type="button" class="button" value="Lotteon 카테 매칭" onClick="popLotteonCateMap('<%= oLotteon.FItemList(i).FtenCateLarge %>','<%= oLotteon.FItemList(i).FtenCateMid %>','<%= oLotteon.FItemList(i).FtenCateSmall %>','')"></td>
	<% Else %>
