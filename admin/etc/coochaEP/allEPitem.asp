...
<tr bgcolor="#FFFFFF" height="20" align="center">
	...
	<td>
        <% if allEP.FItemList(i).FSaleYn="Y" then %>
        <strike><%= FormatNumber(allEP.FItemList(i).FOrgPrice,0) %></strike><br>
        <font color="#CC3333"><%= FormatNumber(allEP.FItemList(i).FSellcash,0) %></font>
        <% else %>
