...
Set oMy11st = new CMy11st
	oMy11st.FPageSize = 5000
	oMy11st.FCurrPage = page
	oMy11st.FsearchName = srcKwd
	oMy11st.getMy11stCateList
%>
...
<tr valign="top">
	...
	<font color="red"><strong>11번가 카테고리 검색</strong></font></td>
...
<tr height="5" valign="top">
	...
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> 검색결과 : <strong><%=oMy11st.FtotalCount%></strong></td>
...
%>
<tr align="center" height="25" onClick="fnSelDispCate('<%= oMy11st.FItemList(i).FCateKey %>', '<%= replace(oMy11st.FItemList(i).Fdepth3Nm, "'", "`") %>')" style="cursor:pointer" title="카테고리 선택" bgcolor="#FFFFFF">
	<td><%= oMy11st.FItemList(i).FCateKey %></td>
	<td><%= oMy11st.FItemList(i).Fdepth1Nm %></td>
	<td><%= oMy11st.FItemList(i).Fdepth2Nm %></td>
	<td><%= oMy11st.FItemList(i).Fdepth3Nm %></td>
</tr>
<%
		Next
	End If
