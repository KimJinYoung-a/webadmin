...
<tr height="25" bgcolor="FFFFFF">
	<td colspan="19">
		...
		2.<a href="http://adcenter.shopping.naver.com" target="_blank">http://adcenter.shopping.naver.com 상품관리>상품현황및관리>서비스상품>가격비교매칭완료</a><br>
...
<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
	...
	<td>TEN 브랜드<br>상품명</td>
	<!-- <td>상세</td> -->
	<td width="100">네이버<br>당시 판매가</td>
...
<tr align="center" bgcolor="#FFFFFF">
	...
	<td align="center"><%= LEFT(olow.FItemList(i).FLastupdate,10) %></td>
</tr>
<% Next %>
<tr height="20">
