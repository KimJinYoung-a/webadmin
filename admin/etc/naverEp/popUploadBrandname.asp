...
<form name="frmFile" method="post" action="/admin/etc/naverEp/procBrandnameUpload.asp"  enctype="MULTIPART/FORM-DATA">
<tr align="center" bgcolor="#FFFFFF">
	<td bgcolor="<%= adminColor("tabletop") %>">파일명:</td>
	<td align="left">
		<input type="file" name="sFile" class="file">
		&nbsp;&nbsp;&nbsp;<a href="/admin/etc/naverEp/brandnameSample.xls"><font color="BLUE"><strong>샘플다운</strong></font></a><br><br />
