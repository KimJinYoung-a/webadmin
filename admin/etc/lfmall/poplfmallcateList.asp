...
<tr valign="top" bgcolor="#FFFFFF">
	<td>
		<font color="red"><strong>Lfmall 카테고리 관리</strong></font>
	</td>
</tr>
</table>
<!-- 액션 -->
...
<tr align="center" height="25" bgcolor="<%= CHKIIF(IsNull(oLfmall.FItemList(i).FCateKey),"#CCCCCC","#FFFFFF") %>">
	...
	<td colspan="3"><input type="button" class="button" value="Lfmall 카테 매칭" onClick="popLfmallCateMap('<%= oLfmall.FItemList(i).FtenCateLarge %>','<%= oLfmall.FItemList(i).FtenCateMid %>','<%= oLfmall.FItemList(i).FtenCateSmall %>','')"></td>
	<% Else %>
