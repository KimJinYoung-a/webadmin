...
<tr valign="top">
	...
	<font color="red"><strong>Marketfor 카테고리 관리</strong></font></td>
...
<tr>
	<td align="right" style="padding-top:5px;">
		...
		<select name="srcDiv" class="select">
			<option value="CCD" <%=chkIIF(srcDiv="CCD","selected","")%>>Marketfor 코드</option>
...
<tr align="center" height="25" bgcolor="#E8E8FF">
	...
	<td colspan="4">Marketfor 카테고리</td>
</tr>
...
<tr align="center" height="25" bgcolor="<%= CHKIIF(IsNull(oMarketfor.FItemList(i).FCatekey),"#CCCCCC","#FFFFFF") %>">
	...
	<td colspan="3"><input type="button" class="button" value="Marketfor 카테 매칭" onClick="popMarketforCateMap('<%= oMarketfor.FItemList(i).FtenCateLarge %>','<%= oMarketfor.FItemList(i).FtenCateMid %>','<%= oMarketfor.FItemList(i).FtenCateSmall %>','')"></td>
	<% Else %>
