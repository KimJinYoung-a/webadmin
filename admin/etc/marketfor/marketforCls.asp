...
Class CMarketforItem
	...
	Public Function getMarketforStatName
		...
		Select Case FMarketforStatcd
			CASE -9 : getMarketforStatName = "미등록"
			CASE -1 : getMarketforStatName = "등록실패"
			CASE 0 : getMarketforStatName = "<font color=blue>등록예정</font>"
			CASE 3 : getMarketforStatName = "승인예정"
			CASE 2 : getMarketforStatName = "반려"
			CASE 4 : getMarketforStatName = "취소"
			CASE 1 : getMarketforStatName = "전송시도"
