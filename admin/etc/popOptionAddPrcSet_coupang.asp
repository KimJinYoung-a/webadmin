...
Dim mallid
dim sqlStr, arrRows
dim regitemname,outmallGoodNo,optaddPrcCnt, lastStatCheckDate, productId
dim TEN_URI, OUT_URI
dim i
...
sqlStr = sqlStr & " ,lastStatCheckDate, productId"
...
sqlStr = sqlStr & " ,r.vendorItemId, r.outmallOptName,r.outmallSellyn,r.outmalllimityn,r.outmalllimitno,r.outmallAddPrice, r.sellerProductItemId"&VbCRLF
sqlStr = sqlStr & " from [db_item].[dbo].tbl_item_option o"&VbCRLF
sqlStr = sqlStr & " 	left join db_etcmall.dbo.tbl_coupang_regedoption r"&VbCRLF
...
sqlStr = sqlStr & " ,r.vendorItemId, r.outmallOptName,r.outmallSellyn,r.outmalllimityn,r.outmalllimitno,r.outmallAddPrice, r.sellerProductItemId"&VbCRLF
sqlStr = sqlStr & " from db_etcmall.dbo.tbl_coupang_regedoption r"&VbCRLF
...
OUT_URI = "http://www.coupang.com/vp/products/"&productId
...
function refreshSellStat(itemid){
	if (mallid=="lotteimall"){
...
<tr  bgcolor="#FFFFFF" align="center">
    <td bgcolor="#FFFFFF" align="center" colspan="4">coupang</td>
...
<tr  bgcolor="#FFFFFF" align="center">
    ...
    <td width="20%" colspan="2"><a href="<%= OUT_URI %>" target=_blank><%= productId %></a></td>
</tr>
<% if (mngOptAdd="1") then %>
<tr>
...
<tr align="center" bgcolor="#F3F3FF" height="20">
    ...
    <td colspan="5">coupang <input type="button" value="단품재수신" class="button" onClick="refreshSellStat('<%=itemid %>')">
    <br><br>(복합옵션은 정확하지 않음)
    </td>
</tr>
<tr align="center" bgcolor="#F3F3FF" height="20">
...
<tr align="center" bgcolor="#FFFFFF" height="20">
    ...
    <td bgcolor="<%= CHKIIF(isOutOptSoldOut,"#EEEEEE","#FFFFFF") %>" ><%= ArrRows(18,i) %></td>
