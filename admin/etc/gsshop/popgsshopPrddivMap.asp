...
<!--
	...
	function fnSearchCJPrddiv(disptpcd, cddnm) {
		var pFCL = window.open("popFindgsshopPrddiv.asp?infodiv="+disptpcd+"&cdd_NAME="+cddnm,"popgsshopPrddiv","width=1500,height=700,scrollbars=yes,resizable=yes");
		pFCL.focus();
	}
//-->
</script>
...
<tr valign="top">
	...
	<font color="red"><strong>gsshop 상품분류 매칭</strong></font></td>
...
<tr height="5" valign="top">
	<td width="10" align="right" background="/images/tbl_blue_round_04.gif"></td>
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> gsshop 상품분류 매칭 정보</td>
	<td width="10" align="left" background="/images/tbl_blue_round_05.gif"></td>
</tr>
</table>
<!-- 표 중간바 끝-->
...
<% End If %>
<tr height="25">
    <td id="brTT" width="80" align="center" bgcolor="#DDDDFF" rowspan="<%= ogsshop.FResultCount + 1 %>" >등록된<br>상품분류</td>
	<td bgcolor="#FFFFFF" height="1"></td>
</tr>
<% If Not IsNULL(ogsshop.FItemList(0).FDivcode) Then %>
<tr>
    <td bgcolor="#F2F2F2"><b><span id="selBr">[<%=ogsshop.FItemList(0).FDivcode%>] <%=ogsshop.FItemList(0).Fcdd_Name%></span></b>
    &nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/icon_delete.gif" width="45" height="20" border="0" onclick="fnDelForm('<%=ogsshop.FItemList(0).FDivcode%>')" style="cursor:pointer" align="absmiddle">
    </td>
</tr>
<% End If %>
</table>
