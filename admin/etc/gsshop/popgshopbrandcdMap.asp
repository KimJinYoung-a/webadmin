...
Set oGSShop = new CGSShop
	...
	oGSShop.getTengsshopOneBrandcd
%>
...
<!--
	...
	function fnSaveForm() {
		...
		if(frm.brandcd.value=="") {
			alert("매칭할 GSShop 브랜드코드를 입력해주세요.");
			frm.brandcd.focus();
			return;
		}

		if(confirm("저장하시겠습니까?")) {
			frm.mode.value="savebrandcd";
			frm.action="procgsshop2.asp";
			frm.submit();
		}
	}

    function fnDelForm(makerid) {
		var frm = document.srcFrm;
		if(confirm("매칭된 브랜드코드를 삭제하시겠습니까?")) {
			frm.mode.value="delbrandcd";
			frm.action="procgsshop2.asp";
			frm.submit();
		}
	}
...
<tr height="5" valign="top">
	<td width="10" align="right" background="/images/tbl_blue_round_04.gif"></td>
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> GSShop 브랜드코드 매칭 정보</td>
	<td width="10" align="left" background="/images/tbl_blue_round_05.gif"></td>
</tr>
</table>
<!-- 표 중간바 끝-->
...
<table width="100%" border="0" align="center" class="a" cellpadding="2" cellspacing="1" bgcolor="#BABABA">
<tr height="25">
    <td id="brTT" width="120" align="center" bgcolor="#DDDDFF">브랜드코드</td>
	<td bgcolor="#FFFFFF" height="1">
		<input type="text" name="brandcd" value="<%= oGSShop.FItemList(0).FBrandcd %>">
		<% If NOT isnull(oGSShop.FItemList(0).FBrandcd) Then %>
		&nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/icon_delete.gif" width="45" height="20" border="0" onclick="fnDelForm('<%=oGSShop.FItemList(0).FUserid%>')" style="cursor:pointer" align="absmiddle">
		<% End If %>
	</td>
</tr>
</table>
