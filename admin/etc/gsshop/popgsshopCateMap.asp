...
<!--
	...
	function fnSearchCJCate(disptpcd) {
		var pFCL = window.open("","popgsshopCate","width=900,height=700,scrollbars=yes,resizable=yes");
		pFCL.focus();
		srcFrm.target="popgsshopCate";
		srcFrm.action="popFindgsshopCate.asp";
		srcFrm.submit();
	}
//-->
</script>
...
<tr valign="top">
	...
	<font color="red"><strong>gsshop 카테고리 매칭</strong></font></td>
...
<tr height="5" valign="top">
	<td width="10" align="right" background="/images/tbl_blue_round_04.gif"></td>
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> gsshop 전시 카테고리 매칭 정보 <!--(변경하려면 삭제후 저장) 1:1 카테고리로.--></td>
	<td width="10" align="left" background="/images/tbl_blue_round_05.gif"></td>
</tr>
</table>
<!-- 표 중간바 끝-->
...
<tr height="25">
    <td id="brTT" width="80" align="center" bgcolor="#DDDDFF" rowspan="<%= ogsshop.FResultCount + 1 %>" >등록된<br>카테고리</td>
	<td bgcolor="#FFFFFF" height="1"></td>
</tr>
<% For i = 0 to ogsshop.FResultCount - 1 %>
<% If Not IsNULL(ogsshop.FItemList(i).FDispNo) Then %>
<tr>
    <td bgcolor="#F2F2F2"><b><span id="selBr"><%=ogsshop.FItemList(i).getDispGubunNm%> [<%=ogsshop.FItemList(i).FDispNo%>] <%=ogsshop.FItemList(i).FDispNm%></span></b>
    &nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/icon_delete.gif" width="45" height="20" border="0" onclick="fnDelForm('<%=ogsshop.FItemList(i).FDispNo%>')" style="cursor:pointer" align="absmiddle">
    </td>
</tr>
<% End If %>
<% Next %>
...
<input type="hidden" name="categbn" value="">
