...
If ogsshop.FResultCount <= 0 Then
	Call Alert_Close("해당 MDID 정보가 없습니다.")
	dbget.Close: Response.End
End If
%>
...
<!--
	...
	function fnSaveForm() {
		...
		if(frm.mdid.value=="") {
			alert("매칭할 MDID를 선택해주세요.");
			return;
		}

		if(confirm("선택하신 MDID로 매칭하시겠습니까?")) {
    ...
    function fnDelForm(iDspNo,mdid) {
		var frm = document.frmAct;
		if (iDspNo=="") {
		    alert("삭제할 MDID를 선택해주세요.");
			return;
		}

		if(confirm("현재 MDID를 연결해제 하시겠습니까?")) {
...
<tr valign="top">
	...
	<font color="red"><strong>gsshop MDID 매칭</strong></font></td>
...
<tr height="5" valign="top">
	...
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> 텐바이텐 전문 카테고리 정보</td>
...
<tr height="25">
	<td width="80" align="center" bgcolor="#DDDDFF">대</td>
	<td bgcolor="#FFFFFF"><%=ogsshop.FItemList(0).FL_NAME %></td>
</tr>
<tr height="25">
	<td width="80" align="center" bgcolor="#DDDDFF">중</td>
	<td bgcolor="#FFFFFF"><%=ogsshop.FItemList(0).FM_NAME%></td>
</tr>
<tr height="25">
	<td width="80" align="center" bgcolor="#DDDDFF">소</td>
	<td bgcolor="#FFFFFF"><%=ogsshop.FItemList(0).FS_NAME%></td>
</tr>
<tr height="25">
	<td width="80" align="center" bgcolor="#DDDDFF">세</td>
	<td bgcolor="#FFFFFF"><%=ogsshop.FItemList(0).FD_NAME%></td>
</tr>
<tr height="25">
	<td width="80" align="center" bgcolor="#DDDDFF">코드</td>
...
<tr height="5" valign="top">
	<td width="10" align="right" background="/images/tbl_blue_round_04.gif"></td>
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> gsshop MDID 매칭 정보 </td>
	<td width="10" align="left" background="/images/tbl_blue_round_05.gif"></td>
</tr>
</table>
<!-- 표 중간바 끝-->
...
<tr height="25">
	...
	<td bgcolor="#FFFFFF">
		...
		<input type="button" value="검색" class="button" onClick="fnSearchMdid()">
	</td>
</tr>
...
<tr height="25">
    <td id="brTT" width="80" align="center" bgcolor="#DDDDFF" rowspan="<%= ogsshop.FResultCount + 1 %>" >등록된<br>MDID</td>
