...
<tr valign="top">
	...
	<font color="red"><strong>boribori 카테고리 검색</strong></font></td>
...
<tr height="5" valign="top">
	...
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> 검색결과 : <strong><%=oboribori.FtotalCount%></strong></td>
...
%>
<tr align="center" height="25" onClick="fnSelDispCate('<%= oboribori.FItemList(i).FCateKey %>', '<%= replace(oboribori.FItemList(i).FCategoryName, "'", "`") %>')" style="cursor:pointer" title="카테고리 선택" bgcolor="#FFFFFF">
