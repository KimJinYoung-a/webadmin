...
<form name="frmFile" method="post" action="/admin/etc/mustprice/procMustPriceUpload.asp"  enctype="MULTIPART/FORM-DATA">
<tr align="center" bgcolor="#FFFFFF">
	<td bgcolor="<%= adminColor("tabletop") %>">파일명:</td>
	<td align="left">
		<input type="file" name="sFile" class="file">
		&nbsp;&nbsp;&nbsp;<a href="/admin/etc/mustprice/mustPriceSample13.xls"><font color="BLUE"><strong>샘플다운</strong></font></a><br><br />
		1.엑셀은 <font color="red">97-2003 통합문서</font>여야 하고, <font color="red">첫라인</font>은 고정.<br /><br />
		2.샘플 형식과 동일해야 하며, <font color="red">몰 구분</font>을 임의로 입력하지 마세요<br>
		 &nbsp;&nbsp;&nbsp;(셀렉트 선택값으로 입력해야 합니다.)<br /><br />
		3.기간 시작/종료일의 시간까지 정확히 입력하세요<br />
		4.스토어팜(nvstorefarm)은 반드시 정상가 기간 시작/종료일의 시간까지 정확히 입력하세요
	</td>
</tr>
<tr align="center" bgcolor="#FFFFFF">
