...
<tr align="center" bgcolor="#FFFFFF" >
	...
	<td align="left">
		...
		<select name="apiAction" class="select">
			...
			<option value="EDITQTY"	 <%= Chkiif(apiAction = "EDITQTY", "selected", "")%> >재고수정</option>
...
<tr align="center" bgcolor="#FFFFFF">
	<td><input type="checkbox" name="cksel" onClick="AnCheckClick(this);"  value="<%= oOutmall.FItemList(i).FItemid %>_<%= oOutmall.FItemList(i).FItemoption %>"></td>
	...
	<td>
		<%
			If oOutmall.FItemlist(i).FQuantity > 1 Then
				response.write "<font color='BLUE'>"&oOutmall.FItemlist(i).FQuantity&"</font>"
			Else
				response.write "<font color='RED'>"&oOutmall.FItemlist(i).FQuantity&"</font>"
			End If
		%>
	</td>
