...
Set oHalfclub = new CHalfclub
	oHalfclub.FPageSize = 5000
	oHalfclub.FCurrPage = page
	oHalfclub.FsearchName = srcKwd
	oHalfclub.getHalfclubCateList
%>
...
<tr valign="top">
	...
	<font color="red"><strong>Halfclub 카테고리 검색</strong></font></td>
...
<tr height="5" valign="top">
	...
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> 검색결과 : <strong><%=oHalfclub.FtotalCount%></strong></td>
...
%>
<tr align="center" height="25" onClick="fnSelDispCate('<%= oHalfclub.FItemList(i).FdepthCode %>', '<%= replace(oHalfclub.FItemList(i).Fdepth3Nm, "'", "`") %>', '<%= replace(oHalfclub.FItemList(i).FBrandCode, "'", "`") %>', '<%= oHalfclub.FItemList(i).FNeedInfoDiv %>')" style="cursor:pointer" title="카테고리 선택" bgcolor="#FFFFFF">
	<td><%= oHalfclub.FItemList(i).FdepthCode %></td>
	<td><%= oHalfclub.FItemList(i).Fdepth1Nm %></td>
	<td><%= oHalfclub.FItemList(i).Fdepth2Nm %></td>
	<td><%= oHalfclub.FItemList(i).Fdepth3Nm %></td>
</tr>
<%
		Next
	End If
