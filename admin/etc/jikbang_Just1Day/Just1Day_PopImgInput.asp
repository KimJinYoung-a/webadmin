...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="a" bgcolor="#9d9d9d">
	<form name="regfrm" method="post" target="prcframe" action="<%=uploadImgUrl%>/linkweb/jikbang_just1day/just1day_image.asp" enctype="multipart/form-data">	
