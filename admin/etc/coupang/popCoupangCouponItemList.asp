...
<%
Dim page, oSsg, i, idx, oSsgMaster
page		= request("page")
idx			= request("idx")
...
function popMarginDetail(v){
	var popdetail=window.open('/admin/etc/ssg/popSsgMarginItemDetail.asp?midx='+v,'popMarginDetail','width=700,height=300,scrollbars=yes,resizable=yes');
	popdetail.focus();
}
...
<tr align="center" bgcolor="#FFFFFF">
	...
	<td><input type="button" class="button" value="수정" onclick="javascript:location.href='/admin/etc/ssg/popssgMarginItemList.asp?idx=<%= oSsg.FItemList(i).FIdx %>';"></td>
</tr>
<% Next %>
<tr height="20">
