...
Set oHomeplus = new CHomeplus
	...
	oHomeplus.FsearchName = srcKwd
	oHomeplus.getHomeplusDispCateList
%>
...
%>
<tr align="center" height="25" onClick="fnSelDispCate('<%= oHomeplus.FItemList(i).FdepthCode %>', '<%= oHomeplus.FItemList(i).Fdepth6Nm %>')" style="cursor:pointer" title="카테고리 선택" bgcolor="#FFFFFF">
