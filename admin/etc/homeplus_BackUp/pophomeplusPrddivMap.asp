...
<% If (categbn = "dft") Then %>
		if(frm.divsioncode.value=="") {
			alert("매칭할 Homeplus 기준카테고리를 선택해주세요.");
			return;
		}
<% Else %>
		if(frm.depthcode.value=="") {
			alert("매칭할 Homeplus 전시카테고리를 선택해주세요.");
			return;
		}
<% End If %>
		if(confirm("선택하신 기준카테고리로 매칭하시겠습니까?")) {
...
<tr height="5" valign="top">
	<td width="10" align="right" background="/images/tbl_blue_round_04.gif"></td>
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> Homeplus 카테고리 매칭 정보</td>
	<td width="10" align="left" background="/images/tbl_blue_round_05.gif"></td>
</tr>
</table>
<!-- 표 중간바 끝-->
...
<% If mode <> "U" Then %>
<tr height="25">
    <td id="brTT" width="80" align="center" bgcolor="#DDDDFF" rowspan="3" >검색</td>
	<td bgcolor="#FFFFFF">
		<% If categbn = "dft" Then %>
		<input type="button" value="기준카테고리검색" class="button" onClick="fnSearchHomeplusPrddiv('<%=infodiv%>')">
		<% Else %>
		<input type="button" value="전시카테고리검색" class="button" onClick="fnSearchHomeplusdispcate()">
		<% End If %>
	</td>
</tr>
		<% If categbn = "dft" Then %>
<tr id="BrRow" style="display:">
	<td bgcolor="#F2F2F2">기준카테고리 : <b><span id="selBr"></span></b></td>
</tr>
		<% Else %>
<tr id="BrRow2" style="display:">
	<td bgcolor="#F2F2F2">전시카테고리 : <b><span id="selBr2"></span></b></td>
</tr>
		<% End If %>
<% Else %>
		...
		<% If categbn = "dft" Then %>
<tr height="25">
    <td id="brTT" width="80" align="center" bgcolor="#DDDDFF">기준카테고리</td>
	<td bgcolor="#FFFFFF" height="1">
		...
		<% Else %>
<tr height="25">
    <td id="brTT" width="80" align="center" bgcolor="#DDDDFF">전시카테고리</td>
	<td bgcolor="#FFFFFF" height="1">
