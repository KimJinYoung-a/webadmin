...
<!--
	...
	// ezwel 카테고리 매칭 팝업
	function popEzwelCateMap(cdl,cdm,cds,dno) {
		var pCM = window.open("popNewezwelCateMap.asp?cdl="+cdl+"&cdm="+cdm+"&cds="+cds+"&dspNo="+dno,"popCateMap","width=600,height=400,scrollbars=yes,resizable=yes");
		pCM.focus();
	}
//-->
</script>
...
<tr align="center" height="25" bgcolor="#FFFFFF">
	...
	<td colspan="3"><input type="button" class="button" value="Ezwel 카테 매칭" onClick="popEzwelCateMap('<%= oEzwel.FItemList(i).FtenCateLarge %>','<%= oEzwel.FItemList(i).FtenCateMid %>','<%= oEzwel.FItemList(i).FtenCateSmall %>','')"></td>
	<% Else %>
	<td title="<%=cateAllNm%>" onClick="popEzwelCateMap('<%= oEzwel.FItemList(i).FtenCateLarge %>','<%= oEzwel.FItemList(i).FtenCateMid %>','<%= oEzwel.FItemList(i).FtenCateSmall %>','<%=oEzwel.FItemList(i).FDepthCode%>')" style="cursor:pointer"><%= oEzwel.FItemList(i).FDepthCode %></td>
	<td title="<%=cateAllNm%>" onClick="popEzwelCateMap('<%= oEzwel.FItemList(i).FtenCateLarge %>','<%= oEzwel.FItemList(i).FtenCateMid %>','<%= oEzwel.FItemList(i).FtenCateSmall %>','<%=oEzwel.FItemList(i).FDepthCode%>')" style="cursor:pointer"><%= oEzwel.FItemList(i).FDepth4Nm %></td>
	<td><%=cateAllNm%></td>
	<% End If %>
</tr>
<%
