...
Select Case mode
	Case "saveCate"
        ...
        If categbn = "cate" Then
			...
			sqlStr = sqlStr& " db_etcmall.[dbo].[tbl_ezwel_Newcategory] as C "
			sqlStr = sqlStr& " JOIN db_etcmall.dbo.tbl_ezwel_Newcate_mapping as m on c.depthCode = m.depthCode "
			...
			If tDepthCode = "" Then
				sqlStr = "Delete From db_etcmall.dbo.tbl_ezwel_Newcate_mapping " & VbCrlf
	        ...
	        sqlStr = "SELECT COUNT(*) as cnt FROM db_etcmall.dbo.tbl_ezwel_Newcate_mapping "  & VbCrlf
			sqlStr = sqlStr& " WHERE tenCateLarge='" & cdl & "'"  & VbCrlf
			sqlStr = sqlStr& " 	and tenCateMid='" & cdm & "'"  & VbCrlf
			sqlStr = sqlStr& " 	and tenCateSmall='" & cds & "'"  & VbCrlf
		...
		If joongBok = False Then
			sqlStr = ""
			sqlStr = sqlStr & " INSERT INTO db_etcmall.dbo.tbl_ezwel_Newcate_mapping  " & VbCrlf
			...
			sqlStr = ""
			sqlStr = sqlStr & " INSERT INTO db_outmall.dbo.tbl_ezwel_Newcate_mapping  " & VbCrlf
			sqlStr = sqlStr & " (depthCode, tenCateLarge, tenCateMid, tenCateSmall, lastUpdate)" & VbCrlf
			sqlStr = sqlStr & " VALUES('" & depthCode & "' "  & VbCrlf
			sqlStr = sqlStr & ", '" & cdl & "','" & cdm & "','" & cds & "', getdate()) "
	...
	Case "delCate"
		...
		sqlStr = "DELETE FROM db_outmall.dbo.tbl_ezwel_Newcate_mapping " & VbCrlf
		sqlStr = sqlStr& " WHERE tenCateLarge='" & cdl & "'" & VbCrlf
		sqlStr = sqlStr& " 	and tenCateMid='" & cdm & "'" & VbCrlf
		sqlStr = sqlStr& " 	and tenCateSmall='" & cds & "'" & VbCrlf
		sqlStr = sqlStr& " 	and depthCode='" & depthCode & "'"
