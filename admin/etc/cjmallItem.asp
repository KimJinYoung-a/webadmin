...
<tr bgcolor="#FFFFFF">
    <td style="padding:5 0 5 0">
	    ...
	    <tr>
	    	<td valign="top">
	    		<center><strong>옵션추가금액 있는 상품의 가격수정 법 :</strong> <font color="red">선택상품 판매가격 기준 수정</font> 완료 후  <font color="red">선택상품 단품가격 기준 수정</font></center>
	    		<br>
	    		실제상품 가공 :
				...
				<% If C_ADMIN_AUTH or C_partnership_part then %>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
