...
<tr valign="top">
	...
	<font color="red"><strong>coupang 카테고리 검색</strong></font></td>
...
<tr height="5" valign="top">
	...
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> 검색결과 : <strong><%=oCoupang.FtotalCount%></strong></td>
...
<%
	Else
		For i = 0 to oCoupang.FresultCount - 1
			...
			End If
%>
<tr align="center" height="25" onClick="fnSelDispCate('<%= oCoupang.FItemList(i).FCateKey %>', '<%= replace(isNullDpethNm, "'", "`") %>')" style="cursor:pointer" title="카테고리 선택" bgcolor="#FFFFFF">
