...
<%
	...
	Dim cDisp, vDepth, vItemID, vItemName, vCateCode, vCateName, vSortNo, vIsDefault, vResultCount, vMakerId
...
<form name="frmCateItem" action="cate_item_proc.asp" method="post" style="margin:0px;" target="cateitemproc">
<input type="hidden" name="action" value="update">
<input type="hidden" name="catecode" value="<%=vCateCode%>">
<input type="hidden" name="itemid" value="<%=vItemID%>">
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="a" bgcolor="#CCCCCC">
<tr>
	<td bgcolor="#F3F3FF" width="25%">상품코드</td>
	<td bgcolor="#FFFFFF"><%=vItemID%></td>
</tr>
<tr>
	<td bgcolor="#F3F3FF" width="25%">상품명</td>
	<td bgcolor="#FFFFFF">[<%=vMakerId%>]<%=vItemName%></td>
</tr>
<tr>
