...
'		strRst = strRst &"	<tns:lowpriceInd>10008</tns:lowpriceInd>"												'기본정보 - 유료배송여부(샘플에 누락)
	...
	Public Function getcjmallItemPriceModXML(isPrdCode)
		...
		sqlStr = sqlStr & " Join [db_outmall].[dbo].tbl_OutMall_regedoption ro on o.itemid=ro.itemid and ro.mallid ='cjmall' and ro.itemoption = o.itemoption "
...
'            end if
	...
	Public Function getcjmallItemQTYXML
		...
		Else
			...
			sqlStr = sqlStr & " left join [db_outmall].[dbo].tbl_OutMall_regedoption R on o.itemid=R.itemid and o.itemoption=R.itemoption and R.mallid='cjmall' " & VBCRLF
