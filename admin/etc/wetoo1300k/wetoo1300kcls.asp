...
Class C1300kItem
	...
	Public Function getWetoo1300kStatName
		...
		Select Case FWetoo1300kStatCd
			CASE -9 : getWetoo1300kStatName = "미등록"
			CASE -1 : getWetoo1300kStatName = "등록실패"
			CASE 0 : getWetoo1300kStatName = "<font color=blue>등록예정</font>"
			CASE 1 : getWetoo1300kStatName = "전송시도"
			CASE 3 : getWetoo1300kStatName = "<font color=red>승인예정</font>"
...
Class C1300k
	...
	Public Sub getWetoo1300kRegedItemList
		...
		If (FRectExcTrans <> "") then
			If (FRectExcTrans = "Y") Then
				...
				addSql = addSql & " or i.itemdiv not in ('01', '16', '07') "		'01 : 일반, 16 : 주문제작, 07 : 구매제한
			...
			ElseIf (FRectExcTrans = "F") Then
				...
				addSql = addSql & " and i.itemdiv in ('01', '16', '07') "		'01 : 일반, 16 : 주문제작, 07 : 구매제한
		...
		'1300k품절&텐바이텐판매가능(판매중,한정>=10) 상품보기
		...
		Else
			...
			sqlStr = sqlStr & " and i.itemdiv in ('01', '16', '07') "		'01 : 일반, 16 : 주문제작, 07 : 구매제한
    ...
    Public Sub getWetoo1300kreqExpireItemList
		...
		sqlStr = sqlStr & " 	or i.itemdiv not in ('01', '16', '07') "		'01 : 일반, 16 : 주문제작, 07 : 구매제한
