...
<tr valign="top">
	...
	<font color="red"><strong>benepia 카테고리 검색</strong></font></td>
...
<tr height="5" valign="top">
	...
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> 검색결과 : <strong><%=oBenepia.FtotalCount%></strong></td>
...
%>
<tr align="center" height="25" onClick="fnSelDispCate('<%= oBenepia.FItemList(i).FCateKey %>', '<%= replace(oBenepia.FItemList(i).FCatename, "'", "`") %>')" style="cursor:pointer" title="카테고리 선택" bgcolor="#FFFFFF">
