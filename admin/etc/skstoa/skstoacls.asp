...
Class CSkstoaItem
	...
	Public Function getSkstoaStatName
		...
		Select Case FSkstoaStatCd
			CASE -9 : getSkstoaStatName = "미등록"
			CASE -1 : getSkstoaStatName = "등록실패"
			CASE 0 : getSkstoaStatName = "<font color=blue>등록예정</font>"
			CASE 1 : getSkstoaStatName = "전송시도"
			CASE 3 : getSkstoaStatName = "<font color=red>승인예정</font>"
...
Class CSkstoa
	...
	Public Sub getSkstoaRegedItemList
		...
		'skstoa품절&텐바이텐판매가능(판매중,한정>=10) 상품보기
