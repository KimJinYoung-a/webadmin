...
<tr valign="top">
	...
	<font color="red"><strong>ebay 카테고리 매칭</strong></font></td>
</tr>
</table>
<p>
<!-- 표 중간바 시작-->
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="a" bgcolor="F4F4F4">
<tr height="5" valign="top">
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> ebay 카테고리 매칭 정보</td>
</tr>
</table>
<!-- 표 중간바 끝-->
...
<tr height="25">
	...
	<td bgcolor="#FFFFFF">
		...
		<input type="button" value="검색" class="button" onClick="fnSearchEbayCate();">
	</td>
</tr>
<tr >
	<td bgcolor="#F2F2F2">
...
<tr height="25">
    <td id="brTT" width="80" align="center" bgcolor="#DDDDFF" rowspan="<%= oEbay.FResultCount + 1 %>" >등록된<br>카테고리</td>
	<td bgcolor="#FFFFFF" height="1"></td>
</tr>
<% For i = 0 to oEbay.FResultCount - 1 %>
<% If Not IsNULL(oEbay.FItemList(i).FCateCode) Then %>
<tr>
    <td bgcolor="#F2F2F2"><b><span id="selBr"><%= Chkiif(oEbay.FItemList(i).FGubun="A", "<font color='RED'>옥션</font>", "<font color='GREEN'>지마켓</font>") %>  : <%=oEbay.FItemList(i).FCateName%> [<%= oEbay.FItemList(i).FCateCode%>]</span></b>
    &nbsp;&nbsp;&nbsp;&nbsp;
    </td>
</tr>
<% End If %>
