...
<tr align="center" height="25" bgcolor="<%= CHKIIF(ocjmall.FItemList(i).FCateIsUsing="Y","#FFFFFF","#CCCCCC") %>">
	...
	<td colspan="3"><input type="button" class="button" value="cjmall 카테 매칭" onClick="popCjCateMap('<%= ocjmall.FItemList(i).FtenCateLarge %>','<%= ocjmall.FItemList(i).FtenCateMid %>','<%= ocjmall.FItemList(i).FtenCateSmall %>','')"></td>
	<% Else %>
