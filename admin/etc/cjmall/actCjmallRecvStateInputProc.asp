...
if (hdc_cd="30") or (hdc_cd = "10") or (hdc_cd="39") then
    rw hdc_cd & " 이노지스택배사, 아주택배, KG로지스 자동조회 불가<br>"
...
if (Not recvCheckResult) or (Not IsAutoCheckAvail) then
	...
	if (IsTooManyFail) or (Not IsAutoCheckAvail) then
		If hdc_cd="39" Then
			response.write "배송조회 : <a href='http://www.kglogis.co.kr/' target=_blank>http://www.kglogis.co.kr/</a><br>"
		Else
