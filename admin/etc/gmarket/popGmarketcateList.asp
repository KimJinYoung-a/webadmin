...
<tr valign="top">
	...
	<font color="red"><strong>Gmarket 카테고리 관리</strong></font></td>
...
<tr>
	<td align="right" style="padding-top:5px;">
		...
		<select name="srcDiv" class="select">
			<option value="CCD" <%=chkIIF(srcDiv="CCD","selected","")%>>Gmarket 코드</option>
...
<tr align="center" height="25" bgcolor="<%= CHKIIF(IsNull(oGmarket.FItemList(i).FDepthCode),"#CCCCCC","#FFFFFF") %>">
	...
	<td colspan="3"><input type="button" class="button" value="Gmarket 카테 매칭" onClick="popCjCateMap('<%= oGmarket.FItemList(i).FtenCateLarge %>','<%= oGmarket.FItemList(i).FtenCateMid %>','<%= oGmarket.FItemList(i).FtenCateSmall %>','')"></td>
	<% Else %>
