...
sqlStr = sqlStr & " ,r.optionValue1,r.optionValue2,r.outmallSellyn,r.outmalllimitno"&VbCRLF
sqlStr = sqlStr & " from [db_item].[dbo].tbl_item_option o"&VbCRLF
sqlStr = sqlStr & " 	left join db_etcmall.dbo.tbl_lfmall_new_regedoption r"&VbCRLF
...
sqlStr = sqlStr & " ,r.optionValue1,r.optionValue2,r.outmallSellyn,r.outmalllimitno"&VbCRLF
sqlStr = sqlStr & " from db_etcmall.dbo.tbl_lfmall_new_regedoption r"&VbCRLF
...
OUT_URI = "https://www.lfmall.co.kr/product.do?cmd=getProductDetail&PROD_CD="&outmallGoodNo
