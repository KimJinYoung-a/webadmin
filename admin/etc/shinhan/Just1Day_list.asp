...
' Discription : 신한은행용 저스트 원데이 목록
' History : 2009.10.27 허진원 : 생성
'###############################################

dim page, sDt, eDt, itemid, i, lp
...
<tr bgcolor="#FFFFFF">
	...
	<td align="center"><%= formatPercent(1-oJust.FItemList(i).FjustSalePrice/oJust.FItemList(i).ForgPrice,1) %></td>
	<td align="center"><% if Not(oJust.FItemList(i).isSell) then Response.Write "품절" %></td>
