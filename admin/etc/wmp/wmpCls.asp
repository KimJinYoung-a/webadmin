...
Class CWmpItem
	...
	Public Function getwemakeStatName
		...
		Select Case FwemakeStatCd
			CASE -9 : getwemakeStatName = "미등록"
			CASE -1 : getwemakeStatName = "등록실패"
			CASE 0 : getwemakeStatName = "<font color=blue>등록예정</font>"
			CASE 1 : getwemakeStatName = "전송시도"
			CASE 3 : getwemakeStatName = "<font color=red>OnSale변경전</font>"
