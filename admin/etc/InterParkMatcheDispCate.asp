...
<tr>
    <td valign="top">
        ...
        <form name="frmSvr" method="post" action="interparkCate_Process.asp">
        ...
        <tr bgcolor="#FFFFFF">
            <td width="100" bgcolor="#F3F3FF">전시사용여부</td> 
            <td>
                <font color="<%= ynColor(oInterParkitem.FOneItem.FIparkCateDispyn) %>"><%= oInterParkitem.FOneItem.FIparkCateDispyn %></font>
            </td> 
        </tr>
