...
Set oZilingo = new CZilingo
	oZilingo.FPageSize = 5000
	oZilingo.FCurrPage = page
	oZilingo.FsearchName = srcKwd
	oZilingo.getZilingoCateList
%>
...
<tr valign="top">
	...
	<font color="red"><strong>Zilingo 카테고리 검색</strong></font></td>
...
<tr height="5" valign="top">
	...
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> 검색결과 : <strong><%=oZilingo.FtotalCount%></strong></td>
...
%>
<tr align="center" height="25" onClick="fnSelDispCate('<%= oZilingo.FItemList(i).FCateKey %>', '<%= replace(oZilingo.FItemList(i).Fdepth3Name, "'", "`") %>')" style="cursor:pointer" title="카테고리 선택" bgcolor="#FFFFFF">
	<td><%= oZilingo.FItemList(i).FCateKey %></td>
	<td><%= oZilingo.FItemList(i).Fdepth1Name %></td>
	<td><%= oZilingo.FItemList(i).Fdepth2Name %></td>
	<td><%= oZilingo.FItemList(i).Fdepth3Name %></td>
</tr>
<%
		Next
	End If
