...
function iParkCateReceive(){
    var param1 = "20150901"
	//param1 = '' ;//최초실행시 전부 가져오기.
    //var param1 = '<%= Left(Replace(CStr(DateAdd("d",-365,now())),"-",""),10) %>'
    var popwin = window.open('iParkAPI_Process.asp?mode=cateRcv&param1='+param1+'&param2=&param3=','iParkAPI_Process','width=100,height=100,scrollbars=yes,resizable=yes');
    popwin.focus();
}
...
<tr>
	...
	<td align="right"><!-- 관리자 메뉴 -->
		<input type="button" value="카테고리 땡겨오기" onClick="iParkCateReceive()"></td>
</tr>
</table>
<br>
...
<tr bgcolor="#FFFFFF">
	...
	<td width="167"><input type="button" value="저 장" onClick="goSubmit()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="취 소" onClick="reFresh()"></td>
</tr>
</table>
</form>
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#EEEEEE" class="a">
...
<tr bgcolor="#FFFFFF">
    ...
    <td width="167"><input type="button" value="일괄변경" onClick="cateItemBatchChange();"></td>
</tr>
</table>
</form>
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#EEEEEE" class="a">
