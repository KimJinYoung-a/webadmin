...
Class CNvClassItem
	...
	Public Function getNvClassStatName
		...
		Select Case FNvClassStatCd
			CASE -9 : getNvClassStatName = "미등록"
			CASE -1 : getNvClassStatName = "등록실패"
			CASE 0 : getNvClassStatName = "<font color=blue>등록예정</font>"
			CASE 1 : getNvClassStatName = "전송시도"
...
Class CNvClass
	...
	'// 네이버 스토어팜 클래스 상품 목록 // 수정시 조건이 달라야 함..
...
'				addSql = addSql & " and uc.isExtUsing='Y' "											'// 2018-12-03 김진영 수정 // 제휴판매안함이라도 스토어팜 판매 가능이면 판매
		...
		Else
			If (FRectExcTrans <> "N") Then
    			...
    			sqlStr = sqlStr & " and i.itemdiv in ('08') "	'티켓/클래스 상품
				sqlStr = sqlStr & " and (i.cate_large = '035' and i.cate_mid = '022' and i.cate_small = '010') " '여행/취미 > 취미/강좌 > 클래스 만 등록되야 함
			end if
		End If
