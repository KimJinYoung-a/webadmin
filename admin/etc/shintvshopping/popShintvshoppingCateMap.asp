...
<!--
	...
	function fnSaveForm() {
		...
		if(frm.lgroup.value=="") {
			alert("매칭할 Shintvshopping 카테고리를 선택해주세요.");
			return;
		}
    ...
    function fnDelForm(cdl, cdm, cds) {
		var frm = document.frmAct;
		if (cdl=="") {
		    alert("삭제할 Shintvshopping 카테고리를 선택해주세요.");
			return;
		}
...
<tr valign="top">
	...
	<font color="red"><strong>Shintvshopping 카테고리 매칭</strong></font></td>
</tr>
</table>
<p>
<!-- 표 중간바 시작-->
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="a" bgcolor="F4F4F4">
<tr height="5" valign="top">
	<td align="left"><img src="/images/icon_arrow_down.gif" border="0" vspace="5" align="absmiddle"> Shintvshopping 카테고리 매칭 정보</td>
</tr>
</table>
<!-- 표 중간바 끝-->
...
<tr height="25">
	...
	<td bgcolor="#FFFFFF">
		...
		<input type="button" value="검색" class="button" onClick="fnSearchShintvshoppingCate();">
	</td>
</tr>
...
<tr height="25">
    <td id="brTT" width="80" align="center" bgcolor="#DDDDFF" rowspan="<%= oShintvshopping.FResultCount + 1 %>" >등록된<br>카테고리</td>
