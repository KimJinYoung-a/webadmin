...
Select Case mode
	Case "saveCate"
		sqlStr = "DELETE FROM db_etcmall.dbo.tbl_shintvshopping_cate_mapping " & VbCrlf
		...
		sqlStr = ""
		sqlStr = sqlStr & " INSERT INTO db_etcmall.dbo.tbl_shintvshopping_cate_mapping  " & VbCrlf
		sqlStr = sqlStr & " (lgroup, mgroup, sgroup, dgroup, tgroup, tenCateLarge, tenCateMid, tenCateSmall, lastupdate)" & VbCrlf
		sqlStr = sqlStr & " VALUES('" & lgroup & "', '" & mgroup & "', '" & sgroup & "', '" & dgroup & "', '" & tgroup & "' "  & VbCrlf
