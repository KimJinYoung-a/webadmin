...
<tr valign="top">
	...
	<font color="red"><strong>위메프W패션 카테고리 관리</strong></font></td>
...
<tr>
	<td align="right" style="padding-top:5px;">
		...
		<select name="srcDiv" class="select">
			<option value="CCD" <%=chkIIF(srcDiv="CCD","selected","")%>>위메프W패션 코드</option>
...
<tr align="center" height="25" bgcolor="<%= CHKIIF(IsNull(oWmpfashion.FItemList(i).FCateKey),"#CCCCCC","#FFFFFF") %>">
	...
	<td colspan="3"><input type="button" class="button" value="위메프W패션 카테 매칭" onClick="popWmpfashionCateMap('<%= oWmpfashion.FItemList(i).FtenCateLarge %>','<%= oWmpfashion.FItemList(i).FtenCateMid %>','<%= oWmpfashion.FItemList(i).FtenCateSmall %>','')"></td>
	<% Else %>
