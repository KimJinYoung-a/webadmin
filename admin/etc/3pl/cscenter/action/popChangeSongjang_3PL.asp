...
<!---- 팝업크기 400x195 ---->
<form name="frmWrite" action="popChangeSongjang_3PL.asp">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td style="font-size:12; text-align:left;">
							<input type="radio" name="songjangRegGubun" value="U" <% if (ocsaslist.FOneItem.FsongjangRegGubun = "U") then %>checked<% end if %> > 고객사
							&nbsp;
							<input type="radio" name="songjangRegGubun" value="C" <% if (ocsaslist.FOneItem.FsongjangRegGubun = "C") then %>checked<% end if %> > 고객접수
							&nbsp;
							<input type="radio" name="songjangRegGubun" value="T" <% if (ocsaslist.FOneItem.FsongjangRegGubun = "T") then %>checked<% end if %> > 텐바이텐물류
						</td>
					</tr>
				</table>
			</td>
