		        ...
		        <tr bgcolor="#F4F4F4">
		            ...
		            <td bgcolor="#FFFFFF">
			            <% if (IsUpcheConfirmState) then %>
							...
							<% if (IsRefASExist) and (ocsaslist.FOneItem.Frequireupche = "Y") then %>
							...
							<% else %>
								<textarea class='textarea_ro' readOnly name="contents_finish" cols="68" rows="9"><%= ocsaslist.FOneItem.Fcontents_finish %></textarea>
							<% end if %>
							</td>
