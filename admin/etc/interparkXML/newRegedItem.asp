...
if (ref<>"222.231.7.189") and (Left(ref,10)<>"210.92.223") and (Left(ref,10)<>"61.252.133") and (Left(ref,10)<>"61.252.143") then
...
'				end if
				...
				ELSE
				    ''if (oiParkitem.FItemList(i).Fdeliverytype<>"9") then
