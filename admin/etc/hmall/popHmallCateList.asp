...
<tr valign="top">
	...
	<font color="red"><strong>hmall 카테고리 관리</strong></font></td>
...
<tr>
	<td align="right" style="padding-top:5px;">
		...
		<select name="srcDiv" class="select">
			<option value="CCD" <%=chkIIF(srcDiv="CCD","selected","")%>>hmall 코드</option>
...
<tr align="center" height="25" bgcolor="<%= CHKIIF(IsNull(oHmall.FItemList(i).FCateKey),"#CCCCCC","#FFFFFF") %>">
	...
	<td colspan="3"><input type="button" class="button" value="hmall 카테 매칭" onClick="popHmallCateMap('<%= oHmall.FItemList(i).FtenCateLarge %>','<%= oHmall.FItemList(i).FtenCateMid %>','<%= oHmall.FItemList(i).FtenCateSmall %>','')"></td>
	<% Else %>
