...
<%
'#############################################################
'	Description : 스페셜 다이어리 이미지 등록 팝업
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="a" bgcolor="#9d9d9d">
	<form name="regfrm" method="post" target="prcframe" action="http://upload.10x10.co.kr/linkweb/Diary/DiarySpecialImg_InputProc.asp" enctype="multipart/form-data">
