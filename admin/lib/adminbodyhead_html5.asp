<%
'###########################################################
' Description : html5 헤더
' History : 2016.03.15 한용민 생성(html5으로 변경시 scm 전체가 표준 규격으로 코딩이 되지 않아서 깨짐. 그래서 페이지 따로땀)
'###########################################################
%>
...
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge" /><% '데이터분석 매뉴에서 사용 %>
