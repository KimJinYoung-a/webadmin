...
<%
dim yyyy1,mm1,stockPlace,i,stockPlacename, day1after, arrlist,noti
...
if stockPlace="L" then
    if day1after="" then
        ...
        ostock.Getmonthlystock_day1after_notpaging
        noti="월말이후"
    end if
...
elseif stockPlace="S" then
    if day1after="" then
        ...
        ostock.Getmonthlyshopstock_day1after_notpaging
        noti="월말이후"
    end if
end if
