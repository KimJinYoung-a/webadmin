...
{
	var detailpop = window.open("/admin/maechul/statistic/statistic_daily_analisys.asp?syear="+y1+"&smonth="+m1+"&sday="+d1+"&eyear="+y2+"&emonth="+m2+"&eday="+d2+"&sellchnl="+sellchnl+"&isSendGift=<%=isSendGift%>","detailpop","width=1000,height=780,scrollbars=yes,resizable=yes");
	detailpop.focus();
}
</script>
