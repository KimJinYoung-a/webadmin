...
{
	var detailpop = window.open("/admin/maechul/statistic/statistic_daily_analisys.asp?syear="+y1+"&smonth="+m1+"&sday="+d1+"&eyear="+y2+"&emonth="+m2+"&eday="+d2+"&sitename="+sitename+"&date_gijun="+date_gijun+"&sellchnl="+sellchnl+"&is6ago="+is6ago,"detailpop","width=1000,height=780,scrollbars=yes,resizable=yes");
	detailpop.focus();
}
