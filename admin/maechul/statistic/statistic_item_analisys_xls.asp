...
IF chkchn ="1" then
	IF sVType = 1 THEN
		response.write "상품코드,상품명,카테고리,브랜드,[Total]상품수량,[Total]구매총액,[Total]매출수익,[Total]수익율,[WWW]상품수량,[WWW]구매총액,[WWW]매출수익,[WWW]수익율,[MOB]상품수량,[MOB]구매총액,[MOB]매출수익,[MOB]수익율,[APP]상품수량,[APP]구매총액,[APP]매출수익,[APP]수익율,[제휴]상품수량,[제휴]구매총액,[제휴]매출수익,[제휴]수익율,[해외몰]상품수량,[해외몰]구매총액,[해외몰]매출수익,[해외몰]수익율,평균매입가,재고충당금"& VbCrlf
	ELSEIF sVType = 2 THEN	
		response.write "날짜,상품코드,상품명,카테고리,브랜드,[Total]상품수량,[Total]구매총액,[Total]매출수익,[Total]수익율,[WWW]상품수량,[WWW]구매총액,[WWW]매출수익,[WWW]수익율,[MOB]상품수량,[MOB]구매총액,[MOB]매출수익,[MOB]수익율,[APP]상품수량,[APP]구매총액,[APP]매출수익,[APP]수익율,[제휴]상품수량,[제휴]구매총액,[제휴]매출수익,[제휴]수익율,[해외몰]상품수량,[해외몰]구매총액,[해외몰]매출수익,[해외몰]수익율,평균매입가,재고충당금"& VbCrlf
	END IF
ELSE	
	IF sVType = 1 THEN
	    response.write "상품코드,상품명,카테고리,브랜드,상품수량,소비자가[상품],판매가[상품](할인적용),구매총액[상품](상품쿠폰적용),보너스쿠폰사용액[상품],취급액,업체정산액1(상품쿠폰적용),매출수익1(구매총액기준),수익율,매출수익2(취급액기준),수익율,업체정산액2(매출수익차감),회계매출,평균매입가,재고충당금" & VbCrlf
	ELSEIF sVType = 2 THEN
	    response.write "날짜,상품코드,상품명,카테고리,브랜드,상품수량,소비자가[상품],판매가[상품](할인적용),구매총액[상품](상품쿠폰적용),보너스쿠폰사용액[상품],취급액,업체정산액1(상품쿠폰적용),매출수익1(구매총액기준),수익율,매출수익2(취급액기준),수익율,업체정산액2(매출수익차감),회계매출,평균매입가,재고충당금" & VbCrlf
	END IF
END IF	
