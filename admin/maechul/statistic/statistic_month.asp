...
<%
	...
	vSYear		= NullFillWith(request("syear"),Year(DateAdd("m",-3,now())))
	vSMonth		= NullFillWith(request("smonth"),Month(DateAdd("m",-3,now())))
...
{
	var detailpop = window.open("/admin/maechul/statistic/statistic_daily.asp?syear="+y1+"&smonth="+m1+"&sday="+d1+"&eyear="+y2+"&emonth="+m2+"&eday="+d2+"&sellchnl="+sellchnl+"","detailpop","width=1000,height=780,scrollbars=yes,resizable=yes");
	detailpop.focus();
}
</script>
