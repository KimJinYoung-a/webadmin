...
<%
	...
	Dim cvDateGijun, isPlusSaleItem
	Dim mwdiv
	...
	isPlusSaleItem = NullFillWith(request("isPlusSaleItem"),"")
	...
	cStatistic.FRectIsPlusSaleItem = isPlusSaleItem
...
<tr bgcolor="#FFFFFF">
	...
	<td align="center" >
		[<a href="/admin/upchejungsan/upcheselllistByItem.asp?datetype=<%= cvDateGijun %>&yyyy1=<%=Year(cStatistic.FList(i).FRegdate)%>&mm1=<%=TwoNumber(Month(cStatistic.FList(i).FRegdate))%>&dd1=<%=TwoNumber(Day(cStatistic.FList(i).FRegdate))%>&yyyy2=<%=Year(cStatistic.FList(i).FRegdate)%>&mm2=<%=TwoNumber(Month(cStatistic.FList(i).FRegdate))%>&dd2=<%=TwoNumber(Day(cStatistic.FList(i).FRegdate))%>&delivertype=all&designer=<%=vmakerid%>&isPlusSaleItem=<%=isPlusSaleItem%>" target="_blank">상품별</a>]
		[<a href="/admin/upchejungsan/upcheselllist.asp?datetype=<%= cvDateGijun %>&yyyy1=<%=Year(cStatistic.FList(i).FRegdate)%>&mm1=<%=TwoNumber(Month(cStatistic.FList(i).FRegdate))%>&dd1=<%=TwoNumber(Day(cStatistic.FList(i).FRegdate))%>&yyyy2=<%=Year(cStatistic.FList(i).FRegdate)%>&mm2=<%=TwoNumber(Month(cStatistic.FList(i).FRegdate))%>&dd2=<%=TwoNumber(Day(cStatistic.FList(i).FRegdate))%>&delivertype=all&designer=<%=vmakerid%>&isPlusSaleItem=<%=isPlusSaleItem%>" target="_blank">건별</a>]
	</td>
</tr>
<%
