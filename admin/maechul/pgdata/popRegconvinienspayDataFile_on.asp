...
<%
'###########################################################
' Description : 편의점결제 정산 파일 업로드
' Hieditor : 2023.05.31 한용민 생성
'###########################################################
%>
...
<form name="frmFile" method="post" action="<%= ItemUploadUrl %>/linkweb/pgdata/PGDataFile_on_process.asp"  enctype="MULTIPART/FORM-DATA" style="margin:0px;">
...
* 다운받은 엑셀파일을 <font color="red">Excel 97 통합</font> 형식으로 저장한 후 업로드 하세요.
