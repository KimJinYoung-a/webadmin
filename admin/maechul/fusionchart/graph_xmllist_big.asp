...
<dataset seriesName='실금액' color='F60925' showValues='0' parentYAxis='P'>
<%	for i=0 to Omaechul_list.FTotalCount - 1	%>
	<set value='<%=Omaechul_list.flist(i).fsubtotalprice%>' />
<%	next	%>
</dataset>
	
<dataset seriesName='순수익' color='F2F84A' showValues='0' parentYAxis='P'>
<%	for i=0 to Omaechul_list.FTotalCount - 1	%>
	<set value='<%=Omaechul_list.flist(i).fsunsuik%>' />
<%	next	%>
</dataset>
	
<dataset seriesName='총건수' color='0611F9' showValues='0' parentYAxis='S'>
<%	for i=0 to Omaechul_list.FTotalCount - 1	%>
