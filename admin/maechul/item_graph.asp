...
<tr>
	<td height="30" align="center">
	    <input type="radio" name="rdsellsum" value="O" <%=CHKIIF(rdsellsum="O","checked","")%> >주문수
	    <input type="radio" name="rdsellsum" value="I" <%=CHKIIF(rdsellsum="I","checked","")%> >주문상품수
		...
		&nbsp;&nbsp;
		<input type="checkbox" name="notincout" <%=CHKIIF(vNotIncOutmall<>"","checked","")%>>입점몰 제외
		&nbsp;
		...
		&nbsp;
		[<a target="_itemlog" href='http://webadmin.10x10.co.kr/admin/etc/extsitejungsan_check.asp?itemid=<%=vItemID%>' target='_blank'>가격변동로그보기</a>]
		<% End If %>
	</td>
</tr>
</table>
