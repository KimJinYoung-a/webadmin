...
function reSearchExcelDown(){
	...
	frm.action = "/admin/maechul/maechul_month_brand_log_excel.asp"
    frm.submit();
	frm.target = "";
	frm.action = "";
...
<tr align="center" bgcolor="FFFFFF" onmouseover=this.style.background="F1F1F1"; onmouseout=this.style.background="FFFFFF";>
	...
	<td><%= oCMaechulLog.FItemList(i).fpurchasetypename %></td>
...
<tr bgcolor="FFFFFF" >
    ...
    <td></td>
    <td></td>
	<td align="right"><%= FormatNumber(ToTitemno,0) %></td>
	<% if (C_InspectorUser = False) then %>
