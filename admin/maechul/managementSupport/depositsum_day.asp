...
<tr bgcolor="#FFFFFF" align="center" onmouseover=this.style.background="f1f1f1"; onmouseout=this.style.background="#ffffff";>
	...
	<td>
		<a href="javascript:pop_use_list('<%= left(csell.fitemlist(i).fYYYYMMdd,4) %>','<%= mid(csell.fitemlist(i).fYYYYMMdd,6,2) %>','<%= right(csell.fitemlist(i).fYYYYMMdd,2) %>','<%= left(csell.fitemlist(i).fYYYYMMdd,4) %>','<%= mid(csell.fitemlist(i).fYYYYMMdd,6,2) %>','<%= right(csell.fitemlist(i).fYYYYMMdd,2) %>','sellCash');" onfocus="this.blur()">
