...
Set cuse = New cgiftcardsum_list
	...
	<td align="left">
		...
		<tr>
			<td height="25">
				...
				구매결제구분 : <% drawgiftcardjukyocd "jukyocd",jukyocd," onchange='searchSubmit();'" %>
			</td>
		</tr>
	    </table>
	</td>	
...
useCash = useCash + cuse.fitemlist(i).fuseCash
%>
<tr bgcolor="#FFFFFF" align="center" onmouseover=this.style.background="#f1f1f1"; onmouseout=this.style.background="#FFFFFF";>
	...
	<td>
		<%= FormatNumber(cuse.fitemlist(i).fuseCash,0) %>
	</td>
	<td>
