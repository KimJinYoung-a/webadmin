...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="a" bgcolor="#9d9d9d">
	<form name="regfrm" method="post" target="prcframe" action="http://upload.10x10.co.kr/linkweb/diary_collection/diary_collection_image_proc.asp" enctype="multipart/form-data">
