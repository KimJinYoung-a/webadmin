...
'objDiary.DiaryPrd.FIdx

'objDiary.DiaryPrd.FDiaryType
'objDiary.DiaryPrd.FItemid
'objDiary.DiaryPrd.FBasicImg
'objDiary.DiaryPrd.FListimg
'objDiary.DiaryPrd.FIconImg
'objDiary.DiaryPrd.FgiftYn
'objDiary.DiaryPrd.FonlyYearYn
'objDiary.DiaryPrd.FhitYn
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="a" bgcolor="#9d9d9d">
	<form name="regfrm" method="post" action="diary_reg_proc.asp">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td>
			...
			<label><input type="checkbox" name="freeBaeSongYn" disabled <%' if objDiary.DiaryPrd.Fcoupontype="3" then response.write "checked" %> onclick="return false;"/>무료 배송 </label>
		</td>
	</tr>
	<tr bgcolor="#FFFFFF">
