...
<tr>
	<td><strong>세금계산서 등록</strong><br><hr width="100%"></td>
</tr>
<tr>
	<td>
		<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>" >
			<form name="frmFile" method="post" action="<%=uploadImgUrl%>/linkweb/tax/procEseroUpload.asp"  enctype="MULTIPART/FORM-DATA">
