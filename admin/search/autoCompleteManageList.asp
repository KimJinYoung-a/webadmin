...
<div class="contSectFix scrl">
	<div class="contHead">
		<div class="locate"><h2>검색 &gt; <strong>자동완성 키워드 관리</strong></h2></div>
		<div class="helpBox">
			<form name="frmMenuFavorite" method="post" action="/admin/menu/popEditFavorite_process.asp">
				<input type="hidden" name="mode" value="">
				<input type="hidden" name="menu_id" value="3961">
			</form>
			<a href="javascript:fnMenuFavoriteAct('addonefavorite')">즐겨찾기</a> l 
			<!-- 마스터이상 메뉴권한 설정 //-->
			<a href="Javascript:PopMenuEdit('3961');">권한변경</a> l 
			<!-- Help 설정 //-->
			<a href="Javascript:PopMenuHelp('3961');">HELP</a>
		</div>
	</div>
				...
				<table class="tbType1 listTb">
					...
					%>
							<tr id="tr<%=cAuto.FItemList(i).Fidx%>">
								...
								<td><input type="text" class="formTxt" id="title<%=cAuto.FItemList(i).Fidx%>" name="title" value="<%=cAuto.FItemList(i).Ftitle%>" style="width:100%" onClick="jsThisClick('<%=cAuto.FItemList(i).Fidx%>');" placeholder="고객행복센터" maxlength="20" /></td>
