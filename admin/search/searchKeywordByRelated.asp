...
'' /admin/search/manageRelatedKeywordNEW.asp?research=on&page=1&menupos=3970&orgkeyword=%C7%CA%C5%EB&relatedKeyword=&useYN=Y 이리로가야함.
...
if (searchKeyword <> "") then
	'osearchKeyword.getReportByRelated
end if
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="#FFFFFF">
		...
		<td align="center">
			<%= osearchKeyword.FItemList(i).FprevKeyword %>
		</td>
		<td align="center">
