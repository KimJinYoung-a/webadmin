...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="a" bgcolor="<%= adminColor("topbar") %>">
	...
	<tr height="25" valign="top">
        ...
        <td>
        	<img src="/images/icon_star.gif" align="absbottom">&nbsp;<b>인기검색어 등록</b>
        </td>
...
<table width="100%" border="0" align="center" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
    <form name="frm" method=post action="manageTopKeyword_process.asp">
	<input type="hidden" name="mode" value="add">
	<input type="hidden" name="useYN" value="Y">
    <tr>
    	<td width="100" bgcolor="<%= adminColor("tabletop") %>">검색어</td>
    	<td bgcolor="#FFFFFF">
    		<input type="text" class="text" name="topKeyword" value="" size="20">
    	</td>
    </tr>
    <tr>
