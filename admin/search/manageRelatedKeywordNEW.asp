...
osearchKeyword.GetRelatedKeywordList
...
function jsPopRelatedKeywordModi(prect, rect) {
    var popwin = window.open('popRelatedKeywordModiNew.asp?prect=' + prect + '&rect=' + rect,'popRelatedKeywordModiNew','width=330,height=220,scrollbars=yes,resizable=yes');
    popwin.focus();
}

function jsDelRelatedKeyword(prect, rect) {
...
function jsUseRelatedKeyword(prect, rect) {
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="#FFFFFF">
		...
		<td align="left">
			...
			<input type="button" class="button" value=" 사용 " onClick="jsUseRelatedKeyword('<%= osearchKeyword.FItemList(i).Fprect %>', '<%= osearchKeyword.FItemList(i).Frect %>')">
			<% else %>
			<input type="button" class="button" value=" 삭제 " onClick="jsDelRelatedKeyword('<%= osearchKeyword.FItemList(i).Fprect %>', '<%= osearchKeyword.FItemList(i).Frect %>')">
			<input type="button" class="button" value=" 가중치부여 " onClick="jsPopRelatedKeywordModi('<%= osearchKeyword.FItemList(i).Fprect %>', '<%= osearchKeyword.FItemList(i).Frect %>')">
			<% end if %>
		</td>
	</tr>
	<%
