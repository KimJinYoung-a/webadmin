...
<%
	...
	vSubCopy	= requestCheckVar(Request("subcopy"),70)
	...
	'### 퀵링크 속성 정보
	vBtnName	= requestCheckVar(Request("btnname"),25)
	...
	If vAction = "" Then
		...
		If vIdx = "" Then
			...
			vQuery = vQuery & "'" & vBtnColor & "', '" & vBgGubun & "', '" & vBgColor & "', '" & vBgImgPC & "', '" & vBgImgM & "', '" & vQImgUseYN & "', "
		...
		Else
			...
			vQuery = vQuery & ", bgimgpc = '" & vBgImgPC & "' "
			vQuery = vQuery & ", bgimgm = '" & vBgImgM & "' "
