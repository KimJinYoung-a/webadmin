...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="a" bgcolor="#9d9d9d">
	<form name="regfrm" method="post" target="prcframe" action="<%=uploadImgUrl%>/linkweb/momo/diary/momo_diary_image.asp" enctype="multipart/form-data">	
