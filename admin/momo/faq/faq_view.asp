...
<tr>
	<td colspan="2" height="32" bgcolor="#FAFAFA" align="center">
		<img src="/images/icon_modify.jpg" onClick="self.location='faq_modi.asp?menupos=<%=menupos%>&ntcId=<%=ntcId & param%>'" style="cursor:pointer" align="absmiddle"> &nbsp;
