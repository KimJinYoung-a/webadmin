...
set ofaq = new CNotice
	...
	if ntcId <> "" then
		...
		if ofaq.FTotalCount > 0 then
			ntcId = ofaq.FNoticeList(0).fntcId
			userid = ofaq.FNoticeList(0).fuserid
			commCd = ofaq.FNoticeList(0).fcommCd
			title = ofaq.FNoticeList(0).ftitle
			contents = ofaq.FNoticeList(0).fcontents
			regdate = ofaq.FNoticeList(0).fregdate
			isusing = ofaq.FNoticeList(0).fisusing
		end if
	end if
%>
...
<tr align="center" bgcolor="#FFFFFF">
	<td colspan="2" height="26" align="left"><b>faq 내용 수정</b></td>
</tr>
<tr>
