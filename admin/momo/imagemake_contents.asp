...
<form name="frmcontents" method="post" action="<%=staticimgurl%>/linkweb/momo/image_proc.asp" onsubmit="return false;" enctype="multipart/form-data">
<input type="hidden" name="ckUserId" value="<%=session("ssBctId")%>">
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <% if oMainContents.FOneItem.Fidx<>"" then %>
	  <br><img src="<%=uploadUrl%>/momo/main/<%= oMainContents.FOneItem.fimagepath %>" border="0"> 
	...
	<tr bgcolor="#FFFFFF">
	    <td align="center" colspan=2><input type="button" value=" 저 장 " onClick="SaveMainContents(frmcontents);" class="button"></td>
	</tr>	
</form>
</table>
<%
