...
<form name="regfrm" method="post" target="prcframe" action="<%=uploadImgUrl%>/linkweb/momo/with/momo_with_image.asp" enctype="multipart/form-data">	
...
<tr bgcolor="#FFFFFF">
	<td>
		<input type="file" name="imgFile" size="35" value="" class="file">
		<br>
