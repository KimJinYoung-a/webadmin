...
dim ingimage , wordimage , wordovimage
	yesnoid = requestcheckvar(request("yesnoid"),8)
...
set ocontents = new cyesno_list
	...
	'//수정일경우에만 쿼리
	if yesnoid <> "" then
	ocontents.fyesno_oneitem()
	end if
	
	if ocontents.ftotalcount > 0 then
		yesnoid = ocontents.FOneItem.fyesnoid
		yesnoword = ocontents.FOneItem.fyesnoword
...
function reg(){
	...
	frm.action='/admin/momo/yesno/yesno_process.asp';
	frm.mode.value='edit';	
	frm.submit();
}
</script>
...
<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
	...
	<td bgcolor="#FFFFFF" align="left">
		<%= yesnoid %><input type="hidden" name="yesnoid" value="<%= yesnoid %>">		
	</td>
</tr>
<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
	<td>키워드</td>
	<td bgcolor="#FFFFFF" align="left">
		<input type="text" name="yesnoword" value="<%= yesnoword %>" size=20>		
	</td>
</tr>
<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
	<td>진행중이미지<br>188x159</td>
	<td bgcolor="#FFFFFF" align="left">
		...
		<div align="right" id="ingimgdiv"><% IF ingimage<>"" THEN %><img src="<%=webImgUrl%>/momo/yesno/ing/<%= ingimage %>" width=50 height=50 style="cursor:pointer" ><% End IF %></div>
	</td>
</tr>
<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
	...
	<td bgcolor="#FFFFFF" align="left">
		...
		<div align="right" id="mainimgdiv"><% IF mainimage<>"" THEN %><img src="<%=webImgUrl%>/momo/yesno/main/<%= mainimage %>" width=50 height=50 style="cursor:pointer" ><% End IF %></div>
	</td>
</tr>
<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
	<td>설명이미지424x85</td>
	<td bgcolor="#FFFFFF" align="left">
		...
		<div align="right" id="detailimgdiv"><% IF detailimage<>"" THEN %><img src="<%=webImgUrl%>/momo/yesno/detail/<%= detailimage %>" width=50 height=50 style="cursor:pointer" ><% End IF %></div>
	</td>
</tr>
<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
	<td>리스트이미지</td>
	<td bgcolor="#FFFFFF" align="left">
		...
		<div align="right" id="wordimgdiv"><% IF wordimage<>"" THEN %><img src="<%=webImgUrl%>/momo/yesno/word/<%= wordimage %>" width=50 height=50 style="cursor:pointer" ><% End IF %></div>
	</td>
</tr>
<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
	<td>리스트오버이미지</td>
	<td bgcolor="#FFFFFF" align="left">
		...
		<div align="right" id="wordovimgdiv"><% IF wordovimage<>"" THEN %><img src="<%=webImgUrl%>/momo/yesno/wordov/<%= wordovimage %>" width=50 height=50 style="cursor:pointer" ><% End IF %></div>
	</td>
</tr>
<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
	<td>사용여부</td>
