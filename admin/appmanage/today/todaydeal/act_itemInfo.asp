...
<%
	...
	strSql = "Select top 1 itemname, smallImage , (limitno-limitsold) as limitno From db_item.dbo.tbl_item Where itemid=" & itemid
	...
	if Not(rsget.EOF or rsget.BOF) then
		...
		Set objXMLv = objXML.createElement("item")
			...
			objXMLv.childNodes(2).appendChild(objXML.createCDATASection("limitno_Cdata"))
			...
			objXMLv.childNodes(2).childNodes(0).text = rsget("limitno")
