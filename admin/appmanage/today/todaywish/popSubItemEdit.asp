...
If subidx <> "" then
	dim todaywishItem
	set todaywishItem = new Ctodaywish
	todaywishItem.FRectSubIdx = subidx
	todaywishItem.GetOneSubItem()

	subIdx			=	todaywishItem.FOneItem.FsubIdx
	listidx			=	todaywishItem.FOneItem.Flistidx
	subItemid		=	todaywishItem.FOneItem.FItemid
	sortnum		=	todaywishItem.FOneItem.Fsortnum
	isusing			=	todaywishItem.FOneItem.Fisusing
	itemName		=	todaywishItem.FOneItem.FitemName
	smallImage	=	todaywishItem.FOneItem.FsmallImage

	set todaywishItem = Nothing
End If 
%>
