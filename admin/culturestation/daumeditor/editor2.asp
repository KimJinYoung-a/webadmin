		...
		<div id="tx_trex_container3" class="tx-editor-container">
						...
						<li class="tx-list">
							...
							<div id="tx_richtextbox_menu3" class="tx-richtextbox-menu tx-menu">
								...
								<div class="tx-menu-footer">
									<img class="tx-menu-confirm" src="/admin/culturestation/daumeditor/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/><img class="tx-menu-cancel" hspace="3" src="/admin/culturestation/daumeditor/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
								</div>
							</div>
						</li>
						<li class="tx-list">
			...
			<div id="tx_canvas3" class="tx-canvas">
				<div id="tx_loading3" class="tx-loading">
					<div>
						<img src="/admin/culturestation/daumeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/>
					</div>
				</div>
				...
				<div id="tx_canvas_text_holder3" class="tx-holder">
					<textarea id="tx_canvas_text3" name="tx_canvas_text3" rows="30" cols="30">
					</textarea>
				</div>
			</div>
			<!-- 높이조절 Start -->
			<div id="tx_resizer3" class="tx-resize-bar">
				...
				<img id="tx_resize_holder3" src="/admin/culturestation/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
			</div>
			<div class="tx-side-bi" id="tx_side_bi3">
				<div style="text-align: right;">
					<img hspace="4" height="14" width="78" align="absmiddle" src="/admin/culturestation/daumeditor/images/icon/editor/editor_bi.png" />
				</div>
				...
				<div id="tx_attach_box3" class="tx-attach-box">
					<div class="tx-attach-box-inner">
						<div id="tx_attach_preview3" class="tx-attach-preview">
							...
							<img src="/admin/culturestation/daumeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/>
						</div>
