		...
		<div id="tx_trex_container2" class="tx-editor-container">
			...
			<div id="tx_canvas2" class="tx-canvas">
				...
				<div id="tx_canvas_text_holder2" class="tx-holder">
					<textarea id="tx_canvas_text2" name="tx_canvas_text2" rows="30" cols="30">
					</textarea>
				</div>
			</div>
			<!-- 높이조절 Start -->
			<div id="tx_resizer2" class="tx-resize-bar">
				...
				<img id="tx_resize_holder2" src="/admin/culturestation/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
			</div>
