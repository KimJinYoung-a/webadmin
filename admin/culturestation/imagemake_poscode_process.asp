...
<%
'###########################################################
' History : 2008.04.01 한용민 개발
' culturestation 포스코드 저장
'###########################################################
%>
<%
...
<%
dim poscode , posname,imagetype, imagewidth ,isusing ,imageheight,imagecount
...
sqlStr = "select top 1 poscode,posname,imagetype,imagewidth,imageheight,isusing,imagecount from db_culture_station.dbo.tbl_culturestation_poscode"
...
if (ItemExists) then
    sqlStr = " update db_culture_station.dbo.tbl_culturestation_poscode" + VbCrlf
    ...
    sqlStr = " insert into db_culture_station.dbo.tbl_culturestation_poscode" + VbCrlf
