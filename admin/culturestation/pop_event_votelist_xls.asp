...
rsget.open "SELECT COUNT(*) FROM [db_culture_station].[dbo].[tbl_culturestation_event_subscript] WHERE evt_code = '" & eCode & "'",dbget,1
IF rsget(0) = 0 Then
...
<form name="frmOption" method="get" onsubmit="return chkForm()" action="pop_event_vote_xls_Download.asp">
<tr height="23">
	<td colspan="2" bgcolor="#F3F3F5"><b>컬쳐스테이션 이벤트 응모자 다운로드 옵션 선택</b></td>
</tr>
<tr>
