...
function print(yyyy)
{
var popup = window.open('/admin/chulgo/monthcsclaim_detail_excel.asp?yyyy='+yyyy,'print','width=1024,height=768,scrollbars=yes,resizable=yes');
popup.focus();
}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="a" bgcolor="F4F4F4">
	...
	<tr height="25" valign="top">
		...
		<td background="/images/tbl_blue_round_06.gif">
			...
			<font color="red"><strong> <%= yyyy %> CS 유형별 클레임 통계</strong></font> <input type="button" value="엑셀로출력" onclick="print('<%= yyyy %>');">
			</td>
...
<% set omonthcsclaimtotal = nothing %>
