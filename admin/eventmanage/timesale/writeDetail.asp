...
<%
'#############################################################
'	Description : TIMESALE DETAIL WRITE
...
<script src="/vue/timedeal/detail/mikki.js?v=1.00"></script>
<script src="/vue/timedeal/detail/normal.js?v=1.00"></script>
<script src="/vue/timedeal/detail/store.js?v=1.00"></script>
<script src="/vue/timedeal/detail/index.js?v=1.00"></script>
