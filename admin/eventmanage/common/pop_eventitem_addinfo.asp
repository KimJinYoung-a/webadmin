...
<%
dim cEvtItem , eCode, egCode , sCode
Dim iTotCnt, arrList,intLoop
Dim iPageSize, iCurrpage ,iDelCnt
Dim iStartPage, iEndPage, iTotalPage, ix,iPerCnt
dim target, actionURL
dim itemid, itemname, makerid, sellyn, usingyn, danjongyn, deliverytype, limityn, vatyn, sailyn, couponyn, mwdiv
dim cdl, cdm, cds
...
set cEvtItem = new ClsEvent	
	...
	cEvtItem.FRectDanjongyn    = danjongyn
...
<tr class="a" height="25" bgcolor="#FFFFFF">
	...
	<td align="center"><A href="http://www.10x10.co.kr/shopping/category_prd.asp?itemid=<%=arrList(0,intLoop)%>" target="_blank"><%=arrList(0,intLoop)%></a></td>
	<td align="center">
...
<iframe name="FrameCKP" src="about:blank" frameborder="0" width="400" height="100"></iframe>
<%
