...
<form name="frmImg" method="post" action="<%= uploadImgUrl %>/linkweb/event_admin/V5/event_upload_new_return.asp" enctype="MULTIPART/FORM-DATA" onSubmit="return jsUpload();">
