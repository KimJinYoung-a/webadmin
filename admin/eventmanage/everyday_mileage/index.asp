...
<%
'#############################################################
'	Description : JOOBJOOB
'	History		: 2021.05.18 ±èÇüÅÂ
'#############################################################
%>
...
<script src="/vue/everyday_mileage/store.js?v=1.00"></script>
<script src="/vue/everyday_mileage/index.js?v=1.00"></script>
