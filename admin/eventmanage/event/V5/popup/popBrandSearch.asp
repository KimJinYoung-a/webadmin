...
<table width="100%" border="0" align="center" class="a" cellpadding="2" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
	...
	<% end if %>
		...
		<td><a href="javascript:selectThis('<%= opartner.FPartnerList(i).Fid %>','<%= opartner.FPartnerList(i).Fsocname %>','<%= opartner.FPartnerList(i).Fdgncomment %>')"><%= opartner.FPartnerList(i).FID %></a></td>
		<td>
			<%= opartner.FPartnerList(i).FSocName_Kor %><br>
			<%= opartner.FPartnerList(i).FSocName %>
		</td>
		<td><a href="javascript:selectThis('<%= opartner.FPartnerList(i).Fid %>','<%= opartner.FPartnerList(i).Fsocname %>','<%= opartner.FPartnerList(i).Fdgncomment %>')"><%= opartner.FPartnerList(i).Fcompany_name %></a></td>
