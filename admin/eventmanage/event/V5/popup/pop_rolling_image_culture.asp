...
<%
'###############################################
' PageName : pop_rolling_image_culture.asp
...
function TnSwifeBannerRegCheck(){
    var winpop = window.open('/admin/eventmanage/event/v5/template/slide/pop_culture_themeslide.asp?eC=<%=eCode%>&menuidx=<%=menuidx%>','winpop','width=1450,height=800,scrollbars=yes,resizable=yes');
    winpop.focus();
}
		...
		<table class="tableV19A">
			...
			<tbody>
                <tr>
                    <th>이미지 등록</th>
                    <td>
                        <button class="btn4 btnBlue1" onclick="TnSwifeBannerRegCheck();return false;">슬라이드 이미지 등록</button>
                    </td>
                </tr>
			</tbody>
        </table>
