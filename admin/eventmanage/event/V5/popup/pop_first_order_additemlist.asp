...
function jsSerach(){
	...
	frm = document.frm;
	frm.target = "_self";
	frm.action ="pop_first_order_additemlist.asp";
	frm.submit();
}
...
frm.sType.value = sType;
	...
	$.ajax({
		type: "POST",
		url: "first_order_item_process.asp",
		data: "mode=add&itemidarr="+frm.itemidarr.value,
...
function NextPage(ipage){
	...
	document.frm.action ="pop_first_order_additemlist.asp";
	document.frm.submit();
}
