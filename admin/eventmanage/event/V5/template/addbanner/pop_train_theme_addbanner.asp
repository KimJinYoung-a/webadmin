...
' Discription : I형 추가 테마 기차형 배너 등록
...
Dim slideimg, GroupItemCheck, menuidx
...
<div class="slideRegister adminMob">
	...
	<div class="register">
		<h2>컨텐츠 등록</h2>
		<dl>
			<dt><span>필수 / 2~8개까지 등록</span></dt>
			<dd>
				<div class="insertImg">
					<h3>템플릿 이미지 등록<br/><span style="color:#c80a0a;line-height:2;"><br/>※ 등록버튼 클릭 후에 반영 됩니다.※<br/>※ 이미지 사이즈 : 600 * 600※</span></h3>
				...
				<div class="tMar20">
					...
					<table class="tbType1 listTb tMar10">
						...
						<% 
							...
							sqlStr = "SELECT c.idx , c.title, c.imgurl , c.groupcode, c.viewidx, i.basicimage" + vbcrlf
							...
							sqlStr = sqlStr & " where c.menuidx = '"& menuidx &"'" + vbcrlf
							sqlStr = sqlStr & " and c.grouptype='B'" & vbcrlf
...
<input type="hidden" name="eventid" value="<%=eCode%>"/>
<input type="hidden" name="mode" value="TI"/>
<input type="hidden" name="device" value="W"/>
