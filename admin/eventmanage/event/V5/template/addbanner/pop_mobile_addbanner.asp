...
<div class="slideRegister adminMob bnrRegister">
	<h1>배너 등록(MOBILE)&nbsp;&nbsp;/&nbsp;&nbsp;<a href="/admin/eventmanage/event/v5/template/addbanner/pop_pc_addbanner.asp?eC=<%=eCode%>&menuidx=<%=menuidx%>" style="color:#FFFFFF">(PC Web)</a> <input type="button" class="btn" value="배경/레이아웃 설정" onclick="fnMasterInfoSet();"></h1>
	<div class="register">
		<dl>
			<dd>
							...
							<td>
								<div class="selectLink">
									...
									<ul style="display:none;">
										...
										<li onclick="populateTextBox('#replyList');">#replyList(코멘트바로가기)</li>
										<li onclick="populateTextBox('#replyPrdList');">#replyPrdList(상품후기바로가기)</li>
