	...
	<div class="register">
		...
		<dl>
			...
			<dd>
				...
				<div class="insertImg">
					<h3>슬라이드 이미지 등록<br/><span style="color:#c80a0a;line-height:2;">※ 상하단 이미지 우선 등록후 슬라이드 이미지를 등록해주세요. 또는 슬라이드 우선 등록후 상하단 이미지를 등록 해주세요. ※<br/>※ 등록버튼 클릭후 좌측 Viewer에 반영 됩니다.※<br>※ 이미지 사이즈 : 1140px(FULL) , 1920px(WIDE)※</span></h3>
		...
		<div class="btnArea">
			...
			<a href=""><img src="/images/icon_cancel.gif" alt="취소" /></a>
		</div>
	</div>
</div>
