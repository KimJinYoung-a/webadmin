...
'###########################################################
' Page : /admin/eventmanage/event/v5/template/slide/delslidebanner.asp
' Description :  상단 이미지 삭제
' History : 2019.01.30 정태훈 생성
'###########################################################
%>
...
If idx <> "" Then
dbget.beginTrans
		sqlStr = " delete FROM db_event.[dbo].[tbl_event_top_slide_addimage] WHERE idx=" & idx
