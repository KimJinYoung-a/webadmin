...
Dim videolink, videosize, menuidx
...
Dim arrowonoff : arrowonoff = false
	...
	If eCode <> "" Then 
		...
		strSql = strSql & " and device = 'M' and menuidx=" & menuidx & vbcrlf
...
<div class="evtSection swiper">
	...
	<div class="swiper-container">
		...
		<% 
			...
			sqlStr = sqlStr & " from db_event.[dbo].[tbl_event_slide_addimage] where evt_code = '"& eCode &"' and device = 'M' " & vbcrlf
