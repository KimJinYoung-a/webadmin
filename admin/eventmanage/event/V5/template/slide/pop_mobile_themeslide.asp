...
<%
'###############################################
' PageName : pop_mobile_themeslide.asp
...
function jsSetImg(sFolder, sImg, sName, sSpan){ 
	var winImg;
	winImg = window.open('/admin/eventmanage/common/pop_event_uploadimgV6.asp?yr=<%=Year(now())%>&sF='+sFolder+'&sImg='+sImg+'&sName='+sName+'&sSpan='+sSpan+'&wid=7500&hei=5280','popImg','width=370,height=150');
}
