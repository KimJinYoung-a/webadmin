...
<%
    ...
    Dim strparm, evt_template, evt_template_mo
...
dim strSearch, DesignID, strSort, strSubSort, strSql
	...
	IF elevel <> "" THEN
		strSearch  = strSearch & " and A.evt_level = '"&elevel&"'"
	END If

	if evt_template<>"" then
		strSearch = strSearch & " and evt_template="&evt_template
	end if
	
	if evt_template_mo<>"" then
		strSearch = strSearch & " and evt_template_mo="&evt_template_mo
	end if
    ...
    strSql = "SELECT A.evt_code, A.evt_kind, A.evt_manager, A.evt_scope, A.evt_name, A.evt_startdate, A.evt_enddate, A.evt_level  "&_
            ...
            "       , B.iscomment, B.isbbs, B.isitemps, B.isGetBlogURL , M.evt_copy_code"&_
            ",(select code_desc FROM  [db_event].[dbo].[tbl_event_commoncode] WHERE code_type = 'eventkind' and code_value = a.evt_kind) evt_kinddesc, M.nocate"&_
...
<table width="100%" border="0" align="center" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
    <tr align="center" bgcolor="<%= adminColor("tabletop") %>">
            ...
            <td width="100"><b>중요도</b></td>
            <td width="100"><b>관련이벤트</b></td>
            <td width="100"><b>진행상태</b></td>
            <td>이벤트명</td>
            <td width="200">카테고리</td>
            <td width="150"><b>시작일</b></td>
            <td width="150">종료일</td>
            <td width="150">이미지요청일</td>
            <td width="100">기획자</td>
