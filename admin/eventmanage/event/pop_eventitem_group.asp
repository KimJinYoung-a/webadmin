...
<form name="frmG" method="post" action="<%= uploadImgUrl %>/linkweb/event_admin/eventgroup_process.asp" enctype="MULTIPART/FORM-DATA" onSubmit="return jsGroupSubmit(this);">
	...
	<td>
		<table width="100%" border="0" align="left" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
			...
			<tr>
				...
				<td bgcolor="#FFFFFF"><input type="text" name="sGD" size="20" value="<%=db2html(gdesc)%>" maxlength="32"></td>
			</tr>		
			<tr>
