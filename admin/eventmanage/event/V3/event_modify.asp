	...
	<td >
		<table width="100%" border="0" align="left" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
		   ...
		   <tr id="eNameTr_A" style="display:<% if ekind="16"  then Response.Write "none" %>;">
		   		...
		   		<td bgcolor="#FFFFFF">
		   			<input type="text" name="sEN" id="sEN" maxlength="120" size="60" value="<%=ename%>" OnKeyUp="chkHtmlTag(this);" />
		   		</td>
		   	</tr>
	...
	<td>
		<table width="100%" border="0" align="left" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
			...
			<tr>
				...
				<td bgcolor="#FFFFFF">
					<input type="button" value="PC 추가 배너(<%=chkiif(evt_pc_addimg_cnt<>"",evt_pc_addimg_cnt,"0")%>)" onClick="poppcaddimg();" class="button"> 
				</td>
			</tr>  
			<tr>
	...
	<td>
		<table width="100%" border="0" align="left" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>" style="display:<% If ecomment Then %><% Else %>none<% End If %>" id="comminfo">
			...
			<tr>
				...
				<td bgcolor="#FFFFFF">
					<input type="hidden" name="comm_isusing" value="<%IF ecomment THEN%>Y<%end if%>"><!--20180706 수정 최종원-->					
