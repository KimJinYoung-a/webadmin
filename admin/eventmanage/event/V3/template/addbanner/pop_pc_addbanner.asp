				...
				<div class="insertImg">
					<table class="tbType1 listTb">
						...
						<tr>
							...
							<td>
								<p>시작일 : <input type="text" onclick="jsPopCal('bst_date');" style="width:85px; cursor:pointer;" name="bst_date" readonly> ~ 종료일 : <input type="text" onclick="jsPopCal('bed_date');" style="width:85px; cursor:hand;" name="bed_date" readonly></p>
