...
eChannel    = requestCheckvar(request("eCh"),1)
	If eChannel="M" Then Response.redirect "/admin/eventmanage/event/V3/eventitem_regist_mo.asp?eC="+Cstr(eCode)+"&&selG="+CStr(strG)+"&eCh=M"
            		     ...
            		     <tr>
                          ...
                          <tr>
                      		...
                      		%></td>
                      			    	...
                      			    	<td><% sbGetVarOptEventCodeValue "itemimgsize","itemimgsize", arrList(27,intLoop), false, "" %></td> 
