...
<%
dim eC, page, dispCate, itemname, i, stype, maxDepth, searchdiv
					...
					<div class="search">
						<ul>
							<li>
								...
								<input type="text" class="formTxt" name="itemname" id="schWord" style="width:400px" value="<%=itemname%>" placeholder="상품명을 입력하여 검색하세요." />
							</li>
						</ul>
					</div>
