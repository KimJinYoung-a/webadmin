...
function jsSetImg(sFolder, sImg, sName, sSpan , sOpt){ 
	var winImg;
	<% if mdtheme="4" then %>
	winImg = window.open('/admin/eventmanage/common/pop_event_uploadimgV3.asp?yr=<%=Year(now())%>&sF='+sFolder+'&sImg='+sImg+'&sName='+sName+'&sSpan='+sSpan+'&sOpt='+sOpt+'&wid=780&hei=500','popImg','width=370,height=150');
	<% else %>
