...
<div class="slideRegister adminMob">
	...
	<div class="register">
		...
		<dl>
			...
			<dd>
				<p class="floatImg">플로팅 이미지(width:640px, png로 등록) :<input class="button" type="button" value="이미지 불러오기" name="mtopimg" onclick="jsSetImg('<%=eFolder%>','','topaddimg','spantopaddimg')"/></p>
				<div class="insertImg">
