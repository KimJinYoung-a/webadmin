...
Dim retUrl, brandname, dgncomment, GroupItemPriceView, GroupItemCheck, videoType, GroupItemType, retQS
retUrl = Request.ServerVariables("HTTP_REFERER")
retQS = Request.ServerVariables("QUERY_STRING")
...
isConfirm = False
	...
	strparm  = "isWeb="&blnWeb&"&isMobile="&blnMobile&"&isApp="&blnApp&"&selDate="&sDate&"&iSD="&sSdate&"&iED="&sEdate&"&selEvt="&sEvt&"&sEtxt="&strTxt&"&selC="&sCategory&"&selCM="&sCateMid&"&eventstate="&sState&"&eventkind="&sKind&"&sDgId="&edgid&"&sMdId="&emdid&"&sCCId="&eCCId&_
				"&sdgnm="&edgnm&"&smdnm="&emdnm&"&spsnm="&epsnm&"&sdpnm="&edpnm&"&ebrand="&ebrand&"&chSale="&esale&"&chGift="&egift&"&chCoupon="&ecoupon&"&chOneplusone="&eOneplusone&"&chFreedelivery="&eFreedelivery&"&chBookingsell="&eBookingsell&"&disp="&dispCate&"&chOnlyTen="&eonlyten&"&chDiary="&eDiary&"&eventtype="&etype&"&catesort="&catesort&"&eventtype_pc="&eventtype_pc&"&eventtype_mo="&eventtype_mo
...
'--------------------------------------------------------
	...
	if videoType=" " or videoType="" or isnull(videoType) then videoType="0"
	...
	dgncomment=cEvtCont.FBrandContents
	...
	'//상품이벤트 모바일 & 앱
	If mdthememo = "5" And (isMobile Or isApp) Then
...
Dim otrainitembanner
set otrainitembanner = new CEventBanner
otrainitembanner.FRectEvtCode = eCode

if mdtheme="4" then
if GroupItemType="" then GroupItemType="T"
otrainitembanner.FRectGroupType = GroupItemType
otrainitembanner.GetTrainThemeItemList
end if
%>
<style>
...
//-- jsEvtSubmit : 이벤트 등록 --//
	function jsEvtSubmit(frm){ 
	 ...
	 if (frm.chComm.checked){	//2018.07.03 코멘트 텍스트 박스 데이터 유효성 체크 추가
		if(frm.comm_text.value == ""){
			alert("코멘트 텍스트 박스의 내용을 입력해주세요.");
			frm.comm_text.focus();
			return false;
		}
	 }
...
//		if (frm.comm_isusing.value=="Y" &&  frm.comm_text.value ==""){//2018.07.09 최종원 수정 주석처리
...
//-- jsLastEvent : 지난 이벤트 불러오기 --//
	...
	function jsChkTitle(sType){  
		...
		}else if (sType=="c"){//2018.07.06 최종원 iscomm value 추가
			if (document.frmEvt.chComm.checked){
				document.all.comm_isusing.value="Y"
				<% If etype<>"80" Then %>
				document.all.dvCmt.style.display ="";
				<% end if %>
				document.all.comminfo.style.display ="";
		 	}else{
				document.all.comm_isusing.value="N"
				<% If etype<>"80" Then %>
   ...
   function jsPubHelp(){ 
	...
	function popmoaddimg(){
		var winPopaddimg;
		winPopaddimg = window.open('/admin/eventmanage/event/v3/template/addbanner/pop_mobile_addbanner.asp?eC=<%=eCode%>','pCal','width=1450,height=800,scrollbars=yes,resizable=yes');
		winPopaddimg.focus();
	}
	...
	function TnSelectTheme(objval){
		if(objval==1){
			...
			document.all.itemtypediv.style.display="none";
			document.all.bannergubun.style.display="none";
			document.all.themecolor.style.display="";
			document.all.BrandInfo.style.display="none";
			...
			document.all.bannergubun.style.display="none";
			document.all.themecolor.style.display="";
			document.all.BrandInfo.style.display="";
			document.all.TrainInfo.style.display="";
		}else if(objval==5){
			document.all.bnimg.style.display="none";
			document.all.colorselect2.style.display="none";
			document.all.colorselect1.style.display="none";
			document.all.itemtypediv.style.display="";
			document.all.bannergubun.style.display="";
			document.all.themecolor.style.display="none";
			document.all.BrandInfo.style.display="none";
			document.all.TrainInfo.style.display="none";
		}else{
			document.all.bnimg.style.display="";
		...
		if(objval==2){
			...
			document.all.videopc.style.display="none";
		}else if(objval==4){
			document.all.videopc.style.display="";
		}else{
	...
	function TnSelectThemeMo(objval){
		if(objval==1){
			...
			document.all.mcolorselect3.style.display="";
			document.all.mitemlistdiv.style.display="";
			document.all.mibdiv.style.display="none";
			document.all.mibevtname.style.display="none";
			document.all.mibevtsubcopy.style.display="none";
			document.all.mevtname.style.display="";
			document.all.mevtsubcopy.style.display="";
		}else if(objval==5){
			document.all.bnimgmo.style.display="none";
			document.all.mcolorselect3.style.display="none";
			document.all.mitemlistdiv.style.display="none";
			document.all.mevtname.style.display="none";
			document.all.mevtsubcopy.style.display="none";
			document.all.mibdiv.style.display="";
			document.all.mibevtname.style.display="";
			document.all.mibevtsubcopy.style.display="";
		}else{
	...
	function TnThemeBannerRegCheck(d){
		if (d == "w"){
			if($('#bntype').val()=="T"){
				var winpop = window.open('/admin/eventmanage/event/V4/template/addbanner/pop_theme_addItems.asp?eC=<%=eCode%>&stype=w','winpop','width=1450,height=800,scrollbars=yes,resizable=yes');
			}else{
				var winpop = window.open('/admin/eventmanage/event/v4/template/slide/pop_pcweb_themeslide.asp?eC=<%=eCode%>&bgubun='+ document.frmEvt.themetype.value + '&mdtheme=' + document.frmEvt.mdtheme.value,'winpop','width=1450,height=800,scrollbars=yes,resizable=yes');
			}
			winpop.focus();
		}else{
			if($('#bntypemo').val()=="T"){
				var winpop = window.open('/admin/eventmanage/event/V4/template/addbanner/pop_theme_addItems.asp?eC=<%=eCode%>&stype=m','winpop','width=1450,height=800,scrollbars=yes,resizable=yes');
			}else{
				var winpop = window.open('/admin/eventmanage/event/v4/template/slide/pop_mobile_themeslide.asp?eC=<%=eCode%>&bgubun='+document.frmEvt.themetypemo.value,'winpop','width=1450,height=800,scrollbars=yes,resizable=yes');
			}
			winpop.focus();
		}
	}
	...
	function TnGiftUsingNum2(objval){
		if (objval == "1"){
            document.all.gifttxt1_2.style.display="";
			document.all.giftimg1_2.style.display="";
			document.all.gifttxt2_2.style.display="none";
			document.all.giftimg2_2.style.display="none";
			document.all.gifttxt3_2.style.display="none";
			document.all.giftimg3_2.style.display="none";
        }else if (objval == "2"){
            document.all.gifttxt1_2.style.display="";
			document.all.giftimg1_2.style.display="";
			document.all.gifttxt2_2.style.display="";
			document.all.giftimg2_2.style.display="";
			document.all.gifttxt3_2.style.display="none";
			document.all.giftimg3_2.style.display="none";
        }else if (objval == "3"){
            document.all.gifttxt1_2.style.display="";
			...
			document.all.gifttxt2_2.style.display="";
			document.all.giftimg2_2.style.display="";
			document.all.gifttxt3_2.style.display="";
			document.all.giftimg3_2.style.display="";
	    }
	}
	...
	$(document).ready(function(){
		...
		$('#subcopyK').keyup(function(){
			$("#subsEN").val($("#subcopyK").val());
		});
	});

	var _EventType;
	function jsEventTypeChangeTempSave(){
		var frm = document.frmEvt;
		frm.target = "FrameCKP";
		frm.upback.value = "T";
		frm.submit();
	...
	function FnPCEventTypeChange(eventtype_pc){
		var etype="<%=eventtype_pc%>";
		_EventType=eventtype_pc;
		if(etype!="80" && eventtype_pc=="80")
		{
			jsEventTypeChangeTempSave();
		}
		else if(etype=="80" && eventtype_pc!="80")
		{
			jsEventTypeChangeTempSave();
		}
	}

	function FnPCEventTypeChangeMove(){
		location.href="event_modify.asp?eC=<%=eCode%>&menupos=1739&eventtype_pc="+_EventType;
	}

	function FnMEventTypeChange(eventtype_mo){
		var etype="<%=eventtype_mo%>";
		_EventType=eventtype_mo;
		if(etype!="80" && eventtype_mo=="80")
		{
			jsEventTypeChangeTempSave();
		}
		else if(etype=="80" && eventtype_mo!="80")
		{
			jsEventTypeChangeTempSave();
		}
	}
	
	function FnMoEventTypeChangeMove(){
		location.href="event_modify.asp?eC=<%=eCode%>&menupos=1739&eventtype_mo="+_EventType;
	}
	...
	function TnTrainThemeItemBannerReg(){
		...
		if($("input:radio[name='GroupItemType']:checked").val()=="T"){
			var winpop = window.open("/admin/eventmanage/event/V4/template/addbanner/pop_train_theme_addItems.asp?eC=<%=eCode%>&GroupItemCheck="+$("input:radio[name='GroupItemCheck']:checked").val(),"winpop","width=1450,height=800,scrollbars=yes,resizable=yes");
		}else{
			var winpop = window.open("/admin/eventmanage/event/V4/template/addbanner/pop_train_theme_addbanner.asp?eC=<%=eCode%>&GroupItemCheck="+$("input:radio[name='GroupItemCheck']:checked").val(),"winpop","width=1450,height=800,scrollbars=yes,resizable=yes");
		}
		winpop.focus();
	}
	...
	function TnTrainThemeItemBannerDel(idx){
		document.ibfrm.target="ifrmProc";
	    document.ibfrm.idx.value=idx;
	    document.ibfrm.action="/admin/eventmanage/event/v4/template/addbanner/deltrainthemeitem.asp";
	    document.ibfrm.submit();
	}
	...
	function TnChangeThemeBannerEdit(sFolder, sImg, sName, sSpan){
		var winImg;
		winImg = window.open("/admin/eventmanage/event/v4/template/addbanner/pop_event_uploadimgV4.asp?yr=<%=Year(eregdate)%>&sF="+sFolder+"&sImg="+sImg+"&sName="+sName+"&sSpan="+sSpan,"popImg","width=370,height=150");
		winImg.focus();
	}

	function TnThemeBannerGroupCodeEdit(idx){
		var winG 
		winG = window.open("/admin/eventmanage/event/v4/pop_event_group_select.asp?eC=<%=eCode%>&idx="+idx,"popG","width=370, height=150,scrollbars=yes,resizable=yes");
		winG.focus();
	}

	function TnThemeBannerItemCodeEdit(idx){
		var winG 
		winG = window.open("/admin/eventmanage/event/v4/pop_event_additem.asp?eC=<%=eCode%>&idx="+idx,"popG","width=1024, height=700,scrollbars=yes,resizable=yes");
		winG.focus();
	}
	...
	function fnViewTempType(objval){
		...
		if (objval == "B"){
			...
			$('input[name="GroupItemPriceView"]:radio[value="N"]').attr("checked",true);
	...
	<td >
		<table width="100%" border="0" align="left" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
		   ...
		   <tr id="spSale" style="display:<%if not ((ekind="1" or ekind="23") and (esale)) then %>none<%end if%>;<%if esale then%>color:red;<%end if%>">
		   		...
		   		<td bgcolor="#FFFFFF">
		   			    </font>~[<input type="text" name="sSP" id="sSP" value="<%=salePer%>" size="10" class="text" />]%&nbsp;&nbsp;&nbsp;
						<input type="button" class="button" value="최대값 가져오기" onclick="fnGetMaxSalevalue('S')" /> (숫자만 입력 가능 특수문자 자동입력)
		   		</td>
		   	</tr>
			<tr id="spCSale" style="display:<%if not ((ekind="1" or ekind="23") and (ecoupon)) then %>none<%end if%>;<%if ecoupon then%>color:green;<%end if%>">
		   		...
		   		<td bgcolor="#FFFFFF">
		   			    </font>~[<input type="text" name="sCSP" id="sCSP" value="<%=saleCPer%>" size="10" class="text" />]&nbsp;&nbsp;&nbsp;
						<input type="button" class="button" value="최대값 가져오기" onclick="fnGetMaxSalevalue('C')" /> (숫자만 입력 가능 특수문자 자동입력)
		   		</td>
		   	</tr>
		</table>
	</td>
...
<tr>
	<td>
		<table width="100%" border="0" align="left" class="a" cellpadding="3" cellspacing="0">
			...
			<tr>
				<td valign="top">
					<div id="multi3" style="display:<% If etype<>"90" Then %>none<% End If %>">
					<table width="100%" border="0" align="left" class="a" cellpadding="5" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
						<tR>
							<td bgcolor="#F6CEEC" colspan="2"><b>멀티3번</b></td>
						</tr>						
						<tr> 
							<td bgcolor="#F6CEEC"  width="8%">설정<b style="color:red">*</b></td>
							<td bgcolor="#FFFFFF">
								<input type="button" onclick="pop_multi3_manage();" value="설정">
							</td>
						</tr>										  	
					</table>
					</div>
			...
			<tr>
				<td valign="top">
					...
					<table width="100%" border="0" align="left" class="a" cellpadding="5" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>" id="evt_type1" style="display:">
						<tr>
							<td bgcolor="#FAECC5" colspan="2"><b>PC 이벤트 설정 정보</b></td>
						</tr>
						<tr id="pcevttype" style="display:">
					   		<td width="100"  bgcolor="#FAECC5">유형선택<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">
					   			<select name="pc_evttype" onchange="FnPCEventTypeChange(this.value);">
									<option value="10"<% If eventtype_pc="10" Then Response.write " selected" %>>A형(기본형)</option>
									<option value="20"<% If eventtype_pc="20" Then Response.write " selected" %>>B형(풀단형)</option>
									<option value="30"<% If eventtype_pc="30" Then Response.write " selected" %>>C형(브랜드배너형)</option>
									<option value="40"<% If eventtype_pc="40" Then Response.write " selected" %>>D형(풀단롤링형)</option>
									<option value="50"<% If eventtype_pc="50" Then Response.write " selected" %>>G형(커스텀형)</option>
									<option value="60"<% If eventtype_pc="60" Then Response.write " selected" %>>F형(상품배너형)</option>
									<option value="70"<% If eventtype_pc="70" Then Response.write " selected" %>>E형(와이드롤링형)</option>
									<option value="80"<% If eventtype_pc="80" Then Response.write " selected" %>>H형(MD등록형)</option>
								</select>
					   		</td>
						</tr>
						<tr>
						...
						<tr> 
							<td bgcolor="#FAECC5">이벤트명<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">
								<input type="text" name="title_pc" id="title_pc" size="70" maxlength="25" value="<%=title_pc%>">
					   		</td>
						</tr>
						<tr> 
							<td bgcolor="#FAECC5">서브카피<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">  
					   			<textarea name="subcopyK" id="subcopyK" style="width:100%; height:80px;" value="<%=subcopyK%>"><%=chkiif(subcopyK="","",subcopyK)%></textarea>
					...
					<% End If %>
					<% If eventtype_pc="80" Then %>
					<table width="100%" border="0" align="left" class="a" cellpadding="5" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>" id="evt_type2" style="display:">
						<tR>
							<td bgcolor="#FAECC5" colspan="2"><b>PC 이벤트 설정 정보</b></td>
						</tr>
						<tr id="pcevttype" style="display:">
							...
							<td bgcolor="#FAECC5">테마선택<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">
					   			<select name="mdtheme" class="select" onChange="TnSelectTheme(this.value)">
									...
									<option value="5" <% If mdtheme = "5" Then %>selected<% End If %>>상품 배너형 테마</option>
								</select>
					   		</td>
						</tr>
						<tr id="itemtypediv" style="display:<% If mdtheme<>"5" Then Response.write "none"%>">
					   		<td width="100"  bgcolor="#FAECC5">유형구분<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">
					   			<input type="radio" name="bannerTypeDiv" value="1"<%IF bannerTypeDiv="1" THEN%> checked<%END IF%>> 할인&nbsp;&nbsp;
					   			<input type="radio" name="bannerTypeDiv" value="2"<%IF bannerTypeDiv="2" THEN%> checked<%END IF%>> 쿠폰 <input type="text" name="bannerCouponTxt" value="<%=bannerCouponTxt%>" size="10">&nbsp;&nbsp;
					   			<input type="radio" name="bannerTypeDiv" value="3"<%IF bannerTypeDiv="3" THEN%> checked<%END IF%>> GIFT&nbsp;&nbsp;
								<input type="radio" name="bannerTypeDiv" value="4"<%IF bannerTypeDiv="4" THEN%> checked<%END IF%>> 무료배송&nbsp;&nbsp;
								<input type="radio" name="bannerTypeDiv" value="5"<%IF bannerTypeDiv="5" THEN%> checked<%END IF%>> 예약배송&nbsp;&nbsp;
								<input type="radio" name="bannerTypeDiv" value="6"<%IF bannerTypeDiv="6" THEN%> checked<%END IF%>> 1:1&nbsp;&nbsp;
								<input type="radio" name="bannerTypeDiv" value="7"<%IF bannerTypeDiv="7" THEN%> checked<%END IF%>> 1+1
					   		</td>
						</tr>
						<tr> 
							<td bgcolor="#FAECC5">이벤트명<b style="color:red">*</b></td>
						...
						<tr id="bannergubun" style="display:<% If mdtheme<>"5" Then Response.write "none"%>"> 
							<td bgcolor="#FAECC5">설명구분<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">
								<input type="radio" name="bannerGubun" value="1"<%IF bannerGubun="1" THEN%> checked<%END IF%> onclick="fnGiftItemChoice(1);"> 서브카피&nbsp;&nbsp;
					   			<input type="radio" name="bannerGubun" value="2"<%IF bannerGubun="2" THEN%> checked<%END IF%> onclick="fnGiftItemChoice(2);"> 사은품
					   		</td>
						</tr>
<script type="text/javascript">
<!--
	function fnGiftItemChoice(div){
		if(div==1)
		{
			$("#giftinfo2").hide();
			$("#giftinfo1").show();
			$("#gift_isusing2").attr("disabled","disabled");
			$("#gift_isusing1").removeAttr("disabled");
			$("#gift_text1_2").attr("disabled","disabled");
			$("#gift_text2_2").attr("disabled","disabled");
			$("#gift_text3_2").attr("disabled","disabled");
			$("#gift_text1_1").removeAttr("disabled");
			$("#gift_text2_1").removeAttr("disabled");
			$("#gift_text3_1").removeAttr("disabled");
		}
		else
		{
			$("#giftinfo2").show();
			$("#giftinfo1").hide();
			$("#gift_isusing1").attr("disabled","disabled");
			$("#gift_isusing2").removeAttr("disabled");
			$("#gift_text1_1").attr("disabled","disabled");
			$("#gift_text2_1").attr("disabled","disabled");
			$("#gift_text3_1").attr("disabled","disabled");
			$("#gift_text1_2").removeAttr("disabled");
			$("#gift_text2_2").removeAttr("disabled");
			$("#gift_text3_2").removeAttr("disabled");
		}
	}
//-->
</script>
						<tr id="giftinfo2" style="display:<% If bannerGubun<>"2" Then %>none<% End If %>"> 
							<td bgcolor="#FAECC5">사은품 정보<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">
								<table width="100%" border="0" align="left" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
									<tr>
										<td width="100"  bgcolor="<%= adminColor("tabletop") %>">사용여부<b style="color:red">*</b></td>
										<td bgcolor="#FFFFFF">
											<select name="gift_isusing" id="gift_isusing2"<%  if  bannerGubun="0"  or bannerGubun="1" then %> disabled="disabled"<% End If %> onchange="TnGiftUsingNum2(this.value);">
									...
									<tr style="display:" id="gifttxt1_2">
										<td width="100"  bgcolor="<%= adminColor("tabletop") %>">사은품1 내용</td>
										<td bgcolor="#FFFFFF">
											<input type="text" name="gift_text1" id="gift_text1_2"<%  if  bannerGubun="0"  or bannerGubun="1" then %> disabled="disabled"<% End If %> value="<%=gift_text1%>" size="100" maxlength="64">
										</td>
									</tr>
									<tr style="display:" id="giftimg1_2">
										<td width="100" bgcolor="<%= adminColor("tabletop") %>">사은품1 이미지</td>
										<td bgcolor="#FFFFFF">
											<input type="button" name="btnicon" value="이미지 등록" onClick="jsSetImg('<%=eFolder%>','<%=gift_img1%>','gift_img1','spangift_img12')" class="button">
											<div id="spangift_img12" style="padding: 5 5 5 5">
												<%IF gift_img1 <> "" THEN %>
												<a href="javascript:jsImgView('<%=gift_img1%>')"><img  src="<%=gift_img1%>" border="0"></a>
												<a href="javascript:jsDelImg('gift_img1','spangift_img12');"><img src="/images/icon_delete2.gif" border="0"></a>
												<%END IF%>
											</div>
										</td>
									</tr>
									<tr style="display:<% If gift_isusing<2 Then %>none<% End If %>" id="gifttxt2_2">
										<td width="100"  bgcolor="<%= adminColor("tabletop") %>">사은품2 내용</td>
										<td bgcolor="#FFFFFF">
											<input type="text" name="gift_text2" id="gift_text2_2"<%  if  bannerGubun="0"  or bannerGubun="1" then %> disabled="disabled"<% End If %> value="<%=gift_text2%>" size="100" maxlength="64">
										</td>
									</tr>
									<tr style="display:<% If gift_isusing<2 Then %>none<% End If %>" id="giftimg2_2">
										<td width="100" bgcolor="<%= adminColor("tabletop") %>">사은품2 이미지</td>
										<td bgcolor="#FFFFFF">
											<input type="button" name="btnicon" value="이미지 등록" onClick="jsSetImg('<%=eFolder%>','<%=gift_img2%>','gift_img2','spangift_img22')" class="button">
											<div id="spangift_img22" style="padding: 5 5 5 5">
												<%IF gift_img2 <> "" THEN %>
												<a href="javascript:jsImgView('<%=gift_img2%>')"><img  src="<%=gift_img2%>" border="0"></a>
												<a href="javascript:jsDelImg('gift_img2','spangift_img22');"><img src="/images/icon_delete2.gif" border="0"></a>
												<%END IF%>
											</div>
										</td>
									</tr>
									<tr style="display:<% If gift_isusing<3 Then %>none<% End If %>" id="gifttxt3_2">
										<td width="100"  bgcolor="<%= adminColor("tabletop") %>">사은품3 내용</td>
										<td bgcolor="#FFFFFF">
											<input type="text" name="gift_text3" id="gift_text3_2"<%  if  bannerGubun="0"  or bannerGubun="1" then %> disabled="disabled"<% End If %> value="<%=gift_text3%>" size="100" maxlength="64">
										</td>
									</tr>
									<tr style="display:<% If gift_isusing<3 Then %>none<% End If %>" id="giftimg3_2">
										<td width="100" bgcolor="<%= adminColor("tabletop") %>">사은품3 이미지</td>
										<td bgcolor="#FFFFFF">
											<input type="button" name="btnicon" value="이미지 등록" onClick="jsSetImg('<%=eFolder%>','<%=gift_img3%>','gift_img3','spangift_img32')" class="button">
											<div id="spangift_img32" style="padding: 5 5 5 5">
												<%IF gift_img3 <> "" THEN %>
												<a href="javascript:jsImgView('<%=gift_img3%>')"><img  src="<%=gift_img3%>" border="0"></a>
												<a href="javascript:jsDelImg('gift_img3','spangift_img32');"><img src="/images/icon_delete2.gif" border="0"></a>
												<%END IF%>
											</div>
										</td>
									</tr>
						...
						<tr id="themecolor" style="display:<% If mdtheme="5" Then Response.write "none"%>">
							...
							<td bgcolor="#FFFFFF">
								...
								<table id="colorselect2" style="display:<% If mdtheme="1" Then Response.write "none"%>">
									<tr>
										...
										<td><table id='clinet12' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="12" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(12)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_1.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet13' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="13" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(13)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_2.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet14' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="14" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(14)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_3.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet15' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="15" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(15)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_4.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet16' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="16" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(16)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_5.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet17' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="17" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(17)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_6.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet18' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="18" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(18)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_7.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet19' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="19" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(19)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_8.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet20' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="20" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(20)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_9.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet21' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="21" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(21)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_10.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet22' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="22" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(22)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_11.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet23' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="23" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(23)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_12.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet24' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="24" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(24)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_13.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet25' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="25" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(25)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_14.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet26' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="26" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(26)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_15.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td><table id='clinet27' border='0' cellpadding='0' cellspacing='1' bgcolor='<% If themecolor="27" Then %>#DD3300<% Else %>#dddddd<% End If %>'><tr><td bgcolor='#FFFFFF'><table border='0' cellpadding='0' cellspacing='2'><tr><td><a href='javascript:selColorChip2(27)' onfocus='this.blur()'><img src='http://webadmin.10x10.co.kr/images/event/img_grd_16.jpg' alt='주황' width='12' height='12' border='0'></a></td></tr></table></td></tr></table></td>
										<td>*선택하신 테마 정보로 배경과 기차 색상이 선택됩니다.</td>
									</tr>
								</table>
							</td>
						...
						<tr id="videopc" style="display:<% If mdtheme<>"4" Then Response.write "none"%>">
							<td bgcolor="#FAECC5">동영상</td>
					   		<td bgcolor="#FFFFFF">
							   	<input type="radio" name="videotype" value="1"<% if videoType="1" then response.write " checked"%>>16:9 (720*405) <input type="radio" name="videotype" value="2"<% if videoType="2" then response.write " checked"%>>4:3 (720*540) <input type="radio" name="videotype" value="3"<% if videoType="3" then response.write " checked"%>>1:1 (720*720) <input type="radio" name="videotype" value="0"<% if videoType="0" then response.write " checked"%>>동영상 제외<br>
								<textarea name="videoLinkPC" rows="2" cols="80"><%=videoLink%></textarea>
					   		</td>
						</tr>
						<tr id="bnimg" style="display:<% If mdtheme=1 Or mdtheme=0 Or mdtheme=5 Then %>none<% End If %>"> 
						...
						<tr id="BrandInfo" style="display:<% If mdtheme<>"4" Then Response.write "none"%>"> 
							<td bgcolor="#FAECC5">브랜드 정보</td>
					   		<td bgcolor="#FFFFFF">
								<table>
								<tr>
									<td>brandname : <input type="text" name="brandname" id="brandname" size="16" maxlength="16" value="<%=brandname%>">&nbsp;<input type="button" value="브랜드 정보가져오기" onClick="fnSSearchBrandPop(0);"></td>
								</tr>
								<tr>
									<td>designer comment : <textarea name="dgncomment" rows="15" style="width:100%;font-size:12px;font-family:'Malgun Gothic',dotum;"><%=dgncomment%></textarea></td>
								</tr>
								</table>
					   		</td>
						</tr>
						<tr id="TrainInfo" style="display:<% If mdtheme<>"4" Then Response.write "none"%>"> 
							<td bgcolor="#FAECC5">기차형 template 정보</td>
					   		<td bgcolor="#FFFFFF">
								<table>
								<tr>
									<td>등록 유형 : <input type="radio" name="GroupItemType" value="T"<% if GroupItemType="T" then response.write " checked" %> onclick="fnViewTempType('T');TnPriceViewCheck('Y');">아이템 선택 <input type="radio" name="GroupItemType" value="B"<% if GroupItemType="B" then response.write " checked" %> onclick="fnViewTempType('B');TnPriceViewCheck('N');">이미지업로드 <input type="button" value="설정" onClick="TnTrainThemeItemBannerReg();"></td>
								</tr>
								...
								<tr id="priceview" style="display:<% if GroupItemCheck="I" or GroupItemCheck="B" or GroupItemCheck="" then %><%else%>none<% end if %>">
								...
								<% If otrainitembanner.FresultCount > 0 And mdtheme="4" Then %>
								<table width="100%" border="0" cellpadding="5" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
								<tr align="center">
									<td bgcolor="<%= adminColor("tabletop") %>">순서</td>
									<td bgcolor="<%= adminColor("tabletop") %>">이미지</td>
									...
									<td bgcolor="<%= adminColor("tabletop") %>" id="grouptemp1" style="display:<% If GroupItemType="T" Then Response.write "none"%>">타이틀</td>
									<td bgcolor="<%= adminColor("tabletop") %>" id="grouptemp2" style="display:<% If GroupItemType="T" Then Response.write "none"%>">그룹코드</td>
									<td bgcolor="<%= adminColor("tabletop") %>" id="grouptemp6" style="display:<% If GroupItemType="T" or GroupItemCheck<>"B" Then Response.write "none"%>">브랜드</td>

									<td bgcolor="<%= adminColor("tabletop") %>" id="grouptemp3" style="display:<% If GroupItemType="B" Then Response.write "none"%>">상품명</td>
									<td bgcolor="<%= adminColor("tabletop") %>" id="grouptemp4" style="display:<% If GroupItemType="B" Then Response.write "none"%>">NEW/BEST</td>

									<td bgcolor="<%= adminColor("tabletop") %>">삭제</td>
								</tr>
								<% For i=0 To otrainitembanner.FresultCount-1 %>
								<input type="hidden" name="bidx" value="<%= otrainitembanner.FItemList(i).Fidx %>">
								<input type="hidden" name="imgurl" id="imgurl<%= otrainitembanner.FItemList(i).Fidx %>" value="<%= otrainitembanner.FItemList(i).Fimgurl %>">
								<tr>
									<td bgcolor="#FFFFFF"><input type="text" name="viewidx" size="5" maxlength="10" value="<%= otrainitembanner.FItemList(i).Fviewidx %>"></td>
									<td bgcolor="#FFFFFF"><a href="javascript:TnChangeThemeBannerEdit('<%=eFolder%>','<%= otrainitembanner.FItemList(i).Fimgurl %>','imgurl<%= otrainitembanner.FItemList(i).Fidx %>','vimg<%= otrainitembanner.FItemList(i).Fidx %>');"><span id="vimg<%= otrainitembanner.FItemList(i).Fidx %>"><% if otrainitembanner.FItemList(i).Fimgurl<>"" then %><img src="<%= otrainitembanner.FItemList(i).Fimgurl %>" width="100"><% else %><img src="<%= otrainitembanner.FItemList(i).Fbasicimage %>" width="100"><% end if %></span></a></td>
									<td bgcolor="#FFFFFF"><input type="text" name="itemid" id="itemid<%= otrainitembanner.FItemList(i).Fidx %>" size="16" maxlength="16" value="<%= otrainitembanner.FItemList(i).Fitemid %>" readOnly onClick="TnThemeBannerItemCodeEdit(<%= otrainitembanner.FItemList(i).Fidx %>);"></td>

									<td bgcolor="#FFFFFF" id="grouptemp1<%=i%>" style="display:<% If GroupItemType="T" Then Response.write "none"%>"><input type="text" name="title" id="title<%= otrainitembanner.FItemList(i).Fidx %>" size="35" maxlength="32" value="<%= otrainitembanner.FItemList(i).Ftitle %>"></td>
									<td bgcolor="#FFFFFF" id="grouptemp2<%=i%>" style="display:<% If GroupItemType="T" Then Response.write "none"%>"><input type="text" name="groupcode" id="groupcode<%= otrainitembanner.FItemList(i).Fidx %>" size="10" maxlength="10" value="<%= otrainitembanner.FItemList(i).Fgroupcode %>" onClick="TnThemeBannerGroupCodeEdit(<%= otrainitembanner.FItemList(i).Fidx %>);"></td>
									<td bgcolor="#FFFFFF" id="grouptemp6<%=i%>" style="display:<% If GroupItemType="T" or GroupItemCheck<>"B" Then Response.write "none"%>"><input type="text" name="brandid" id="brandid<%= otrainitembanner.FItemList(i).Fidx %>" size="10" maxlength="16" value="<%= otrainitembanner.FItemList(i).FBrandID %>" onClick="fnSSearchBrandPop(<%= otrainitembanner.FItemList(i).Fidx %>);"></td>									
									
									<td bgcolor="#FFFFFF" id="grouptemp3<%=i%>" style="display:<% If GroupItemType="B" Then Response.write "none"%>"><input type="text" name="itemname" id="itemname<%= otrainitembanner.FItemList(i).Fidx %>" value="<%= otrainitembanner.FItemList(i).Fitemname %>" size="50" maxlength="32"></td>
									<td bgcolor="#FFFFFF" id="grouptemp4<%=i%>" style="display:<% If GroupItemType="B" Then Response.write "none"%>">NEW : <select name="iconnew"><option value="N"<% if otrainitembanner.FItemList(i).Ficonnew="N" then response.write " selected" %>>N</option><option value="Y"<% if otrainitembanner.FItemList(i).Ficonnew="Y" then response.write " selected" %>>Y</option></select><br>
									BEST : <select name="iconbest"><option value="N"<% if otrainitembanner.FItemList(i).Ficonbest="N" then response.write " selected" %>>N</option><option value="Y"<% if otrainitembanner.FItemList(i).Ficonbest="Y" then response.write " selected" %>>Y</option></select></td>
									
									<td bgcolor="#FFFFFF"><a href="javascript:TnTrainThemeItemBannerDel(<%= otrainitembanner.FItemList(i).Fidx %>);">삭제</a></td>
								</tr>
								<% Next %>
								</table>
								<% End If %>
			...
			<tr>
				<td valign="top">
					...
					<table width="100%" border="0" align="left" class="a" cellpadding="5" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>" id="evt_type3" style="display:">
						<tR>
							<td bgcolor="#e3f1fb"  colspan="2"><b>Mobile 이벤트 설정 정보</b></td>
						</tr>
						<tr id="moevttype" style="display:">
					   		<td width="100"  bgcolor="#e3f1fb">유형선택<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">
					   			<select name="mo_evttype" onchange="FnMEventTypeChange(this.value);">
									<option value="10"<% If eventtype_mo="10" Then Response.write " selected" %>>A형(기본형)</option>
									<option value="20"<% If eventtype_mo="20" Then Response.write " selected" %>>B형(풀단형)</option>
									<option value="30"<% If eventtype_mo="30" Then Response.write " selected" %>>C형(브랜드배너형)</option>
									<option value="40"<% If eventtype_mo="40" Then Response.write " selected" %>>D형(풀단롤링형)</option>
									<option value="50"<% If eventtype_mo="50" Then Response.write " selected" %>>G형(커스텀형)</option>
									<option value="60"<% If eventtype_mo="60" Then Response.write " selected" %>>F형(상품배너형)</option>
									<option value="70"<% If eventtype_mo="70" Then Response.write " selected" %>>E형(와이드롤링형)</option>
									<option value="80"<% If eventtype_mo="80" Then Response.write " selected" %>>H형(MD등록형)</option>
									<option value="90"<% If eventtype_mo="90" Then Response.write " selected" %>>Multi3형</option>
								</select>
					   		</td>
						</tr>
						<tr>
						...
						<tr id="mevtname" style="display:<% If mdthememo="5" Then Response.write "none"%>">
							<td bgcolor="#e3f1fb">이벤트명<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">
								<input type="text" name="title_mo" id="title_mo" size="70" maxlength="25" value="<%=title_mo%>">
					   		 </td>
					   	</tr>
						<tr>
							<td bgcolor="#e3f1fb">서브카피<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF"> <input type="text" name="subsEN" id="subsEN" size="70" maxlength="140" value="<%=enamesub%>"  OnKeyUp="jsAddByte(this);"> 
					...
					<% End If %>
					<% If eventtype_mo="80" Then %>
					<table width="100%" border="0" align="left" class="a" cellpadding="5" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>" id="evt_type4" style="display:">
						<tR>
							<td bgcolor="#e3f1fb"  colspan="2"><b>Mobile 이벤트 설정 정보</b></td>
						</tr>
						<tr id="moevttype" style="display:">
						...
						<tr>
							...
							<td bgcolor="#FFFFFF">
								<select name="mdthememo" class="select" onChange="TnSelectThemeMo(this.value)">
									...
									<option value="5" <% If mdthememo = "5" Then %>selected<% End If %>>상품 배너형 테마</option>
								</select>
							</td>
						</tr>
						<tr id="mitemlistdiv" style="display:<% If mdthememo="5" Then Response.write "none"%>">
							<td  bgcolor="#e3f1fb">리스트 구성<b style="color:red">*</b></td>
							<td bgcolor="#FFFFFF">
								<input type="radio" name="itemlisttype"  value="1"  <%IF eItemListType = "1" THEN%>checked<%END IF%>> 격자형&nbsp;&nbsp;
								<input type="radio" name="itemlisttype"  value="2"  <%IF eItemListType = "2" THEN%>checked<%END IF%>> 리스트형&nbsp;&nbsp;
						...
						<tr id="mibdiv" style="display:<% If mdthememo<>"5" Then Response.write "none"%>">
							<td  bgcolor="#e3f1fb">유형구분<b style="color:red">*</b></td>
							<td bgcolor="#FFFFFF">
								<input type="radio" name="ietag" value="7" <%=chkiif(tmpietag="7","checked","")%> onclick="jstagchk(this.value);"/> 할인 <input type="radio" name="ietag" value="2" <%=chkiif(tmpietag="2","checked","")%> onclick="jstagchk(this.value);"/> 쿠폰 <input type="text" size="5" name="ietagval" value="<%=tmpietagval%>" <%=chkiif(tmpietag="7" Or tmpietag = "2" ,"","readOnly")%> class="text_ro"/> <input type="radio" name="ietag" value="1" <%=chkiif(tmpietag="1","checked","")%> onclick="jstagchk(this.value);"/> GiFT <input type="radio" name="ietag" value="4" <%=chkiif(tmpietag="4","checked","")%> onclick="jstagchk(this.value);"/> 무료배송 <input type="radio" name="ietag" value="5" <%=chkiif(tmpietag="5","checked","")%> onclick="jstagchk(this.value);"/> 1:1 <input type="radio" name="ietag" value="6" <%=chkiif(tmpietag="6","checked","")%> onclick="jstagchk(this.value);"/> 1+1 <input type="radio" name="ietag" value="3" <%=chkiif(tmpietag="3","checked","")%> onclick="jstagchk(this.value);"/> 예약배송
							</td>
						</tr>
						...
						<tr id="mibevtname" style="display:<% If mdthememo<>"5" Then Response.write "none"%>">
							<td bgcolor="#e3f1fb">이벤트 카피<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">
								<input type="text" size="70" name="mcopy" maxlength="40" value="<%=tmpmcopy%>"/><div style="color:#602030;font-size:11px;padding-top:5px;">( ex: 오늘 단 하루, UDH-02 전기렌지 증정! )</div>
					   		 </td>
					   	</tr>
						<tr id="mevtsubcopy" style="display:<% If mdthememo="5" Then Response.write "none"%>">
							<td bgcolor="#e3f1fb">서브 카피<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF"> <input type="text" name="subsEN" id="subsEN" size="70" maxlength="70" value="<%=enamesub%>"  OnKeyUp="jsAddByte(this);"> 
					   		    <input type="text" name="subSize" size="3" value="" class="text_ro" style="text-align:right" readonly>Byte
					   		     <p style="color:#602030;font-size:11px;"> [ 최대 70byte까지 등록가능합니다. ]</p>
					   		    <script type="text/javascript">
					   		        jsAddByte(frmEvt.subsEN);
						...
						<tr id="mibevtsubcopy" style="display:<% If mdthememo<>"5" Then Response.write "none"%>">
							<td bgcolor="#e3f1fb">서브카피<b style="color:red">*</b></td>
					   		<td bgcolor="#FFFFFF">
					   		    <input type="text" size="70" name="scopy" maxlength="140" value="<%=tmpscopy%>"/><div style="color:#602030;font-size:11px;padding-top:5px;">( ex: 선착순 100명/ 소진 시 조기종료 )</div>
								<input type="hidden" name="eventview_mo" value="9">
					   		 </td>
					   	</tr>
						<tr id="mcolorselect3" style="display:<% If mdthememo="5" Then Response.write "none"%>">
						...
						<tr id="videomo" style="display:<% If mdthememo<>"2" Then Response.write "none"%>"> 
							<td bgcolor="#e3f1fb">동영상</td>
					   		<td bgcolor="#FFFFFF">
								<input type="text" name="videoLink" id="videoLink" size="70" maxlength="256" value="<%=videoLink%>">
					   		</td>
						</tr>
						<tr id="bnimgmo" style="display:<% If mdthememo=1 Or mdthememo=0 Or mdthememo=5 Then %>none<% End If %>">
					...
					<script type="text/javascript">
						var CAL_Start = new Calendar({
							...
							onSelect: function() {
								...
								CAL_End.redraw();
								this.hide();
							}, bottomBar: true, dateFormat: "%Y-%m-%d" <%=chkIIF(comm_end<>"",", max: " & replace(null2blank(comm_end),"-",""),"")%>
						});
						var CAL_End = new Calendar({
							...
							onSelect: function() {
								...
								CAL_Start.redraw();
								this.hide();
							}, bottomBar: true, dateFormat: "%Y-%m-%d" <%=chkIIF(comm_end<>"",", min: " & replace(null2blank(comm_start),"-",""),"")%>
						});
					</script>
		   		<%END IF%>
				</td>
...
<tr id="giftinfo1" style="display:<% If bannerGubun="2" Then %>none<% End If %>">
	<td>
		<table width="100%" border="0" align="left" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
			<tr>
		   		<td align="left" colspan="2" bgcolor="<%= adminColor("tabletop") %>"><B>사은품 텍스트 박스 정보</B></td>
		   	</tr>
			<tr>
				<td width="100"  bgcolor="<%= adminColor("tabletop") %>">사용여부<b style="color:red">*</b></td>
				<td bgcolor="#FFFFFF">
					<select name="gift_isusing" id="gift_isusing1"<% If bannerGubun="2" Then %> disabled="disabled"<% End If %> onchange="TnGiftUsingNum(this.value);">
						<option value="1"<% If gift_isusing=1 Then %> selected<% End If %>>1개 사용</option>
						<option value="2"<% If gift_isusing=2 Then %> selected<% End If %>>2개 사용</option>
						<option value="3"<% If gift_isusing=3 Then %> selected<% End If %>>3개 사용</option>
			...
			<tr style="display:" id="gifttxt1">
				<td width="100"  bgcolor="<%= adminColor("tabletop") %>">사은품1 내용</td>
				<td bgcolor="#FFFFFF">
					<input type="text" name="gift_text1" id="gift_text1_1"<% If bannerGubun="2" Then %> disabled="disabled"<% End If %> value="<%=gift_text1%>" size="100" maxlength="64">
				</td>
			</tr>
			...
			<tr style="display:<% If gift_isusing<2 Then %>none<% End If %>" id="gifttxt2">
				<td width="100"  bgcolor="<%= adminColor("tabletop") %>">사은품2 내용</td>
				<td bgcolor="#FFFFFF">
					<input type="text" name="gift_text2" id="gift_text2_1"<% If bannerGubun="2" Then %> disabled="disabled"<% End If %> value="<%=gift_text2%>" size="100" maxlength="64">
				</td>
			</tr>
			...
			<tr style="display:<% If gift_isusing<3 Then %>none<% End If %>" id="gifttxt3">
				<td width="100"  bgcolor="<%= adminColor("tabletop") %>">사은품3 내용</td>
				<td bgcolor="#FFFFFF">
					<input type="text" name="gift_text3" id="gift_text3_1"<% If bannerGubun="2" Then %> disabled="disabled"<% End If %> value="<%=gift_text3%>" size="100" maxlength="64">
				</td>
			</tr>
	...
	<td>
		<table width="100%" border="0" align="left" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
			...
			<tr style="display:" id="usingtxt1">
				...
				<td bgcolor="#FFFFFF">
					<input type="text" name="using_text1" value="<%=using_text1%>" size="40" maxlength="32">
				</td>
			</tr>
			...
			<tr style="display:<% If usinginfo<2 Then %>none<% End If %>" id="usingtxt2">
				...
				<td bgcolor="#FFFFFF">
					<input type="text" name="using_text2" value="<%=using_text2%>" size="40" maxlength="32">
				</td>
			</tr>
			...
			<tr style="display:<% If usinginfo<3 Then %>none<% End If %>" id="usingtxt3">
				...
				<td bgcolor="#FFFFFF">
					<input type="text" name="using_text3" value="<%=using_text3%>" size="40" maxlength="32">
				</td>
			</tr>
