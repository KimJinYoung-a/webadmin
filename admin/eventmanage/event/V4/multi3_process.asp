...
unit_main_copy		= request("unit_main_copy")
unit_main_content	= request("unit_main_content")
...
Select Case mode
	...
	'유닛 수정
		...
		for i = 1 to Ubound(unitIdxArr) + 1
			...
			sqlStr = sqlStr + " 	,unit_main_copy ='" & html2db(request("unit_main_copy")(i)) & "'" & vbcrlf
			sqlStr = sqlStr + " 	,unit_main_content ='" & html2db(request("unit_main_content")(i)) & "'" 	& vbcrlf			
