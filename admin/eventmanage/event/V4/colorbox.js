...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	function ShowColorBox(posX, posY){
		if (ColorBox.style.visibility != 'visible'){
			ColorBox.innerHTML = tagColor();
	...
	function tagColor(){
		...
		var strHTML = "";
			...
			for (var i=0; i<11; i++){
				...
				for(var j=0; j<10; j++){
					strHTML = strHTML + "<td onmouseover=this.style.backgroundColor='blue' onmouseout=this.style.backgroundColor='' class='hand' title='" + colortone[i][j] + "'><table cellpadding=0 cellspacing=1 border=0><tr><td bgcolor='" + colortone[i][j] + "' onclick='changeColor(\"" + colortone[i][j] + "\");' width=10 height=10></td></tr></table></td>";
				}   
				strHTML = strHTML + "</tr>";
			}
	...
	function changeColor(opt){
		...
		ColorBox.style.visibility = 'hidden';
		frm.prvColor.style.backgroundColor = opt;
		frm.main_color.value=opt;
	}	
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++