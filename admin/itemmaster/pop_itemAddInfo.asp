...
dim reAct, ptype
dim page, paraRoad , sCode, notdeal, groupId, pageSize

actionURL 	= Replace(ReplaceRequestSpecialChar(request("acURL")),"||","&")

itemid      = requestCheckvar(request("itemid"),1800)	'200 개 상품 검색(7byte+cr+lf)
...
pageSize = requestCheckvar(request("pgSize"),3)
	...
	<tr align="center" bgcolor="<%= adminColor("topbar") %>" >
		<td align="left">
			...
			<tr>
				...
				<td style="white-space:nowrap;padding:0 10px 0 5ox;">그룹코드: <input type="text" class="text" name="groupId" value="<%= groupId %>" size="8" maxlength="8"></td>
				<td style="white-space:nowrap;padding-left:5px;">상품코드:</td>
				<td style="white-space:nowrap;" rowspan="3"><textarea rows="4" cols="10" name="itemid" id="itemid"><%=replace(itemid,",",chr(10))%></textarea> </td>
			</tr>
			<tr>
				<td style="white-space:nowrap;" colspan="3">상품명: <input type="text" class="text" name="itemname" value="<%= itemname %>" size="32" maxlength="20"></td>
			</tr>
			<tr>
				<td style="white-space:nowrap;" colspan="3">관리<!-- #include virtual="/common/module/categoryselectbox.asp"--></td>
			</tr>
			<tr>
				<td style="white-space:nowrap;" colspan="4">전시 카테고리 : <!-- #include virtual="/common/module/dispCateSelectBox.asp"--></td>
			</tr>
			<tr>
				<td colspan="3">검색키워드 : <input type="text" class="text" name="keyword" value="<%=keyword%>" size="40"><font color="gray" size="2">(주의:느릴수있습니다.)</font></td>
			</tr>
	 	</table>
		</td>
...
<table width="100%" height="40" align="center" cellpadding="3" cellspacing="1" class="a" border="0">
	<tr>
		...
		<td valign="bottom" align="right">
			<select name="pgSize" class="select">
			<option value="30" <%=chkIIF(pageSize=30,"selected","")%>>30</option>
