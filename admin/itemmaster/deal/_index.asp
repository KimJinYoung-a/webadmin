...
<table width="100%" border="0" align="center" class="a" cellpadding="3" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="<%= adminColor("tabletop") %>">
	 ...
	 <% End If %>
		...
		<td align="center">
			<input type="button" class="button" style="width:105;" value="수정" onclick="TnEditDeal('/admin/itemmaster/deal/deal_edit.asp?idx=<%= arrList(0,intLoop) %>');"<% if arrList(14,intLoop)="0" then %> disabled<% End If %>>
			<!-- <input type="button" class="button" style="width:105;" value="삭제" onclick="TnDelMail(<%= arrList(0,intLoop) %>);"> -->
		</td>
	 </tr>
	 <% Next %>
	 <% Else %>
