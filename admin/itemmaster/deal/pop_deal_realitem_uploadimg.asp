...
<form name="frmImg" method="post" action="<%= uploadImgUrl %>/linkweb/event_admin/V2/deal_upload_new.asp" enctype="MULTIPART/FORM-DATA" onSubmit="return jsUpload();">
