...
//자금구분 부서 등록
function jsSetPartMoney2(iType, sAUCD,sACCGRP){
	var winPart = window.open("/admin/approval/eapp/epop/popGetBiz.asp?iType="+iType+"&sAUCD="+sAUCD+"&sACCGRP="+sACCGRP,"popPart","width=400, height=600, resizable=yes, scrollbars=yes");
	winPart.focus();
}
//수지항목 불러오기
function jsGetARAP2(){
			...
			<td>
				...
				<tr>
					<td>
						...
						<tr bgcolor="#FFFFFF" align="center">
							...
							<td><input type="text" class="text" name="mRP" size="15" maxlength="20" style="text-align:right;" value="<%=mReportPrice%>"   onKeypress="num_check()" onkeyup="auto_amount(this.form,this)" onblur="jsIsHundred();"></td>
							<td>
				...
				<tr>
					<td>
						...
						<tr bgcolor="#FFFFFF">
        					<td colspan="3"><input type="button" class="button" value="수지항목 수정" onClick="jsGetARAP2();"></td>
        				</tr>
						</table>
					</td>
				</tr>  
				...
				<tr>
					<td>
						...
						<tr>
							...
							&nbsp;<input type="button" value="부서등록" onClick="jsSetPartMoney2(1,'<%=sacc_use_cd%>','<%=sACC_GRP_CD%>');" class="button" ><Br><Br>
							</td>
						</tr>
						</table>
					</td>
