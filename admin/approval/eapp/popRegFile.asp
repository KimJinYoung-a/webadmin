...
<form name="frmImg" method="post" action="<%=uploadImgUrl%>/linkweb/eapp/procUpload.asp"  enctype="MULTIPART/FORM-DATA">
	...
	<tr>
		<td>	
			<div style="font-size:11px;">- 지원되는 파일포맷: XLS,PPT,DOC,RTF,XLSX,PPTX,DOCX<br>
				&nbsp;&nbsp;&nbsp;,HWP,PDF,TXT,ZIP,RAR,7Z,CAB,ALZ,JPG,JPEG,GIF,XML  </div>
