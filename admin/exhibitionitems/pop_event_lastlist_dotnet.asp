...
<!--
	...
	//부모창에 값 넘기기
	function jsSetEvtCont(cd){
		document.domain = '10x10.co.kr';

		if (opener['setEventCodeFromEventList'] != null && opener['setEventCodeFromEventList'] != undefined) {
			opener['setEventCodeFromEventList'](cd);
		}
...
<form name="frmLast" method="post" action="pop_event_lastlist_dotnet.asp" onSubmit="return jsSearch();">
