...
frm.sType.value = sType;   //전체선택 or 선택상품 여부 구분
	...
	frm.target = "FrameCKP";
	frm.action = "/admin/exhibitionitems/lib/exhibition_items_proc.asp";
...
$(function(){ // detail options
	$("select[name='detailcode']").change(function(){
		document.frmItem.detailcode.value = $(this).val();
	});
});
//-->
</script>
		...
		<table class="tbType1 listTb">
			<tr bgcolor="<%= adminColor("topbar") %>" >
				<td  style="text-align:left;">
					...
					<tr>
						<td colspan="4"  style="text-align:left;">검색키워드 : <input type="text" class="text" name="keyword" value="<%=keyword%>" size="40"><font color="gray" size="2">(주의:느릴수있습니다.)</font></td>
					</tr>
				</table>
				</td>
			...
			<tr bgcolor="<%= adminColor("topbar") %>" >
				<td>
					<div style="float:left;">
						<table cellpadding="3" cellspacing="1" class="a" border="0">
							<tr align="center" bgcolor="<%= adminColor("topbar") %>">
								<td colspan="2" style="color:red">※ 기획전을 선택 해주세요! (필수) ※</td>
							</tr>
							<tr align="center" bgcolor="<%= adminColor("topbar") %>">
								<td>구분 선택</td>
								<td>
									<% DrawMainPosCodeCombo "mastercode", mastercode , "onchange='jsSerach();'" %>
					...
					<div style="float:right;text-align:left;">
						...
						한정:<% drawSelectBoxLimitYN "limityn", limityn %><br>
						...
						배송:<% drawBeadalDiv "deliverytype",deliverytype %><br>
