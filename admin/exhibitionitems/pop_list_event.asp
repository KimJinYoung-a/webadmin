...
set oExhibition = new ExhibitionCls
    ...
    oExhibition.FRectEventKind = sKind
	oExhibition.getEventList
...
<script type="text/javascript">
    function AddNewMainContents(idx,mastercode){
        var popwin = window.open('/admin/exhibitionitems/pop_reg_event.asp?idx='+idx+'&mastercode='+mastercode,'mainposcodeedit','width=800,height=600,scrollbars=yes,resizable=yes');
        popwin.focus();
    }
                ...
                <table class="tbType1 listTb">
                    <tr>
                        ...
                        <td style="text-align:left;">
                            ...
                            &nbsp;&nbsp;&nbsp;
                            종류: <%sbGetOptEventCodeValue "eventkind",sKind,True,"onChange=""document.frm.submit();"""%>&nbsp;&nbsp;&nbsp;
		...
		<div class="tPad15">
            <table class="tbType1 listTb">
                ...
                <tr bgcolor="<%=chkiif((oExhibition.FItemList(i).IsEndDateExpired) or (oExhibition.FItemList(i).FIsusing="0"),"#DDDDDD","#FFFFFF")%>">
                    ...
                    <td>
                        [<a href="http://www.10x10.co.kr/event/eventmain.asp?eventid=<%= oExhibition.FItemList(i).FEvt_Code %>" target="_blank"><%= oExhibition.FItemList(i).FEvt_Code %></a>] <%= oExhibition.FItemList(i).Fevt_name %><br/><br/>
                    ...
                    <td>
                        <% if oExhibition.FItemList(i).FbannerImage <> "" then %>
                            <img src="<%= oExhibition.FItemList(i).FbannerImage %>" border="0" width="100">
                        <% else %>
                    ...
                    <td>
                        ...
                        <span style="color:red">이벤트 시작일 : <%= oExhibition.FItemList(i).Fevt_StartDate %></span>
                    </td>
                    <td>
                        <%= oExhibition.FItemList(i).FEndDate %><br/><br/>
                        <span style="color:red">이벤트 종료일 : <%= oExhibition.FItemList(i).Fevt_EndDate %></span>
                    </td>
