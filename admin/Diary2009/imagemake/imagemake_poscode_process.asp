...
sqlStr = "select top 1 poscode,posname,imagetype,imagewidth,imageheight,isusing,imagecount from db_diary2010.dbo.tbl_diary_poscode"
...
if (ItemExists) then
    sqlStr = " update db_diary2010.dbo.tbl_diary_poscode" + VbCrlf
    ...
    sqlStr = " insert into db_diary2010.dbo.tbl_diary_poscode" + VbCrlf
