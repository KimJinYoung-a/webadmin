...
dim objCon,intLoop
set objCon = new DiaryCls
objCon.FYearUse = YearUse
objCon.getDiaryContens diaryid
...
<!-- 이미지 등록 -->
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="a" bgcolor="#9d9d9d">
	<form name="regfrm" method="post" action="proc_diary_cont.asp">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td>
			<input type="button" class="button" size="30" value="이미지 넣기" onclick="jsImgInput('contimg','contImgName','cont','200000','1500','false');"/>
