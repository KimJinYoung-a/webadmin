...
dim oMainContents
	...
	oMainContents.GetMainGatherEventList
%>
<script type="text/javascript">
<!--
function AddNewMainContents(idx){
    var popwin = window.open('/admin/sitemaster/lib/popmaingathereventedit.asp?idx=' + idx+'&<%=strParm%>','mainposcodeedit','width=800,height=600,scrollbars=yes,resizable=yes');
    popwin.focus();
}
//-->
</script>
...
<% end if %>
    ...
    <td align="center">
	[<%= oMainContents.FItemList(i).FEvt_Code1 %>] <%= oMainContents.FItemList(i).FEvt_Title1 %><br>
	[<%= oMainContents.FItemList(i).FEvt_Code2 %>] <%= oMainContents.FItemList(i).FEvt_Title2 %><br>
	[<%= oMainContents.FItemList(i).FEvt_Code3 %>] <%= oMainContents.FItemList(i).FEvt_Title3 %>
	</td>
    <td align="center">
