...
orderbynum= request.Form("orderbynum")

dim sqlStr, ItemExists

sqlStr = "select top 1 * from [db_sitemaster].[dbo].tbl_main_contents_poscode"
...
if (ItemExists) then
    sqlStr = " update [db_sitemaster].[dbo].tbl_main_contents_poscode" + VbCrlf
    ...
    sqlStr = sqlStr + " ,orderbynum='" + orderbynum + "'" + VbCrlf
    sqlStr = sqlStr + " where poscode=" + CStr(poscode) + VbCrlf
    
    dbget.Execute sqlStr
else
    sqlStr = " insert into [db_sitemaster].[dbo].tbl_main_contents_poscode" + VbCrlf
    sqlStr = sqlStr + " (poscode,posname,posVarname,linktype,fixtype,imagewidth,imageheight,useSet,isusing,gubun,orderbynum)"+ VbCrlf
    ...
    sqlStr = sqlStr + " ,'" + orderbynum + "'" + VbCrlf
