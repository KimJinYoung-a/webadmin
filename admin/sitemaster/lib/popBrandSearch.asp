...
function selectThis(makerid, dgncomment, brandimage){
    opener.<%= frmName %>.BrandID.value = makerid;
    opener.<%= frmName %>.MainCopy.value = dgncomment;
    if (brandimage!="http://testimgstatic.10x10.co.kr/brandstreet/main/"){
        opener.<%= frmName %>.Main_Image.value = brandimage;
...
<table width="100%" border="0" align="center" class="a" cellpadding="2" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
	...
	<% end if %>
		...
		<td><a href="javascript:selectThis('<%= opartner.FPartnerList(i).Fid %>','<%= opartner.FPartnerList(i).Fdgncomment %>','<%= opartner.FPartnerList(i).Fbrandimage %>')"><%= opartner.FPartnerList(i).FID %></a></td>
		<td>
			<%= opartner.FPartnerList(i).FSocName_Kor %><br>
			<%= opartner.FPartnerList(i).FSocName %>
		</td>
		<td><a href="javascript:selectThis('<%= opartner.FPartnerList(i).Fid %>','<%= opartner.FPartnerList(i).Fdgncomment %>','<%= opartner.FPartnerList(i).Fbrandimage %>')"><%= opartner.FPartnerList(i).Fcompany_name %></a></td>
