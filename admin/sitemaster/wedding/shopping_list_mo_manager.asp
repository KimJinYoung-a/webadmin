...
dim oPlanEvent
	...
	oPlanEvent.GetShoppingListMo
%>
<script type="text/javascript">
<!--
function AddNewMainContents(idx){
    var popwin = window.open('/admin/sitemaster/wedding/popWeddingShoppingListMoedit.asp?idx=' + idx+'&<%=strParm%>','mainposcodeedit','width=800,height=600,scrollbars=yes,resizable=yes');
    popwin.focus();
}
...
<tr bgcolor="#FFFFFF">
	...
	<%= oPlanEvent.FItemList(i).GetDDayTitleMo %>
	</td>
    <td align="center" onClick="AddNewMainContents('<%= oPlanEvent.FItemList(i).FWeddingStepID %>');"  style="cursor:pointer;">
