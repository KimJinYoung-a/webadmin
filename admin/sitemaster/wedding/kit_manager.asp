...
dim oPlanEvent
	...
	oPlanEvent.GetWeddingKitList
%>
<script type="text/javascript">
<!--
function AddNewMainContents(idx){
    var popwin = window.open('/admin/sitemaster/wedding/popWeddingKitedit.asp?idx=' + idx,'mainposcodeedit','width=800,height=600,scrollbars=yes,resizable=yes');
    popwin.focus();
}
...
<tr bgcolor="#FFFFFF">
	...
	<%= oPlanEvent.FItemList(i).Fitemname %>
	</td>
    <td align="center" onClick="AddNewMainContents('<%= oPlanEvent.FItemList(i).FIdx %>');"  style="cursor:pointer;">
