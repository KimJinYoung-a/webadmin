...
<%
Dim idx, Evt_Code, Evt_Title, Evt_Discount, Evt_Subcopy, Evt_Coupon
Dim StartDate, EndDate, DispOrder, Isusing, mode, weddingban, Evt_Img
	...
	weddingban = requestCheckVar(request("weddingban"),128)
...
If Evt_Code <> "" And weddingban="" Then
...
if (mode = "add") then
    ...
    sqlStr = " insert into [db_sitemaster].[dbo].[tbl_wedding_plan_event]" + VbCrlf
	...
	sqlStr = "select IDENT_CURRENT('[db_sitemaster].[dbo].[tbl_wedding_plan_event]') as idx"
	rsget.Open sqlStr, dbget, 1
...
elseif mode = "edit" then
   sqlStr = " update [db_sitemaster].[dbo].[tbl_wedding_plan_event]" + VbCrlf
