...
<form name="frmFile" method="post" action="/admin/sitemaster/adver/procFileUpload.asp"  enctype="MULTIPART/FORM-DATA">
...
<tr align="center" bgcolor="#FFFFFF">
	...
	<td align="left">
		...
		&nbsp;&nbsp;&nbsp;<a href="/admin/sitemaster/adver/testsample.xls"><font color="BLUE"><strong>샘플다운</strong></font></a><br>
		1.엑셀은 <font color="red">97-2003 통합문서</font>여야 하고, <font color="red">첫라인</font>은 고정.<br>
		2.샘플 형식과 동일해야 하며, <font color="red">셀서식</font> 바꾸지 말 것(모든 셀 <font color="red">텍스트</font>)<br>
	</td>
</tr>
<tr align="center" bgcolor="#FFFFFF">
