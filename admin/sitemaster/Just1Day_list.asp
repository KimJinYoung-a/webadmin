...
%>
<tr bgcolor="#FFFFFF">
	<td align="center"><a href="Just1Day_write.asp?mode=edit&menupos=<%= menupos %>&justdate=<%= oJust.FItemList(i).FjustDate %>&itemid=<%= oJust.FItemList(i).Fitemid %>"><%= oJust.FItemList(i).FjustDate %></a></td>
	<td align="center"><a href="Just1Day_write.asp?mode=edit&menupos=<%= menupos %>&justdate=<%= oJust.FItemList(i).FjustDate %>&itemid=<%= oJust.FItemList(i).Fitemid %>"><img src="<%= oJust.FItemList(i).FsmallImage %>" width="50" height="50" border="0"></a></td>
