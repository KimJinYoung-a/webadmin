...
<%
Dim sImg, sName,sSpan, slen, arrImg, sImgName, vYear, vType, vFolder
...
<form name="frmImg" method="post" action="<%= uploadImgUrl %>/linkweb/play/play_mo_upload.asp" enctype="MULTIPART/FORM-DATA" onSubmit="return jsUpload();">
