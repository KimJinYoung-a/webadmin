...
dim oMainContents
	...
	oMainContents.GetMainContentsList2
...
<% end if %>
	...
	%>
    	<a href="javascript:AddNewMainContents('<%= oMainContents.FItemList(i).Fidx %>');"><img src="<%= oMainContents.FItemList(i).GetImageUrlCulture %>" border="0" width=160 height=238 alt="<%= oMainContents.FItemList(i).Faltname %>"></a>
    <%		Else %>
