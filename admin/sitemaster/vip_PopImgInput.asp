...
<%
'###########################################################
' Description : 우수회원코너 이미지
' Hieditor : 2015.04.20 원승현 생성
'###########################################################
%>
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="a" bgcolor="#9d9d9d">
	<form name="regfrm" method="post" target="prcframe" action="<%=uploadImgUrl%>/linkweb/vipcorner/vip_image.asp" enctype="multipart/form-data">	
