...
'###############################################
' PageName : index.asp
' Discription : 모바일 메인 라운드배너
' History : 2018.12.24 최종원
'###############################################
...
function jsmodify(v, addtype){
	location.href = "roundbanner_insert.asp?menupos=<%=menupos%>&idx="+v+"&prevDate=<%=sDt%>&indexparam=1";
}
$(function() {
...
function addContent(){
	...
	dateOptionParam = document.frm.prevDate.value

	document.location.href= "roundbanner_insert.asp?menupos=<%=menupos%>&prevDate=<%=sDt%>&dispOption="+contentType+"&dateoption="+dateOptionParam;	
}
-->

function popTodayEasyReg(){
    let popTodayEasyReg = window.open('/admin/mobile/popTodayEasyReg.asp?type=round','mainposcodeedit','width=800,height=400,scrollbars=yes,resizable=yes');
