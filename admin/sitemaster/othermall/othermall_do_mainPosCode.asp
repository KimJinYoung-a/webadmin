...
sqlStr = "select top 1 * from [db_contents].[dbo].tbl_othermall_main_contents_poscode"
...
if (ItemExists) then
    sqlStr = " update [db_contents].[dbo].tbl_othermall_main_contents_poscode" + VbCrlf
    ...
    sqlStr = " insert into [db_contents].[dbo].tbl_othermall_main_contents_poscode" + VbCrlf
