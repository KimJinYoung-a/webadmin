...
if Scnt>0 then
    sqlStr = " insert into db_sitemaster.dbo.tbl_sbsvshop_items" + VbCrlf
    ...
    sqlStr = sqlStr + " 		from db_sitemaster.dbo.tbl_sbsvshop_items" + VbCrlf
...
'	Response.end
	...
	'// 페이지정보 최종 수정자 업데이트
	sqlStr = "Update [db_sitemaster].[dbo].tbl_sbsvshop_list " + VbCrlf
