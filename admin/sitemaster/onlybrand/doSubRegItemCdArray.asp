...
if Scnt>0 then
    sqlStr = " insert into [db_sitemaster].[dbo].tbl_pc_main_onlybrand_item" + VbCrlf
    sqlStr = sqlStr + " (listidx, itemid, isusing, orderby ) " + VbCrlf
    ...
    sqlStr = sqlStr + " 		from [db_sitemaster].[dbo].tbl_pc_main_onlybrand_item" + VbCrlf
