...
dim tmpArrIid, ptype, itemcount, itemdiv, idx, posX, posY
...
'Response.Write "alert('" & strRst & "\n저장되었습니다.');"& vbCrLf
	Response.Write "parent.opener.location.href='/admin/sitemaster/ImageLinkMap/popimagelinkdetailedit.asp?masteridx="&listidx&"&itemdiv="&itemdiv&"&itemid="&arrItemid(0)&"&idx="&idx&"&posX="&posX&"&posY="&posY&"';" & vbCrLf
