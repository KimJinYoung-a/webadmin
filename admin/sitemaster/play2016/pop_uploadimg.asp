...
<%
Dim sImg, sName,sSpan, slen, arrImg, sImgName, vYear, vFolder, vImgGubun
vFolder = Request.Querystring("folder") 
sImg = Request.Querystring("sImg")
sSpan = Request.Querystring("span")
vImgGubun = Request.Querystring("imggubun")
vYear = Year(now)
%>
...
<form name="frmImg" method="post" action="<%= uploadImgUrl %>/linkweb/play/play_upload_2016.asp" enctype="MULTIPART/FORM-DATA" onSubmit="return jsUpload();">
...
<input type="hidden" name="imggubun" value="<%=vImgGubun%>">
