...
Dim i, cQuick, vPage, vDateGubun, vSDate, vEDate, vEndType, vUseYN, vSearchGubun, vSearchTxt
...
function jsQuickReg(idx){
	var popquickreg;
	popquickreg = window.open('quickLinkManage.asp?idx='+idx+'','popquickreg','width=800,height=830,scrollbars=yes,resizable=yes');
	popquickreg.focus();
}
...
//브랜드 ID 검색 팝업창
function jsBrandBannerSearchBrandID(idx){
    var popwin = window.open("popBrandList.asp?idx=" + idx ,"popBrandSearch","width=800 height=400 scrollbars=yes resizable=yes");
	popwin.focus();
}
</script>
</head>
...
<div class="contSectFix scrl">
	<div class="contHead">
		<div class="locate"><h2>[MOBILE]사이트관리 &gt; <strong>브랜드상세퀵링크관리</strong></h2></div>
		<div class="helpBox">
				...
				<table class="tbType1 listTb">
					...
					%>
							<tr>
                                ...
                                <td><input type="button" class="btn" value="브랜드 관리" onClick="jsBrandBannerSearchBrandID('<%=cQuick.FItemList(i).Fidx%>');" /></td>
