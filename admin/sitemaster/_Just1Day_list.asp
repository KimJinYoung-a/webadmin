...
function goPage(pg)
{
	...
	document.refreshFrm.action="_Just1Day_list.asp";
...
<form name="refreshFrm" method="get" action="_Just1Day_list.asp">
...
<form name="frmarr" method="post" action="_doJust1Day_Process.asp">
<input type="hidden" name="menupos" value="<%= request("menupos") %>">
<input type="hidden" name="mode" value="">
<tr>
	<td align="right"><input type="button" value="아이템 추가" onclick="self.location='_Just1Day_write.asp?mode=add&menupos=<%= menupos %>'" class="button"></td>
</tr>
</table>
<!-- 액션 끝 -->
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
...
%>
<tr bgcolor="#FFFFFF">
	<td align="center"><a href="_Just1Day_write.asp?mode=edit&menupos=<%= menupos %>&justdate=<%= oJust.FItemList(i).FjustDate %>"><%= oJust.FItemList(i).FjustDate %></a></td>
	<td align="center"><a href="_Just1Day_write.asp?mode=edit&menupos=<%= menupos %>&justdate=<%= oJust.FItemList(i).FjustDate %>"><img src="<%= oJust.FItemList(i).FsmallImage %>" width="50" height="50" border="0"></a></td>
