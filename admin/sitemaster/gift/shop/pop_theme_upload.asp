...
<%
'####################################################
' Description : GIFT SHOP 테마 타이틀 이미지 등록
' History : 2014.04.07 허진원 생성
'####################################################
%>
...
<form name="frmImg" method="post" action="<%= uploadImgUrl %>/linkweb/common/upload_giftShop_themeImgProc.asp" enctype="MULTIPART/FORM-DATA" onSubmit="return jsUpload();">
