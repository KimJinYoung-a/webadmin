...
If subidx <> "" then
	dim ogiftdayItem
	set ogiftdayItem = new CShowBannerContents
	ogiftdayItem.FRectSubIdx = subidx
	ogiftdayItem.GetOneSubItem()

	subIdx			=	ogiftdayItem.FOneItem.Fidxsub
	listidx			=	ogiftdayItem.FOneItem.Fidx
	subItemid		=	ogiftdayItem.FOneItem.FItemid
	sortnum			=	ogiftdayItem.FOneItem.Fsortnum
	isusing			=	ogiftdayItem.FOneItem.Fisusing
	itemName		=	ogiftdayItem.FOneItem.FitemName
	smallImage		=	ogiftdayItem.FOneItem.FsmallImage

	set ogiftdayItem = Nothing
End If 
%>
