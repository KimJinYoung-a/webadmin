...
if Scnt>0 then
    sqlStr = " insert into db_board.dbo.tbl_giftday_master_item" + VbCrlf
    sqlStr = sqlStr + " (masteridx, itemid, isusing, sortnum ) " + VbCrlf
    ...
    sqlStr = sqlStr + " 		from db_board.dbo.tbl_giftday_master_item" + VbCrlf
    sqlStr = sqlStr + " 		where masteridx='" & listidx & "'" + VbCrlf
