...
<% if listidx <> "" then %>
    var popwinsub = window.open("/admin/itemmaster/pop_itemAddInfo.asp?sellyn=Y&usingyn=Y&defaultmargin=0&acURL=/admin/sitemaster/just1daymobile2018/doSubRegItemCdArray.asp?listidx=<%=listidx%>&ptype=just1day", "popup_itemsub", "width=800,height=500,scrollbars=yes,resizable=yes");
    popwinsub.focus();
<% else %>
