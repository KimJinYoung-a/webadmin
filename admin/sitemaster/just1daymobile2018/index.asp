...
function addContents(){	
	...
	document.location.href="just1day_insert.asp?menupos=<%=menupos%>&prevDate=<%=sDt%>&paramisusing=<%=isusing%>&dateoption="+dateOptionParam
}

function fnPcJust1dayCopy() {
    var popwin = window.open("/admin/sitemaster/just1day2018/index.asp?mode=copy","popTemplateManage","width=1200,height=600,scrollbars=yes,resizable=yes");
    popwin.focus();
}
-->
</script>
<!-- 검색 시작 -->
<form name="frm" method="post" style="margin:0px;" action="/admin/sitemaster/just1daymobile2018/index.asp">
...
<!-- 검색 끝 -->
<br>
<div style="float:right;clear:both;"><button onClick="fnPcJust1dayCopy();">불러오기</button>&nbsp;&nbsp;<a href="javascript:addContents()"><img src="/images/icon_new_registration.gif" border="0" align="absmiddle"></a></div>
<br><br>
<!--  리스트 -->
...
<tr  height="30" align="center" bgcolor="<%=chkIIF(just1DayList.FItemList(i).Fisusing="Y","#FFFFFF","#F0F0F0")%>">
    ...
    <td onclick="jsmodify('<%=just1DayList.FItemList(i).Fidx%>');" style="cursor:pointer;"><%=just1DayList.FItemList(i).Ftitle%></td>
