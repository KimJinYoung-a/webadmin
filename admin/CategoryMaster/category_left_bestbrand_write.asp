...
<%
'###############################################
' PageName : category_left_bestBrand_write.asp
' Discription : 카테고리 베스트 브랜드 등록/수정
...
<form name="inputfrm" method="post" action="<%=uploadUrl%>/linkweb/Category/doLeftBestBrand.asp" enctype="multipart/form-data">
...
<tr>
	...
	<td bgcolor="#FFFFFF"><% DrawSelectBoxCategoryLarge "cdl", cdl %></td>
</tr>
...
<tr>
	...
	<td bgcolor="#FFFFFF"><% DrawSelectBoxCategoryLarge "cdl", fmainitem.FItemList(0).Fcdl %></td>
</tr>
<tr>
...
<tr>
	...
	<td bgcolor="#FFFFFF"><input type="file" name="img1" size="55"><br>
		...
		<tr><td><img src="<%= staticImgUrl & "/left/bestbrand/" & fmainitem.FItemList(0).FImage %>" border="0" name="imgv1"></td></tr>
