...
sqlStr = "select top 1 * from [db_sitemaster].[dbo].tbl_category_contents_poscode"
...
if (ItemExists) then
    sqlStr = " update [db_sitemaster].[dbo].tbl_category_contents_poscode" + VbCrlf
    ...
    sqlStr = " insert into [db_sitemaster].[dbo].tbl_category_contents_poscode" + VbCrlf
