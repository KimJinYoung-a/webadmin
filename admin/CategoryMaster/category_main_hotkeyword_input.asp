...
function subcheck(){
	...
	if (frm.keywordTxt.value.length<1) {
		alert('키워드 문구를 입력해주세요..');
		frm.keywordTxt.focus();
		return;
	}
...
<form name="inputfrm" method="post" action="<%=uploadUrl%>/linkweb/doCategoryhotKeyword.asp" enctype="multipart/form-data">
...
<tr name="row_link" id="row_link">
	<td align="center" bgcolor="#F0F0FD">키워드 문구</td>
	<td bgcolor="#FFFFFF">
		<input type="text" name="keywordTxt" size="20">
	</td>
</tr>
<tr name="row_link" id="row_link">
	<td align="center" bgcolor="#F0F0FD">링크 주소</td>
	<td bgcolor="#FFFFFF">
		<input type="text" name="linkURL" value="/" size="60">
		<br>※ 상대주소로 표기
	</td>
</tr>
<tr>
...
<%
	dim fmainitem
	set fmainitem = New CateHotKeyword
...
<tr name="row_link" id="row_link">
	<td align="center" bgcolor="#F0F0FD">키워드 문구</td>
	<td bgcolor="#FFFFFF">
		<input type="text" name="keywordTxt" size="20" value="<%=fmainitem.FKeyWord%>">
	</td>
</tr>
