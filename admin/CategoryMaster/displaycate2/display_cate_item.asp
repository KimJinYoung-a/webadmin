...
<%
	Dim cDisp, i, vDepth, vCateCode, vCurrpage, vPageSize, vIsThisCate, vParam, vSearch, vNotCateReg, dispCate, dispCateOld
	...
	cdm 		= request("cdm")
	cds 		= request("cds")
	itemid_s	= html2db(request("itemid_s"))
	...
	cDisp.FSearchDispCateOld= dispCateOld
...
<tr>
	<td width="75%">
		<form name="frmitem" method="post" action="<%=CurrURL()%>" style="margin:0px;">
		...
		<tr>
			<td bgcolor="#FFFFFF">
						...
						<table class="a">
							<tr>
								...
								<td rowspan="2" bgcolor="#FFFFFF">	
									<textarea rows="3" cols="20" name="itemid_s" id="itemid_s"><%=replace(itemid_s,",",chr(10))%></textarea> 
									<span style="font-size:11px; color:gray;padding-left:5px;">(엔터로 복수입력가능, 500개까지)</span>
								</td>
							</tr>
							<tr>
								<td> 
				...
				<tr>
					<td bgcolor="#FFFFFF">
						<!-- #include virtual="/admin/CategoryMaster/displaycate2/categoryselectbox.asp"-->
					</td>
				</tr>
				<tr>
					<td bgcolor="#FFFFFF">
						...
						<input type="hidden" name="olddisp" id="oOldDispCate" value="<%=dispCateOld%>">
					</td>
				</tr>
