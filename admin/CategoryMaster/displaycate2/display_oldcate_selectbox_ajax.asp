	...
	If cDisp.FResultCount > 0 Then
		For i=0 To cDisp.FResultCount-1
			...
			If i=0 OR vTempDepth <> cDisp.FItemList(i).FDepth Then
				...
				End If
				Response.Write "<select name=""cate"" class=""select"" onChange=""jsOldCateCodeSelectBox(this.value," & cDisp.FItemList(i).FDepth+1 & ",'" & vGubun & "');"">" & vbCrLf
