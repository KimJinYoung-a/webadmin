...
function popCate(c){
	var catepop = window.open("pop_cate.asp?catecode=105&depth=2&inputname="+c+"","catepop","width=850,height=527, scrollbars=yes, resizable=yes");
	catepop.focus();
}

function jsItemReg(i){
	var itempop = window.open("pop_item.asp?catecode=105&itemid="+i+"","itempop","width=400,height=300, scrollbars=yes, resizable=yes");
	itempop.focus();
}
...
<%
	...
	End IF
%>
    var popCreateTemp = window.open("<%=vWWW%>/chtml/dispcate/menu_make_xml.asp?catecode=105&gb=temp","popCreateTemp","width=1200 height=930 scrollbars=yes resizable=yes");
	popCreateTemp.focus();
}
...
function jsSaveCateMenu(){
	...
	$("input[name=cate7code]").val($("input[name=cate7]").val());
	$("input[name=cate8code]").val($("input[name=cate8]").val());
	$("input[name=cate9code]").val($("input[name=cate9]").val());
...
<input type="hidden" name="cnt" value="9">
		...
		<div class="gnbSub">
			...
			<div class="ftLt">
				<dl>
					...
					<dd>
						<ul>
							<li>7. <input type="text" name="cate7" value="<%=cate(6)%>" size="17" style="cursor:pointer;" onClick="jsSearchBrandIDn(this.form.name,'cate7');" readonly></li>
							<li>8. <input type="text" name="cate8" value="<%=cate(7)%>" size="17" style="cursor:pointer;" onClick="jsSearchBrandIDn(this.form.name,'cate8');" readonly></li>
							<li>9. <input type="text" name="cate9" value="<%=cate(8)%>" size="17" style="cursor:pointer;" onClick="jsSearchBrandIDn(this.form.name,'cate9');" readonly></li>
						</ul>
					</dd>
				</dl>
				<dl class="cBnrView">
