...
function jsRealServerReg(){
	if(confirm("[<%=Left(vCateCode,3)%>] 카테고리 메뉴를 생성하시겠습니까?") == true){
	    var popCreateTemp = window.open("http://<%=CHKIIF(application("Svr_Info")="Dev","2015www","www1")%>.10x10.co.kr/chtml/dispcate/menu_make_xml_New.asp?catecode=<%=Left(vCateCode,3)%>","popCreateTemp","width=1200 height=930 scrollbars=yes resizable=yes");
		popCreateTemp.focus();
	}
}
...
<div class="box2">
	...
	<tr id="lyrSbmBtn1">
		<td>
			...
			<% If vCateCode <> "" Then %>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" value="10x10 사이트 [<%=Left(vCateCode,3)%>] 메뉴생성" onClick="jsRealServerReg()">&nbsp;&nbsp;&nbsp;
			<% End If %>
			&nbsp;&nbsp;
