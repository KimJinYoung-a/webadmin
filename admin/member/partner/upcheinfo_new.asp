...
Else
	...
	vSocNo = ogroup.FOneItem.getDecCompNo
...
<input type="hidden" name="old_uid" value="">
...
<% Else %>
	...
	<input type="hidden" name="groupid_old" value="">
<% End If %>
<tr>
...
<tr height="25">
	...
	<td bgcolor="#FFFFFF">
		<input type="text" class="text" name="company_no" value="<%= vSocNo %>" size="16" maxlength="20" style="background-color:#EEEEEE;" readonly>
	</td>
	<td bgcolor="<%= adminColor("tabletop") %>">과세구분</td>
	<td bgcolor="#FFFFFF">
		<% drawSelectBoxjungsan_gubun "jungsan_gubun",ogroup.FOneItem.Fjungsan_gubun,"()" %>
	</td>
</tr>
<tr height="25">
