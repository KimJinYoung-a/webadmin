...
<tr>
	<td>
		...
		<input type="hidden" name="hidEday" value="<%= dEndDay %>"><!-- 현재달의 마지막 DD -->
		<input type="hidden" name="hidYear" value="<%=dYear%>"><!-- 사용안함 -->
		<input type="hidden" name="hidMonth" value="<%=dMonth%>"><!-- 사용안함 -->
		<input type="hidden" name="hidDP" value="<%=defaultpay%>"><!-- 사용안함 -->
		...
		END IF
		%>
		<input type="hidden" name="hidPWD" value="<%=totPWD%>"><!-- 지난 달 마지막 일요일 이후의 근무시간(2013-02 의 경우 2013-01-27 이후) -->
		<input type="hidden" name="hidPWHD" value="<%=chkPWHD%>"><!-- 지난 달 마지막 일요일 이후의 결근횟수(2013-02 의 경우 2013-01-27 이후) -->
