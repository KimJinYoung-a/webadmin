...
<%
    Dim oJson, clsCMeachulLogTotal, arrList, i, mode, vcate, syear, smonth, eyear, emonth
    ...
    If mode = "totalcontribution" Then
        ...
        clsCMeachulLogTotal.FcatecodeSearch = vcate
        ...
        arrList = clsCMeachulLogTotal.fnGetCategoryTotalContributionProfit
    ...
    ElseIf mode = "ContributionMarginStructure" Then
        ...
        IF isArray(arrList) then
            ...
            oJson("chart")("caption") = CStr(arrList(21,0))&" 공헌이익율구조"
    ...
    ElseIf mode = "TotalPurchase" Then
        ...
        IF isArray(arrList) then
            ...
            oJson("chart")("theme") = "fusion"
            oJson("chart")("xAxisName") = "년월"
            oJson("chart")("caption") = CStr(arrList(21,0))&" 구매총액"            
            oJson("chart")("subCaption") = "단위:₩"
    ...
    ElseIf mode = "HandlingAmount" Then
        ...
        IF isArray(arrList) then
            ...
            oJson("chart")("theme") = "fusion"
            oJson("chart")("xAxisName") = "년월"
            oJson("chart")("caption") = CStr(arrList(21,0))&" 취급액"            
            oJson("chart")("subCaption") = "단위:₩"
    ...
    ElseIf mode = "VariableCost" Then
        ...
        IF isArray(arrList) then
            ...
            oJson("chart")("theme") = "fusion"
            oJson("chart")("xAxisName") = "년월"
            oJson("chart")("caption") = CStr(arrList(21,0))&" 변동비"            
            oJson("chart")("subCaption") = "단위:₩"
    ...
    ElseIf mode = "ContributionProfit" Then
        ...
        IF isArray(arrList) then
            ...
            oJson("chart")("theme") = "fusion"
            oJson("chart")("xAxisName") = "년월"
            oJson("chart")("caption") = CStr(arrList(21,0))&" 공헌이익"            
            oJson("chart")("subCaption") = "단위:₩"
