...
%>
<%
dim YearUse,orgImgName ,newImgName ,ImagePath ,maxFileSize ,maxFileWidth ,maxFileheight,makeThumbYn,divName,inputname
YearUse = year(now)
orgImgName 		= request("orgImgName")
ImagePath 		= request("ImagePath")
maxFileSize 	= request("maxFileSize")
maxFileWidth	= request("maxFileWidth")
maxFileheight	= request("maxFileheight")
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="a" bgcolor="#9d9d9d">
	<form name="regfrm" method="post" action="<%=uploadImgUrl%>/linkweb/breakdown/breakdown_image_proc.asp" enctype="multipart/form-data">
	...
	<input type="hidden" name="maxFileheight" value="<%= maxFileheight %>">
	<input type="hidden" name="makeThumbYn" value="<%= makeThumbYn %>">

	<tr bgcolor="#FFFFFF">
		<td>
			<input type="file" class="button" name="imgFile" size="35" value="">
			<br>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="a" bgcolor="<%= adminColor("topbar") %>">
    <tr valign="bottom" height="25">
        ...
        <td valign="bottom" align="center">
			<input type="button" class="button" value="저장" onclick="subchk();" style="width:80px; height:23px;" />&nbsp;&nbsp;
			<input type="button" class="button" value="취소" onclick="self.close();"style="width:80px; height:23px;" />
        </td>
        <td width="10" align="left" background="/images/tbl_blue_round_05.gif"></td>
    </tr>
...
<iframe name="prcframe" src="" frameborder="0" width="0" height="0"></iframe>
