...
<%
    ...
    LGD_MERTKEY                = trim(request("LGD_MERTKEY"))        '[반드시 세팅]상점MertKey(mertkey는 상점관리자 -> 계약정보 -> 상점정보관리에서 확인하실수 있습니다')
    ...
    ' */
    ''LGD_CASNOTEURL             = "http://상점URL/cas_noteurl.asp"
...
<input type="hidden" name="LGD_PAYKEY"                  value="">                                      <!-- LG데이콤 PAYKEY(인증후 자동셋팅)-->
