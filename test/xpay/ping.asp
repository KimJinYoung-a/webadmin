<%
	configPath = "C:/lgdacom/conf"  'LG데이콤에서 제공한 환경파일("/conf/lgdacom.conf") 위치 지정.
    ...
    ' */
    CST_PLATFORM 	= "test" ''trim(request("CST_PLATFORM"))         
    CST_MID 		= "lgdacomxpay" ''trim(request("CST_MID"))  't 가 추가되지 않은 가입요청시 아이디를 입력바랍니다.
