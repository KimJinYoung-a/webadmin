...
<form name="frm" method="post" action="/lectureadmin/itemmaster/upche_item_reqMod_proc.asp">
...
<tr bgcolor="#FFFFFF" align="center">
	...
	<td><img src="<%=imgFingers%>/diyItem/webimage/small/<%=GetImageSubFolderByItemid(arrList(0,intLoop))%>/<%=arrList(11,intLoop)%>"></td> 
	<td align="left"><input type="hidden" name="sOIN" value="<%=arrList(2,intLoop)%>"><%=arrList(2,intLoop)%> &nbsp;&nbsp;<a href="<%=wwwFingers%>/diyshop/shop_prd.asp?itemid=<%=arrList(0,intLoop)%>" target="_blank"><font color="blue">확인하기</font></a></td>
