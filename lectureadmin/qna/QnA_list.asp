...
<%
	...
	oQnA.FRectSearchLecturer = Session("ssBctId")
...
<tr height="30">
	...
	<td valign="top" align="right">
		...
		<select name="searchDiv" onChange="goPage(frm_search.page.value)">
			...
			<%= oQnA.optCommCd("'D000'", searchDiv)%>
		</select>
		/ 검색
		<select name="searchKey">
			<option value="">선택</option>
			<option value="qnaId">번호</option>
...
<table width="100%" border="0" align="center" class="a" cellpadding="2" cellspacing="1" bgcolor="#BABABA">
	...
	<tr align="center" bgcolor="#DDDDFF">
		...
		<td align="center" width="240">강좌명</td>
		<td align="center" width="80">구분</td>
	...
	<tr align="center" bgcolor="#FFFFFF">
		...
		<td><%= oQnA.FQnAList(lp).FlecTitle %></td>
