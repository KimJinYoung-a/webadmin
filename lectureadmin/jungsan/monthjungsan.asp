...
function PopDetail(iidx,tg){
    var uri = 'jungsandetailsumAC.asp?id=' + iidx;
    if (tg=="OF") uri = '/designer/jungsanNew/jungsandetailsumOF.asp?idx=' + iidx;
    if (tg=="ON") uri = '/designer/jungsanNew/jungsandetailsumON.asp?id=' + iidx;
    
	var popwin = window.open(uri,'PopDetail','width=1300, height=900, scrollbars=1, resizable=yes');
	popwin.focus();
}
...
function PopTaxReg(v){
	var popwin = window.open("/designer/jungsan/poptaxreg.asp?id=" + v,"poptaxreg","width=640 height=700 scrollbars=yes resizable=yes");
	popwin.focus();
}
...
<tr align="center" bgcolor="<%= adminColor("tabletop") %>" height="26">
    ...
    <td width="100">지급대상액<br>(상품/배송비)</td>
...
<tr align="center" bgcolor="#FFFFFF" height="30">
    ...
    <td align="right"><%=FormatNumber(ojungsanTaxCC.FItemList(i).FPgCommissionSum,0)%></td>
    
    <td align="right"><%=FormatNumber(ojungsanTaxCC.FItemList(i).FprdJungsanSum+ojungsanTaxCC.FItemList(i).FdlvJungsanSum,0)%></td>
    ...
    <td><%=replace(ojungsanTaxCC.FItemList(i).GetTaxEvalStateName,"텐바이텐","더핑거스")%></td>
    <td>
    ...
    <td>
    <a href="javascript:PopDetail('<%= ojungsanTaxCC.FItemList(i).FId %>','<%= ojungsanTaxCC.FItemList(i).FtargetGbn%>');">보기<img src="/images/icon_arrow_link.gif" width="14" height="14" border="0" align="absbottom"></a>
    </td>
</tr>
<% next %>
<% else %>
...
<tr align="center" bgcolor="#FFFFFF" height="30">
    ...
    <td><%=replace(ojungsanTaxCE.FItemList(i).GetTaxEvalStateName,"텐바이텐","더핑거스")%></td>
    <td>
    ...
    <td>
    <a href="javascript:PopDetail('<%= ojungsanTaxCE.FItemList(i).FId %>','<%= ojungsanTaxCE.FItemList(i).FtargetGbn%>');">보기<img src="/images/icon_arrow_link.gif" width="14" height="14" border="0" align="absbottom"></a>
    </td>
</tr>
<% next %>
<% else %>
...
<table width="100%" border="0" align="center" class="a" cellpadding="4" cellspacing="1" bgcolor="<%= adminColor("tablebg") %>">
<tr align="center" bgcolor="#FFFFFF">
    <td colspan="13" align="left"><strong>* 매입 정산 내역</strong> (협력사에서 텐바이텐으로 발행해 주셔야 합니다.) (해외 판매 내역 및 가맹점 판매 내역은 매입정산으로 처리 됩니다.)</td>
</tr>
...
<tr align="center" bgcolor="#FFFFFF" height="30">
    ...
    <td><%=replace(ojungsanTaxMM.FItemList(i).GetTaxEvalStateName,"텐바이텐","더핑거스")%></td>
    <td>
    ...
    <td>
    <a href="javascript:PopDetail('<%= ojungsanTaxMM.FItemList(i).FId %>','<%= ojungsanTaxMM.FItemList(i).FtargetGbn%>');">보기<img src="/images/icon_arrow_link.gif" width="14" height="14" border="0" align="absbottom"></a>
    </td>
</tr>
<% next %>
<% else %>
...
<tr align="left" bgcolor="#FFFFFF">
    ...
    <td >협력사가 더핑거스 사이트를 통해 판매한 매출액</td>
    <td width="220">계산서 발행하지 않음</td>
</tr>
<tr align="left" bgcolor="#FFFFFF">
    <td>배송비/기타판매금액</td>
    <td align="center">(B)</td>
    <td>더핑거스로 입금된 배송비 + 기타정산분	</td>
    <td>계산서 발행하지 않음</td>
</tr>
<tr align="left" bgcolor="#FFFFFF">
    <td>상품판매수수료</td>
    <td align="center">(C)</td>
    <td>판매대행수수료 더핑거스 매출액(더핑거스>>협력사로 세금계산서 발행)</td>
    <td>세금계산서 발행</td>
</tr>
...
<tr align="left" bgcolor="#FFFFFF">
    ...
    <td>결제대행수수료 더핑거스 매출액(더핑거스>>협력사로 세금계산서 발행)</td>
    <td>세금계산서 발행</td>
</tr>
...
<tr align="left" bgcolor="#FFFFFF">
    ...
    <td>(E)=(A)+(B)-(C)-(D) 매출액-수수료</td>
    <td></td>
</tr>
<tr align="left" bgcolor="#FFFFFF">
    <td>추가정산액</td>
    <td align="center">(F)</td>
    <td>더핑거스에서 협력사로 지급해야할 기타정산분</td>
    <td></td>
</tr>
<tr align="left" bgcolor="#FFFFFF">
    <td>지급예정액</td>
    <td align="center">(G)</td>
    <td>(G)=(E)+(F) 협력사로 지급할 총액(업체정산액)</td>
    <td></td>
</tr>
<tr align="left" bgcolor="#FFFFFF">
    <td>계산서상태</td>
...
<tr align="left" bgcolor="#FFFFFF">
    ...
    <td>더핑거스>>협력사 발행된 세금계산서 실물 확인 및 출력</td>
    <td></td>
</tr>
<tr align="left" bgcolor="#FFFFFF">
    <td>상세조회</td>
...
<tr align="left" bgcolor="#FFFFFF">
    <td>지급대상액(배송비/기타)</td>
    <td align="center">(d)</td>
    <td>더핑거스에서 협력사로 지급해야할 배송비 + 기타정산분</td>
    <td></td>
</tr>
<tr align="left" bgcolor="#FFFFFF">
    <td>협력사매출액(지급예정액)</td>
...
<tr align="left" bgcolor="#FFFFFF">
    <td>계산서</td>
    <td align="center">(g)</td>
    <td>협력사>>더핑거스 발행된 세금계산서 실물 확인 및 출력</td>
    <td></td>
</tr>
<tr align="left" bgcolor="#FFFFFF">
    <td>상세조회</td>
