...
<script language='javascript'>
alert('발주이전 주문이거나 / 주문 확인 안하신 상품이 있습니다. \r\n\r\n더핑거스에서 발주 후 \n\n상품주문관리>>*업체배송주문확인 에서 주문 확인 하신 후 사용하실 수 있습니다.');
window.close();
</script>
<% dbget.Close() : response.end %>
<% end if  %>
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
    ...
    <tr>
		...
		<td width="100" bgcolor="<%= adminColor("tabletop") %>">취소여부</td>
		<td width="225" bgcolor="#FFFFFF"><font color="<%= ojumun.FMasterItemList(0).CancelYnColor %>"><%= ojumun.FMasterItemList(0).CancelYnName %></font></td>
	</tr>
	<tr>
...
<% if (true) or ojumun.FMasterItemList(0).Fipkumdiv > 4 then %>
	...
	<tr>
		...
		<%= trim(ojumun.FMasterItemList(0).FReqZipCode) %>
		<br>
