...
listitem =  RequestCheckvar(request("orderserial"),16)
...
<tr>
	...
	<td align="center" class=normal >배송지주소1,배송지주소2</td>
...
<tr>
	...
	<td align="center" class=normal><%= ojumun.FMasterItemList(ix).FReqZipAddr %> <%= ojumun.FMasterItemList(ix).FReqAddress %></td>
	...
	<td align="center" class=normal ><%= ojumun.FMasterItemList(ix).Frequiredetail %></td>
<% if Not IsNULL(ojumun.FMasterItemList(ix).Freqdate) then %>
	<td align="center" class=normal><%= Left(CStr(ojumun.FMasterItemList(ix).Freqdate),10) %>일 <%= (ojumun.FMasterItemList(ix).Freqtime) %>시</td>
	<td align="center" class=normal><%= ojumun.FMasterItemList(ix).getCardribbonName %></td>
	<td align="center" class=normal><%= db2html(ojumun.FMasterItemList(ix).Fmessage) %></td>
