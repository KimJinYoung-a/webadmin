...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
    <form name="frmbalju" method="post" action="upchebeasong_Process.asp">
    ...
    <tr align="center" bgcolor="<%= adminColor("tabletop") %>">
		...
		<td width="120" align="center">운송장번호</td>
		<td width="80" align="center">미출고사유<br>보기</td>
	</tr>
...
<% else %>
	...
	<tr align="center" class="a" bgcolor="#FFFFFF">
		<td><input type="checkbox" name="detailidx" value="<%= ojumun.FMasterItemList(ix).Fidx %>" onClick="AnCheckClick(this);" <%= CHKIIF(ojumun.FMasterItemList(ix).FMisendReason="05","disabled","") %>></td>
		...
		<td><input type="text" class="text" name="songjangno" size="16" value="<%= ojumun.FMasterItemList(ix).FSongjangno %>" onKeyup="CheckThis(this,'<%= ix %>');" maxlength=16 <%= CHKIIF(ojumun.FMasterItemList(ix).FMisendReason="05","readonly style='background:#EEEEEE'","") %>></td>
		<td>
