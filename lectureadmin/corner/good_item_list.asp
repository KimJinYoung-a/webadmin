...
set oip = new cgood_onelist
	...
	'	response.write "<script>alert('먼저 프로필을 등록하세요.'); self.close();</script>"
	End If
%>
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<tr align="center" bgcolor="#FFFFFF" >
		...
		<td align="left">
			...
			&nbsp;강사ID: <%=lecturer_id%><input type="hidden" name="lecturer_id" value="<%=lecturer_id%>">
		</td>	
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" class="a" style="padding-top:10;">
	<tr>
		...
		<td align="right">				
			<input type="button" class="button" value="작품등록" onclick="reg_item('<%=lecturer_id%>','');">				
		</td>
	</tr>
</table>
<!-- 액션 끝 -->
...
<table width="100%" align="center" cellpadding="3" cellspacing="1" class="a" bgcolor="<%= adminColor("tablebg") %>">
	...
	<% end if %>
		...
		<td align="center">
			<input type="button" class="button" value="수정" onclick="reg_item('<%= oip.FItemList(i).flecturer_id %>',<%= oip.FItemList(i).fidx %>);">			
		</td>			
    </tr>   
	</form>
	<% next %>
