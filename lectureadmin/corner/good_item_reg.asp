...
<table width="100%" border="0" align="center" class="a" cellpadding="3" cellspacing="1" bgcolor="#BABABA">
	<form name="frmcontents" method="post" action="<%=UploadImgFingers%>/linkweb/corner/lectureritem_proc.asp" onsubmit="return false;" enctype="multipart/form-data">
	<input type="hidden" name="idx" value="<%=idx%>">
	<input type="hidden" name="islecAdmin" value="Y">
	<tr bgcolor="#FFFFFF">
		<td align="center"  bgcolor="<%= adminColor("tabletop") %>"><b>강사ID</b><br></td>
		<td>
			<%=lecturer_id%>
