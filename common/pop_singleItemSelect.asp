...
<script>
<% If ptype = "just1day" or ptype = "excludingcoupon" Then %>
document.domain = "10x10.co.kr";
<% End If %>

function SelectItems(tgvalue,Nm,oP,sP,sC,Ln,Ly,oC,idv){
	var tg = eval('opener.<%= target %>');
	var con = opener.document.getElementById("saleinfo");
...
<tr bgcolor="#FFFFFF" align="center">
	<td><a href="javascript:SelectItems(<%= oItem.FItemList(i).FItemID %>,'<%= Replace(oItem.FItemList(i).FItemName,"'","\'") %>',<%= oItem.FItemList(i).ForgPrice %>,<%= oItem.FItemList(i).FsailPrice %>,<%= oItem.FItemList(i).FsailSuplyCash%>,<%= oItem.FItemList(i).FlimitNo %>,'<%= oItem.FItemList(i).FlimitYn %>',<%=oItem.FItemList(i).FoptionCnt%>,<%= oItem.FItemList(i).Fitemdiv %>)"><%= oItem.FItemList(i).FItemID %></a></td>
	<td><a href="javascript:SelectItems(<%= oItem.FItemList(i).FItemID %>,'<%= Replace(oItem.FItemList(i).FItemName,"'","\'") %>',<%= oItem.FItemList(i).ForgPrice %>,<%= oItem.FItemList(i).FsailPrice %>,<%= oItem.FItemList(i).FsailSuplyCash%>,<%= oItem.FItemList(i).FlimitNo %>,'<%= oItem.FItemList(i).FlimitYn %>',<%=oItem.FItemList(i).FoptionCnt%>)"><img src="<%= oItem.FItemList(i).Fsmallimage %>" width="50" height="50" border=0></a></td>
	<td align="left"><a href="javascript:SelectItems(<%= oItem.FItemList(i).FItemID %>,'<%= Replace(oItem.FItemList(i).FItemName,"'","\'") %>',<%= oItem.FItemList(i).ForgPrice %>,<%= oItem.FItemList(i).FsailPrice %>,<%= oItem.FItemList(i).FsailSuplyCash%>,<%= oItem.FItemList(i).FlimitNo %>,'<%= oItem.FItemList(i).FlimitYn %>',<%=oItem.FItemList(i).FoptionCnt%>)"><%= oItem.FItemList(i).FItemName %></a></td>
