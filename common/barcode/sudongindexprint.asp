...
function jsIndexSudongBarcodePrint() {
	...
	if (TEC_DO3.IsDriver == 1){
		if (confirm("직접입력 인덱스를 출력합니다.\n\nTEC B-FV4 로 출력하시겠습니까?") == true) {
			...
			printTOSHIBAMultiIndexSudongLabel(msg,itemno,fontName);
		}
	...
	// /js/barcode.js 참조
		...
		if (confirm("직접입력 인덱스를 출력합니다.\n\nTTP-243 로 출력하시겠습니까?") == true) {
			printTTPMultiIndexSudongLabel(msg,itemno,fontName);
		}
...
<tr>
	...
	<td bgcolor="#FFFFFF">
		<textarea name="message" style="width:400px;" rows="6"></textarea>
	</td>
</tr>
<tr height="30">
...
<tr>
	<td bgcolor="#FFFFFF" colspan=2 align="center">
        <input type="button" class="button" onClick="jsIndexSudongBarcodePrint();" value=" 출 력 ">
	</td>
</tr>
</table>
</form>
