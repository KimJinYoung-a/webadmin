...
<tr bgcolor="#FFFFFF">
    <td>
        ...
        <tr>
            <td width="460" valign="top">
                ...
                <table width="440" border="0" cellspacing="1" cellpadding="2" align="center" class="a"  bgcolor="#3d3d3d">
                	...
                	<tr bgcolor="#FFFFFF" align="center">
                		<td>
                		  <select name="opt1" size="34" style='width:210;' onchange="javascript:searchOption(this.options[this.selectedIndex].value);" >
                		  <option value="">-----------------------</option>
                		  </select>
                		</td>
                		<td>
                		  <select multiple name="opt2" size="34" style='width:210;'>
                		  <option value="">-----------------------</option>
                		  </select>&nbsp;
                		</td>
                	</tr>
                ...
                <tr bgcolor="#FFFFFF" align="center">
                    <td>옵션명 <%= i+1 %> </td>
                    <td align="center"><input type="text" name="etcOpt" size="20" maxlength="20"></td>
                </tr>
                <% next %>
                </table>
                </div>
            ...
            <td width="50">
                <input type="button" class="button" value=">> 추가" onclick="MoveOptionWithGubun(document.frmSelOpt_N.elements['opt1'],document.frmSelOpt_N.elements['opt2'])">
                <br><br>
                <input type="button" class="button"  value="<< 삭제" onclick="DelSelectOption();">
            </td>
            <td width="300" valign="top">
                ...
                <tr bgcolor="#FFFFFF">
                    <td align="center">
                        <select multiple name="addopt" size="15" style='width:210;'>
        		        </select>
        		    </td>
        		</tr>
                ...
                <tr bgcolor="#FFFFFF">
                    <td align="center">
                        <select multiple name="oldopt" size="15" style='width:210;background-color:#CCCCCC' >
                        <% for i=0 to oitemoption.FResultCount-1 %>
                ...
                <td>
                    ...
                    <% for k=0 to oOptionMultiple.FResultCount-1 %>
                        <% if (oOptionMultiple.FItemList(k).FTypeSeq=(j+1)) and (CStr(oOptionMultiple.FItemList(k).FKindSeq)=optKindSeq2Code(i+1)) then %>
                            ...
                            <input type="text" name="optionName<%= j+1 %>" class="text_ro" ReadOnly value="<%= oOptionMultiple.FItemList(k).FoptionKindName %>" size="16" maxlength="18">
                            <% found = TRUE %>
                        <% end if %>
                    <% next %>
                    ...
                    <input type="text" name="optionName<%= j+1 %>" size="16" maxlength="18">
                    <% end if %>
                </td>
                <% next %>
                <td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="a" bgcolor="F4F4F4">
    <tr valign="top" height="25">
        ...
        <td valign="bottom" align="center">
          <% if optAddType<>"D" then %>
          <input type="button" class="button" value="추가한 옵션 저장" name="btnoptsave" onclick="saveItemOptionAdd();">
          <% else %>
          <input type="button" class="button"  value="추가한 옵션 저장" name="btnoptsave" onclick="saveDoubleOptionAdd();">
          <% end if %>
          <input type="button" class="button"  value=" 닫 기 " onclick="window.close()">
        </td>
