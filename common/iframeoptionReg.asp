            ...
            <tr align="center"  bgcolor="#FFFFFF">
                ...
                <td>
                    ...
                    <% for k=0 to oOptionMultiple.FResultCount-1 %>
                        <% if (oOptionMultiple.FItemList(k).FTypeSeq=(j+1)) and (oOptionMultiple.FItemList(k).FKindSeq=i+1) then %>
                            <input type="hidden" name="itemoption<%= j+1 %>" value="<%= oOptionMultiple.FItemList(k).FTypeSeq %><%= oOptionMultiple.FItemList(k).FKindSeq %>">
                            <input type="text" name="optionName<%= j+1 %>" class="text_ro" ReadOnly value="<%= oOptionMultiple.FItemList(k).FoptionKindName %>" size="18" maxlength="20">
                            <% found = TRUE %>
                        <% end if %>
                    <% next %>
                    ...
                    <input type="text" name="optionName<%= j+1 %>" size="18" maxlength="20">
                    <% end if %>
                </td>
                <% next %>
                <td>
