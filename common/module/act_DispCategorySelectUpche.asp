...
function jsCateCodeSelectBox(c,d,g){
	$.ajax({
		url: "/admin/CategoryMaster/displaycate/display_cate_selectbox_ajax_upche.asp?depth="+d+"&cate="+c+"&gubun="+g+"",
		cache: false,
...
%>
<% if chkCnt<2 then %><input type="button" value="추가" class="button" onclick="sendDispCateItem()" /><% end if %>
