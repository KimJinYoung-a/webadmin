...
<form name="frmFile" method="post" action="<%= uploadUrl %>/linkweb/item/foreign/upload_foreign_item_foreign_excel.asp"  enctype="MULTIPART/FORM-DATA" style="margin:0px;">

<table width="100%" border="0" align="center" class="a" cellpadding="3" cellspacing="1" bgcolor="#999999">
<tr bgcolor="#FFFFFF" align="center">
	<td colspan="2">
		<b>해외상품 언어팩 엑셀 일괄 업로드</b>
	</td>
</tr>
<tr bgcolor="#FFFFFF" align="center">
	<td width="60">샘플</td>
	<td align="left"><a href="<%= uploadUrl %>/offshop/sample/item/item_foreign_language_v1.xls" target="_blank">item_foreign_language_v1.xls</a></td>
</tr>
<tr bgcolor="#FFFFFF" align="center">
	<td><font color="red"><b>주의사항</b></font></td>
	<td align="left">
		※ 엑셀에서 저장형식이 <font color="red"><b>Save As Excel 97 -2003 통합문서</b></font> 형태만 인식 합니다.
		<br><br>* 위에 샘플을 다운 받으신후, 입력 하시거나, 리스트에 있는 <font color="red"><b>언어팩 일괄 다운로드</b></font>를 받으셔서 등록하시면 됩니다.
		<br><br>* 맨 상단의 Item Code, Item Name, Option Name 등이 있는 <font color="red"><b>1줄은 그대로 두세요.</b></font>
		<br><br>* Item Code을 기준으로 업데이트 되기 때문에 <font color="red"><b>Item Code는 절대 공란이거나, 틀리면 안됩니다.</b></font>
		<br><br><font color="red"><b>* Item Name[EN], Option delimitation[EN], Option Name[EN], ItemCopy[EN], Material[EN], Size[EN], Manufacturer[EN], Origin[EN], Keyword[EN]</b></font> 입력하시면 되며, 그대로 저장 됩니다.
	</td>
</tr>
<tr bgcolor="#FFFFFF" align="center">
	<td>파일명:</td>
