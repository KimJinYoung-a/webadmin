...
<% option explicit %>
<%
''///////// 이페이지는 가라 견적서를 만들기 위한 페이지 입니다. 수기로 고치세여		'/용만 생성
%>
						...
						<tr>
							<td colspan="5">
								<div class="orderTotal">
									<% if orderserial="19071288084" then %>
										총 합계금액 : <strong>
										<%= FormatNumber(oordermaster.FOneItem.Ftotalsum,0) %> - 마일리지 <%= FormatNumber(oordermaster.FOneItem.Fmiletotalprice,0) %>
