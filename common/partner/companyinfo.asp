...
<!-- #include virtual="/partner/lib/adminHead_utf8.asp" -->
...
function fnforeignbizNoHyphen(num) {
     num = num.replace(/-/g, "");
     var num_str = num.toString();
     var result = '';
...
function jsCheckUpload() {
    if($("#fileupload").val()!="") {
        ...
        $('#ajaxform').ajaxSubmit({
            ...
            url: "<%=uploadImgUrl%>/linkweb/partnerAdmin/new_JoinUpload_Ajax.asp",
            //submit이후의 처리
...
function jsCheckUpload2() {
    if($("#fileupload2").val()!="") {
        ...
        $('#ajaxform').ajaxSubmit({
            ...
            url: "<%=uploadImgUrl%>/linkweb/partnerAdmin/new_JoinUpload_Ajax2.asp",
            //submit이후의 처리
            success: function(responseText, statusText){
                var resultObj = JSON.parse(responseText)
...
function error_numbr(field){
	$(field).next().html("<br />"+field.value+"은(는) 정상적인 번호가 아닙니다.");
	field.value = "";
	field.focus();
	return;
}
function reset_errorMsg(field){
	$(field).next().empty();
}
</script>
</head>
...
<div class="content scrl" style="top:0;">
    ...
    <div class="popHead">
        ...
        <form name="frmupche" method="post" action="/common/partner/companyInfo_proc.asp" style="margin:0px;">
        ...
        <table class="tbType1 writeTb tMar05">
            ...
            <% if left(trim(opartner.FOneItem.Fcompany_no),3)="888" then %>
                <tr>
                    <th style="background-color:#FFE6E6;"><div>해외사업자 번호</div></th>
                    <td colspan="3"><input type="text" class="formTxt" name="company_no" id="company_no" onkeyup="this.value=fnforeignbizNoHyphen(this.value)" style="width:40%;" />&nbsp;<input type="button" class="btn3 btnIntb" value="확인" onclick="fnGetCheckCompanyNo()" /></td>
                </tr>
            <% else %>
                <tr>
    ...
    <div class="cont" id="pdiv" style="display:none">
        ...
        <table class="tbType1 writeTb">
            ...
            <tr>
                <th><div>대표전화</div></th>
                <td><input type="text" class="formTxt" name="company_tel" value="" maxlength="16" style="width:90%;"  onfocusout="fnPhoneNoHyphen(this.value,this)"/><span></span></td>
            </tr>
            <tr>
                <th><div>팩스</div></th>
                <td><input type="text" class="formTxt" name="company_fax" value="" maxlength="16" style="width:90%;"  onfocusout="fnPhoneNoHyphen(this.value,this)"/><span></span></td>
            </tr>
            <tr>
                <th><div>사무실주소</div></td>
                <td> 
                    <p>
                        ...
                        <input type="checkbox" class="formCheck" name="samezip" id="samezip" onclick="SameReturnAddr(this.checked)" /><label for="samezip">상동</label></p>
        ...
        <table class="tbType1 writeTb">
            ...
            <tr>
                <th><div>일반전화</div></th>
                <td><input type="text" class="formTxt" name="manager_phone" value="" maxlength="16" style="width:90%;" onfocusout="fnPhoneNoHyphen(this.value,this)"/><span></span></td>
            </tr>
            <tr>
            ...
            <tr style="border-bottom:solid 2px #000;">
                <th><div>핸드폰</div></th>
                <td><input type="text" class="formTxt" name="manager_hp" value="" maxlength="16" style="width:90%;" onfocusout="fnPhoneNoHyphen(this.value,this)"/><span></span></td>
            </tr>
            <tr>
            ...
            <tr>
                <th><div>일반전화</div></th>
                <td><input type="text" class="formTxt" name="jungsan_phone" value="" maxlength="16" style="width:90%;" onfocusout="fnPhoneNoHyphen(this.value,this)"/><span></span></td>
            </tr>
            <tr>
                <th><div>E-Mail</div></th>
            ...
            <tr>
                <th><div>핸드폰</div></th>
                <td><input type="text" class="formTxt" name="jungsan_hp" value="" maxlength="16" style="width:90%;" onfocusout="fnPhoneNoHyphen(this.value,this)"/><span></span></td>
            </tr>
            <tbody>
        </table>
        ...
        <table class="tbType1 writeTb">
            ...
            <tr>
                <th><div>일반전화</div></th>
                <td><input type="text" class="formTxt" name="deliver_phone" value="" maxlength="16" style="width:90%;" onfocusout="fnPhoneNoHyphen(this.value,this)"/><span></span></td>
            </tr>
            <tr>
                <th><div>E-Mail</div></th>
            ...
            <tr>
                <th><div>핸드폰</div></th>
                <td><input type="text" class="formTxt" name="deliver_hp" value="" maxlength="16" style="width:90%;" onfocusout="fnPhoneNoHyphen(this.value,this)"/><span></span></td>
            </tr>
            <tr>
                <th><div>물류(반품)주소</div></td>
                <td> 
                    <p><input type="text" class="formTxt" name="p_return_zipcode" value="" maxlength="7" style="width:100px;" /> <input type="button" class="btn3 btnIntb" value="우편번호검색" onclick="TnFindZipPartnerDistribution('frmupche','H')" /> <input type="button" class="btn3 btnIntb" value="우편번호검색(구)" onclick="javascript:popZip('m');" /> <input type="checkbox" class="formCheck" name="samezip" id="samezip" onclick="SameReturnAddr2(this.checked)" /><label for="samezip">상동</label></p>
        ...
        <form name="frmUpload" id="ajaxform" method="post" enctype="multipart/form-data" style="margin:0px;">
