...
<div class="popupWrap">
	...
	<div class="popContent scrl">
		<div class="contTit bgNone"><!-- for dev msg : 타이틀 영역하단에 searchWrap이 올 경우엔 bgNone 클래스 삭제 -->
			<h2>옵션수정</h2>
			<p class="titDesp tMar05">- 옵션을 추가 또는 삭제할수 있습니다.</p>
			<p class="titDesp">- 판매/입고/출고된 내역이 있는 옵션은 삭제가 불가능합니다.(사용안함 으로 수정하세요)</p>
			</div>
		<div class="cont"> 
		 <table class="tbType1 writeTb tMar10">
			...
			<div class="overHidden">
			 <div class="ftLt"><h3 class="tMar20 bltNo">등록된 옵션 리스트</h3></div>
 			 <div class="ftRt tMar10"><input type="button" class="btn3 btnIntb cBl1" value="옵션추가 +" onClick="AddOptionPop('<%= itemid %>');"></div>
 			</div>
 			 <% if oitemoption.FResultCount<1 then %>
 			 	<ul class="txtList">
					<li class="cBl1">등록된 옵션이 없습니다.</li>
				</ul>
 			 	<%else%>
 			 	  <% if (oitemoption.IsMultipleOption) then %><!-- 이중옵션 --> 
