...
%>	
	...
	<div class="heightgird" id="orderPrint"><!-- 2013.09.24 : id="mediaPrint" 추가 -->
		<div class="popWrap">
			<div class="popHeader">
				<h1><img src="/fiximage/web2013/my10x10/tit_order_receipt.gif?dumi=1234" alt="주문확인서" /></h1><!-- <img src="http://fiximage.10x10.co.kr/web2013/my10x10/tit_order_receipt.gif" alt="주문확인서" />-->
			</div>
			<div class="popContent">
				...
				<div class="mySection">
						...
						<tr>
							<td colspan="7">
								...
								<div class="orderTotal">
				    				...
				    				- 배송비쿠폰할인 <%= FormatNumber(oordermaster.FOneItem.FDeliverpriceCouponNotApplied-oordermaster.FOneItem.FDeliverprice,0) %>원
				    				<% end if %>
					...
					<div class="companyInfo">
						<p><img src="http://fiximage.10x10.co.kr/web2020/my10x10/img_company_info.png" alt="텐바이텐 10X10 / 판매처 안내 : (주)텐바이텐 사업자등록번호 : 211-87-00620 / 대표이사 : 최은희 / 소재지 : (03082) 서울시 종로구 대학로 57 홍익대학교 대학로캠퍼스 교육동 14층 텐바이텐 / 텐바이텐 고객센터안내 TEL : 1644-6030 / AM 09 :00~PM 06:00 점심시간 PM 12:00~01:00 주말,공휴일 휴무 / E-mail : customer@10x10.co.kr " /></p>
					</div> 
				</div>
				<!-- //content -->
			</div>
