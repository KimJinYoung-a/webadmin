...
// customer 셋팅 변수,,실제 파일액션이 일어나는 부분
var g_strUploadPath_Image = "<%=uploadImgUrl%>/linkweb/innoditor/upload.asp";
</script>
...
*/
	...
	// V2.1.0.1 Safari 전달방식 변경처리, Opera 추가 적용
									...
									<td>
										...
										<tr valign="top">
											...
											<td width="70">
												...
												<input type="hidden" name="Fd" value="<%=request("Fd")%>">
...
<!--iframe name="ifrmUpload" src="" width="100%" height="100" border="0" frameborder="0" framespacing="0" marginheight="0" marginwidth="0"></iframe-->
