...
Class board
	...
	'//admin/ithinkso/notice/board_edit.asp
	Public Sub fnBoardmodify
		...
		strSql = strSql & " from db_board.dbo.tbl_board_ithinkso as B"
	...
	'/admin/ithinkso/notice/board_list.asp
