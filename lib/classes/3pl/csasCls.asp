...
function drawSelectBoxCancelTypeBox(selectBoxName,selectedId,orgPaymethod,divcd,onChangefunction)
    ...
    elseif (orgPaymethod="400")  then
        ...
        if application("Svr_Info") = "Dev" or C_ADMIN_AUTH then ''or session("ssBctId") = "bseo"
...
Class CCSBrandMemo
    ...
    public sub GetBrandMemo()
		...
		sqlStr = sqlStr + " , return_comment, return_modifyday, return_reguserid, cs_name, cs_phone, cs_hp, cs_email, lunch_start, lunch_end, vacation_div, cs_modifyday, cs_reguserid "
...
Class CCSASMasterItem
    ...
    public function IsRequireSongjangNO()
        ...
        IsRequireSongjangNO = (Fdivcd="A000") or (Fdivcd="A001") or (Fdivcd="A002") or (Fdivcd="A200") or (Fdivcd="A004") or (Fdivcd="A010") or (Fdivcd="A011") or (Fdivcd="A100") or (Fdivcd="A111") or (Fdivcd="A012") or (Fdivcd="A112")
    end function
...
'rw sqlStr
    ...
    public Sub GetOneCSASMaster()
        ...
        sqlStr = sqlStr + " , cu.addmethod as customeraddmethod, cu.addbeasongpay as customeraddbeasongpay, cu.receiveyn as customerreceiveyn, cu.realbeasongpay as customerrealbeasongpay, s.findurl as songjangfindurl "
        sqlStr = sqlStr + " from [db_cs].[dbo].tbl_new_as_list A "
...
''            end if
    ...
    public Sub GetCSASTotalCount()
        ...
        sqlStr = " select count(id) as cnt "
        sqlStr = sqlStr + " from [db_threepl].[dbo].[tbl_3pl_as_list] "
        sqlStr = sqlStr + " where 1 = 1 "
