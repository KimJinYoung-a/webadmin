...
public FCateSmall
	...
	public Function fnGetCategoryList
		...
		strSql ="[db_item].[dbo].sp_Ten_CategoryMatching_getList("&FRectDispCate&",'"&FRectCateLarge&"','"&FRectCateMid&"','"&FRectCateSmall&"','"&FRectIsNotMatching&"' )" 
	...
	public Function fnGetDispCateFullName
		Dim strSql 
		strSql ="[db_item].[dbo].[sp_Ten_dispcategory_getFullName]("&FRectDispCate&")" 
		rsget.Open strSql, dbget, adOpenForwardOnly, adLockReadOnly, adCmdStoredProc
		IF Not (rsget.EOF OR rsget.BOF) THEN
			fnGetDispCateFullName = rsget("dispFullcatename") 
		END IF
		rsget.close 
	END Function	
	...
	public Function fnGetCategoryDisp
		Dim strSql 
		strSql ="[db_item].[dbo].[sp_Ten_CategoryMatching_GetData]("&FRectDispCate&")"
