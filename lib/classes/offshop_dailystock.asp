...
Class COffShopDailyStock
	...
	public function GetCurrentAllShopItemStock()
		...
		sqlStr = sqlStr + " d.chargediv, IsNULL(d.defaultmargin,0) as defaultmargin, IsNULL(d.defaultsuplymargin,0) as defaultsuplymargin"
	...
	public function GetCurrentSysStock()
		...
		sqlStr = sqlStr + " 	from " + VbCrlf
		sqlStr = sqlStr + " 	[db_storage].[10x10].tbl_acount_storage_master m," + VbCrlf
		sqlStr = sqlStr + " 	[db_storage].[10x10].tbl_acount_storage_detail d" + VbCrlf
...
'				end if
	...
	public function GetDailyStock()
		...
		sqlStr = sqlStr + " left join [db_item].[10x10].tbl_item o"
