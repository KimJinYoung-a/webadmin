...
Class CCouponItem
    ...
    public Fexitemidlist
    public Fexbrandidlist
...
Class CCouponlist
    ...
    public Sub GetCouponMasteritem()
		...
		sqlStr = sqlStr + " , m.exitemidlist, m.exbrandidlist "
        ...
        if Not rsget.Eof then
			...
			FOneItem.fexitemidlist 		= rsget("exitemidlist")
			FOneItem.fexbrandidlist 	= rsget("exbrandidlist")
	...
	public Sub GetCouponshopList
		...
		sqlStr = sqlStr + " from db_shop.dbo.tbl_shop_user_coupon_master_shoplist"+ vbcrlf
