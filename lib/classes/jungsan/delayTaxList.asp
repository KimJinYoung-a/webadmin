...
function popDelayTaxDetail(yyyy1, mm1, yyyy2, mm2, offgubun, issuegubun) {
	var popwin = window.open("popDelayTaxDetailList.asp?yyyy1=" + yyyy1 + "&mm1=" + mm1 + "&yyyy2=" + yyyy2 + "&mm2=" + mm2 + "&offgubun=" + offgubun + "&issuegubun=" + issuegubun,"popDelayTaxDetail","width=1000, height=700, scrollbars=yes,resizable=yes");
	popwin.focus();
}
