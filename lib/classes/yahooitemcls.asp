...
class CYahooItemList
	...
	public Sub GetEmpasItem
		...
		sqlStr = sqlStr + " cate_large, cate_mid, cate_small,"
		sqlStr = sqlStr + " i.orgprice, i.makerid, i.regdate"
		...
		if  not rsget.EOF  then
			...
			do until rsget.eof
				...
				FItemList(i).fmakername = db2html(rsget("makerid"))
	...
	public Sub GetYahooItem
		...
		sqlStr = sqlStr + " from [db_item].dbo.tbl_item i "
		sqlStr = sqlStr + " left join [db_item].dbo.vw_category v on v.cdlarge=i.itemserial_large"
    ...
    public Sub GetYahooItemDB2
		...
		sqlStr = sqlStr + " left join [db_search].[dbo].tbl_item_category v on v.cdlarge=i.itemserial_large"
		sqlStr = sqlStr + " and v.cdmid=i.itemserial_mid"
		sqlStr = sqlStr + " and v.cdsmall=i.itemserial_small"
		sqlStr = sqlStr + " where i.dispyn='Y'"
		sqlStr = sqlStr + " and i.sellyn='Y'"
