...
class CPartnerUserItem
	...
	public function GetPCuserDivName()
    	select case FpcUserDiv
            case "999_50"
                GetPCuserDivName = "제휴사(온라인)"
            case "501_21"
                GetPCuserDivName = "직영점"
            case "502_21"
                GetPCuserDivName = "가맹점"
            case "503_21"
                GetPCuserDivName = "도매처"
            case "900_21"
                GetPCuserDivName = "출고처(기타)"
            case "903_21"
                GetPCuserDivName = "3PL(대표)"
            case "902_21"
                GetPCuserDivName = "협력업체"
            case "901_21"
                GetPCuserDivName = "웹에이전시"
            case else
