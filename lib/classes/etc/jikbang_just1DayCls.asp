...
Class Cjust1Day
	...
	public Function Getjust1DayList()
		...
		sqlStr = sqlStr + " from [db_etcmall].[dbo].tbl_jikbang_oneDay as t1" + vbcrlf
		...
		sqlStr = sqlStr + " , t1.sale_code, t1.limitNo, t1.regdate, t1.OutPutImgUrl1, t1.OutPutImgUrl2 " + vbcrlf
		sqlStr = sqlStr + " , t2.itemname, t2.sellYn, t2.smallImage " + vbcrlf
		sqlStr = sqlStr + " , isNull(t1.OutPutImgUrl1,'') as img1, isNull(t1.OutPutImgUrl2,'') as img2, isNull(t1.contentImgUrl,'') as img3, " + vbcrlf
		...
		sqlStr = sqlStr + " where 1=1 " + addSql + vbcrlf
		sqlStr = sqlStr + " group by t1.JustDate, t1.itemid, t1.orgPrice, t1.justSalePrice, t1.saleSuplyCash , t1.sale_code, t1.limitNo, t1.regdate , t2.itemname, t2.sellYn, t2.smallImage,t1.OutPutImgUrl1 ,t1.OutPutImgUrl2,t1.contentImgUrl "
