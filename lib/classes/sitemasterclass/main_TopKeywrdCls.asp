...
Class CSearchKeyWord
	...
	public Function GetSearchKeyWord()
		...
		if FRectSiteDiv<>"" then
			addSql = addSql & " and siteDiv='" & FRectSiteDiv & "'"
		end if
		...
		sqlStr = "select count(idx) as cnt from [db_sitemaster].[dbo].tbl_maintopKeyword with (nolock)"
		...
		sqlStr = sqlStr + " idx,siteDiv,keyword,sortNo,linkinfo,isUsing,regdate" + vbcrlf
		sqlStr = sqlStr + " from [db_sitemaster].[dbo].tbl_maintopKeyword with (nolock)" + addSql + vbcrlf
