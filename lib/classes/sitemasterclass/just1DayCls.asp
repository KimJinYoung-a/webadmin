...
Class Cjust1Day
	...
	public Function Getjust1DayList()
		...
		sqlStr = sqlStr + " from [db_sitemaster].[dbo].tbl_just1day as t1" + vbcrlf
		...
		sqlStr = sqlStr + " 	, (select justDesc from [db_sitemaster].[dbo].tbl_just1day where JustDate=t1.JustDate And itemid = t1.itemid) as justDesc, t2.itemdiv"
		sqlStr = sqlStr + " from [db_sitemaster].[dbo].tbl_just1day as t1 " + vbcrlf
		sqlStr = sqlStr + "		Join [db_item].[dbo].tbl_item as t2 " + vbcrlf
		sqlStr = sqlStr + "			on t1.itemid=t2.itemid " + vbcrlf
