...
'response.end
	...
	END IF
	    ...
	    If FRectUserLevel<>"" Then
	    	sqlStr = sqlStr & " and m.userlevel='" & FRectUserLevel & "'"
		End If

	    If FRectDlvType<>"" Then
	    	sqlStr = sqlStr & " and d.isUpchebeasong='" & FRectDlvType & "'"
		End If
		...
		If FRectOptExists = "on" Then
			sqlStr = sqlStr + " group by d.itemid, d.itemcost, d.itemname, d.makerid, d.itemoptionname ,i.smallimage,i.sellcash, i.buycash ,i.orgprice, i.orgsuplycash, i.sailprice,i.sailsuplycash,i.sailyn,i.itemcouponyn,i.curritemcouponidx,i.itemcoupontype,i.itemcouponvalue, i.itemid "
		Else
			sqlStr = sqlStr + " group by d.itemid, d.itemname, d.makerid, i.smallimage,i.sellcash, i.buycash ,i.orgprice, i.orgsuplycash, i.sailprice,i.sailsuplycash,i.sailyn,i.itemcouponyn,i.curritemcouponidx,i.itemcoupontype,i.itemcouponvalue, i.itemid "
		End If
