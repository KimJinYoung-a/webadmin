<%
'###############################################
' PageName : todaythemeCls
' Discription : 사이트 메인 todaytheme
' History : 2014.01.07 이종화 생성
'###############################################

Class CtodaythemeItem
	public fidx
	Public fgubun
	Public fmaintitle
	Public fsubtitle
...
Class Ctodaytheme
	...
	'//admin/mobile/todaytheme/todaytheme_insert.asp
    public Sub GetOneContents()
        dim sqlStr
        sqlStr = "select top 1 * "
        sqlStr = sqlStr + " from db_sitemaster.dbo.tbl_mobile_main_todaytheme_list "
        ...
        set FOneItem = new CtodaythemeItem
    ...
    public Sub GetContentsList()
		...
		sqlStr = " select count(idx) as cnt from db_sitemaster.dbo.tbl_mobile_main_todaytheme_list "
		...
		if  not rsget.EOF  then
			...
			do until rsget.eof
				set FItemList(i) = new CtodaythemeItem
    ...
    public Sub GetContentsItemList()
       dim sqlStr, addSql, i
		...
		sqlStr = " select count(listidx) as cnt from db_sitemaster.dbo.tbl_mobile_main_todaytheme_item "
		sqlStr = sqlStr + " where 1=1"
