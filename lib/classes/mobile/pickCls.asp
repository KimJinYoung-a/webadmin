...
Class Cpick
    ...
    public Sub GetContentsList()
		...
		sqlStr = " select count(idx) as cnt from db_sitemaster.dbo.tbl_mobile_main_pick_list "
        ...
        sqlStr = sqlStr + " from db_sitemaster.dbo.tbl_mobile_main_pick_list as a "
	...
	public Sub GetOneSubItem()
        ...
        sqlStr = sqlStr & "From [db_sitemaster].[dbo].tbl_mobile_main_pick_item as s "
    ...
    public Sub GetOneContents()
        dim sqlStr
        sqlStr = "select top 1 * "
        sqlStr = sqlStr + " from db_sitemaster.dbo.tbl_mobile_main_pick_list "
    ...
    public Sub GetContentsItemList()
       dim sqlStr, addSql, i
		...
		sqlStr = " select count(listidx) as cnt from db_sitemaster.dbo.tbl_mobile_main_pick_item "
		sqlStr = sqlStr + " where 1=1"
