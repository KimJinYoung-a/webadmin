...
Class CMainbanner
    ...
    public Sub GetOneContents()
        ...
        sqlStr = sqlStr + " from db_sitemaster.dbo.tbl_mobile_cate_topkeyword as hk "
        ...
        if Not rsget.Eof then
			...
			FOneItem.Fkwimg			= staticImgUrl & "/mobile/topkeyword" & rsget("kwimg")
    ...
    public Sub GetContentsList()
		...
		sqlStr = " select count(t.idx) as cnt from db_sitemaster.dbo.tbl_mobile_cate_topkeyword  as t"
		...
		If FRectgnbcode <> "" Then
			sqlStr = sqlStr + " and c.gnbcode='" + CStr(FRectgnbcode) + "'"
		End If 
		...
		sqlStr = sqlStr + " t.idx , t.kwimg , t.kword , t.ktitle , t.kcontents , t.kurl_mo , t.kurl_app , t.appdiv , t.appcate  , t.sortnum , t.startdate , t.enddate , t.adminid , t.lastadminid , t.isusing ,t.regdate , t.lastupdate , t.xmlregdate , c.gnbname , i.basicimage , t.itemid "
...
'		Response.end
		...
		if  not rsget.EOF  then
			...
			do until rsget.eof
				...
				FItemList(i).Fkwimg			= staticImgUrl & "/mobile/topkeyword" & rsget("kwimg")
