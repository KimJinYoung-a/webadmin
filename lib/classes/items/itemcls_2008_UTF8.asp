...
'rw sqlStr
	...
	public function GetItemAboardList()
		...
		if FRecItemManageType = "O" then
			sqlstr = sqlstr + " join [db_item].[dbo].[tbl_item_logics_addinfo] ai "
			sqlstr = sqlstr + " on i.itemid=ai.itemid and ai.itemManageType = 'O' "
		else
			sqlstr = sqlstr + " left join [db_item].[dbo].[tbl_item_logics_addinfo] ai "
